...
/* loaded from: turned-730838-4352793_mapped_official_1.18.2.jar:net/ltxprogrammer/turned/world/features/OperativefacilityFeature.class */
public class OperativefacilityFeature extends Feature<NoneFeatureConfiguration> {
    public static OperativefacilityFeature FEATURE = null;
    ...
    public static Feature<?> feature() {
        FEATURE = new OperativefacilityFeature();
        CONFIGURED_FEATURE = FeatureUtils.register("turned:operativefacility", FEATURE, FeatureConfiguration.NONE);
        PLACED_FEATURE = PlacementUtils.register("turned:operativefacility", CONFIGURED_FEATURE, List.of());
        return FEATURE;
    }
