...
/* loaded from: turned-730838-4352793_mapped_official_1.18.2.jar:net/ltxprogrammer/turned/world/features/Secretbasementruins1Feature.class */
public class Secretbasementruins1Feature extends Feature<NoneFeatureConfiguration> {
    public static Secretbasementruins1Feature FEATURE = null;
    public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
    public static Holder<PlacedFeature> PLACED_FEATURE = null;
    public static final Set<ResourceLocation> GENERATE_BIOMES = Set.of(new ResourceLocation("forest"), new ResourceLocation("sunflower_plains"), new ResourceLocation("plains"), new ResourceLocation("savanna"), new ResourceLocation("swamp"));
    ...
    public static Feature<?> feature() {
        FEATURE = new Secretbasementruins1Feature();
        CONFIGURED_FEATURE = FeatureUtils.register("turned:secretbasementruins_1", FEATURE, FeatureConfiguration.NONE);
        PLACED_FEATURE = PlacementUtils.register("turned:secretbasementruins_1", CONFIGURED_FEATURE, List.of());
        return FEATURE;
    }
