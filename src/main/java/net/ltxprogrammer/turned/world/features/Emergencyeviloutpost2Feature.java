...
/* loaded from: turned-730838-4352793_mapped_official_1.18.2.jar:net/ltxprogrammer/turned/world/features/Emergencyeviloutpost2Feature.class */
public class Emergencyeviloutpost2Feature extends Feature<NoneFeatureConfiguration> {
    public static Emergencyeviloutpost2Feature FEATURE = null;
    public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
    public static Holder<PlacedFeature> PLACED_FEATURE = null;
    public static final Set<ResourceLocation> GENERATE_BIOMES = Set.of(new ResourceLocation("forest"), new ResourceLocation("taiga"), new ResourceLocation("old_growth_pine_taiga"), new ResourceLocation("plains"), new ResourceLocation("birch_forest"), new ResourceLocation("swamp"));
    ...
    public static Feature<?> feature() {
        FEATURE = new Emergencyeviloutpost2Feature();
        CONFIGURED_FEATURE = FeatureUtils.register("turned:emergencyeviloutpost_2", FEATURE, FeatureConfiguration.NONE);
        PLACED_FEATURE = PlacementUtils.register("turned:emergencyeviloutpost_2", CONFIGURED_FEATURE, List.of());
        return FEATURE;
    }
    ...
    public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
        ...
        if (this.template == null) {
            this.template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation(LatexMod.MODID, "evil_emergency_outpost_2"));
        }
        boolean anyPlaced = false;
        if (context.random().nextInt(1000000) + 1 <= 575) {
