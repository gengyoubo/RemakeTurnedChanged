...
/* loaded from: turned-730838-4352793_mapped_official_1.18.2.jar:net/ltxprogrammer/turned/world/features/MilitaryBaseFeature.class */
public class MilitaryBaseFeature extends Feature<NoneFeatureConfiguration> {
    public static MilitaryBaseFeature FEATURE = null;
    ...
    public static Feature<?> feature() {
        FEATURE = new MilitaryBaseFeature();
        CONFIGURED_FEATURE = FeatureUtils.register("turned:military_base", FEATURE, FeatureConfiguration.NONE);
        PLACED_FEATURE = PlacementUtils.register("turned:military_base", CONFIGURED_FEATURE, List.of());
        return FEATURE;
    }
    ...
    public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
        ...
        if (context.random().nextInt(1000000) + 1 <= 25) {
