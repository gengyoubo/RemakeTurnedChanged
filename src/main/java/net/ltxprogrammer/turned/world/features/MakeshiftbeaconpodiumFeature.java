...
public class MakeshiftbeaconpodiumFeature extends Feature<NoneFeatureConfiguration> {
    public static MakeshiftbeaconpodiumFeature FEATURE = null;
    public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
    public static Holder<PlacedFeature> PLACED_FEATURE = null;
    public static final Set<ResourceLocation> GENERATE_BIOMES = Set.of(new ResourceLocation("mushroom_fields"), new ResourceLocation("forest"), new ResourceLocation("sunflower_plains"), new ResourceLocation("snowy_plains"), new ResourceLocation("taiga"), new ResourceLocation("sparse_jungle"), new ResourceLocation("birch_forest"), new ResourceLocation("flower_forest"), new ResourceLocation("swamp"), new ResourceLocation("old_growth_birch_forest"), new ResourceLocation("windswept_hills"), new ResourceLocation("old_growth_pine_taiga"), new ResourceLocation("plains"), new ResourceLocation("savanna"), new ResourceLocation("jungle"));
    private final Set<ResourceKey<Level>> generate_dimensions;
    private final List<Block> base_blocks;
    private StructureTemplate template;

    public static Feature<?> feature() {
        FEATURE = new MakeshiftbeaconpodiumFeature();
        CONFIGURED_FEATURE = FeatureUtils.register("turned:makeshiftbeaconpodium", FEATURE, FeatureConfiguration.NONE);
        PLACED_FEATURE = PlacementUtils.register("turned:makeshiftbeaconpodium", CONFIGURED_FEATURE, List.of());
        return FEATURE;
    }
    ...
    public MakeshiftbeaconpodiumFeature() {
        ...
        this.template = null;
        this.base_blocks = List.of(Blocks.STONE, Blocks.GRANITE, Blocks.DIORITE, Blocks.ANDESITE, Blocks.GRASS_BLOCK, Blocks.DIRT_PATH, Blocks.MYCELIUM, Blocks.DIRT, Blocks.COARSE_DIRT, Blocks.PODZOL);
    }
    ...
    public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
        if (!this.generate_dimensions.contains(context.level().getLevel().dimension())) {
            ...
            if (this.template == null) {
                this.template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("turned", "makeshift_beacon_podium"));
            }
            ...
            if (this.template == null) {
                ...
                if (context.random().nextInt(1000000) + 1 <= 250) {
                    ...
                    for(int a = 0; a < count; ++a) {
                        ...
                        int j = context.level().getHeight(Types.OCEAN_FLOOR_WG, i, k) - 1;
