...
/* loaded from: turned-730838-4352793_mapped_official_1.18.2.jar:net/ltxprogrammer/turned/world/features/InfestedlatexbunkerFeature.class */
public class InfestedlatexbunkerFeature extends Feature<NoneFeatureConfiguration> {
    ...
    public static Feature<?> feature() {
        ...
        CONFIGURED_FEATURE = FeatureUtils.register("turned:infestedlatexbunker", FEATURE, FeatureConfiguration.NONE);
        PLACED_FEATURE = PlacementUtils.register("turned:infestedlatexbunker", CONFIGURED_FEATURE, List.of());
        return FEATURE;
    }
