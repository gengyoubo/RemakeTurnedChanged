...
/*    */ 
/*    */ public class Villagerbunker1Feature extends Feature<NoneFeatureConfiguration> {
/* 32 */   public static Villagerbunker1Feature FEATURE = null;
...
/* 37 */     FEATURE = new Villagerbunker1Feature();
/* 38 */     CONFIGURED_FEATURE = FeatureUtils.m_206488_("turned:villagerbunker_1", FEATURE, (FeatureConfiguration)FeatureConfiguration.f_67737_);
/* 39 */     PLACED_FEATURE = PlacementUtils.m_206509_("turned:villagerbunker_1", CONFIGURED_FEATURE, List.of());
/* 40 */     return FEATURE;
/*    */   }
/*    */   
...
/*    */   }
/*    */   
/* 47 */   public static final Set<ResourceLocation> GENERATE_BIOMES = Set.of(new ResourceLocation("sunflower_plains"), new ResourceLocation("taiga"), new ResourceLocation("plains"), new ResourceLocation("savanna"), new ResourceLocation("snowy_taiga"), new ResourceLocation("swamp"));
/*    */   
...
/* 63 */       this.template = context.m_159774_().m_6018_().m_8875_().m_74341_(new ResourceLocation("turned", "villager_bunker_1")); 
/* 64 */     if (this.template == null)
/* 65 */       return false; 
/* 66 */     boolean anyPlaced = false;
/* 67 */     if (context.m_159776_().nextInt(1000000) + 1 <= 505) {
...
/* Location:              C:\Users\Administrator\Desktop\TurnedPatch-m1.18.2-vPTBv5.jar!\net\ltxprogrammer\turned\world\features\Villagerbunker1Feature.class
