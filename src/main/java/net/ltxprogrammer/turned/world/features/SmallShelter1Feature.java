...
/* loaded from: turned-730838-4352793_mapped_official_1.18.2.jar:net/ltxprogrammer/turned/world/features/SmallShelter1Feature.class */
public class SmallShelter1Feature extends Feature<NoneFeatureConfiguration> {
    public static SmallShelter1Feature FEATURE = null;
    ...
    public static Feature<?> feature() {
        FEATURE = new SmallShelter1Feature();
        CONFIGURED_FEATURE = FeatureUtils.register("turned:small_shelter_1", FEATURE, FeatureConfiguration.NONE);
        PLACED_FEATURE = PlacementUtils.register("turned:small_shelter_1", CONFIGURED_FEATURE, List.of());
        return FEATURE;
    }
    ...
    public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
        ...
        if (this.template == null) {
            this.template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation(LatexMod.MODID, "small_shelter_1"));
        }
