...
/*    */ 
/*    */ public class AbandonedsmallvillageFeature extends Feature<NoneFeatureConfiguration> {
/* 30 */   public static AbandonedsmallvillageFeature FEATURE = null;
...
/* 35 */     FEATURE = new AbandonedsmallvillageFeature();
/* 36 */     CONFIGURED_FEATURE = FeatureUtils.m_206488_("turned:abandonedsmallvillage", FEATURE, (FeatureConfiguration)FeatureConfiguration.f_67737_);
/* 37 */     PLACED_FEATURE = PlacementUtils.m_206509_("turned:abandonedsmallvillage", CONFIGURED_FEATURE, List.of());
/* 38 */     return FEATURE;
/*    */   }
/*    */   
...
/*    */   
/*    */   public AbandonedsmallvillageFeature() {
...
/* 63 */       this.template = context.m_159774_().m_6018_().m_8875_().m_74341_(new ResourceLocation("turned", "abandoned_small_village")); 
/* 64 */     if (this.template == null)
/* 65 */       return false; 
/* 66 */     boolean anyPlaced = false;
/* 67 */     if (context.m_159776_().nextInt(1000000) + 1 <= 100) {
...
/* 76 */           if (this.template.m_74536_((ServerLevelAccessor)context
/* 77 */               .m_159774_(), spawnTo, spawnTo, (new StructurePlaceSettings()).m_74377_(Mirror.NONE).m_74379_(Rotation.NONE)
/* 78 */               .m_74390_(context.m_159776_()).m_74383_((StructureProcessor)BlockIgnoreProcessor.f_74046_).m_74392_(false), context
/* 79 */               .m_159776_(), 2))
/* 80 */             anyPlaced = true; 
/*    */         } 
/*    */       } 
...
/* Location:              C:\Users\Administrator\Desktop\TurnedPatch-m1.18.2-vPTBv5.jar!\net\ltxprogrammer\turned\world\features\AbandonedsmallvillageFeature.class
