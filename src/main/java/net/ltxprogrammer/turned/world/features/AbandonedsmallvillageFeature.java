...
/* loaded from: turned-730838-4352793_mapped_official_1.18.2.jar:net/ltxprogrammer/turned/world/features/AbandonedsmallvillageFeature.class */
public class AbandonedsmallvillageFeature extends Feature<NoneFeatureConfiguration> {
    public static AbandonedsmallvillageFeature FEATURE = null;
    ...
    public static Feature<?> feature() {
        FEATURE = new AbandonedsmallvillageFeature();
        CONFIGURED_FEATURE = FeatureUtils.register("turned:abandonedsmallvillage", FEATURE, FeatureConfiguration.NONE);
        PLACED_FEATURE = PlacementUtils.register("turned:abandonedsmallvillage", CONFIGURED_FEATURE, List.of());
        return FEATURE;
    }
