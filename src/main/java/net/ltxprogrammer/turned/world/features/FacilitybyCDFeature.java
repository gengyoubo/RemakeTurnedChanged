...
/* loaded from: turned-730838-4352793_mapped_official_1.18.2.jar:net/ltxprogrammer/turned/world/features/FacilitybyCDFeature.class */
public class FacilitybyCDFeature extends Feature<NoneFeatureConfiguration> {
    ...
    public static Feature<?> feature() {
        ...
        CONFIGURED_FEATURE = FeatureUtils.register("turned:facilityby_cd", FEATURE, FeatureConfiguration.NONE);
        PLACED_FEATURE = PlacementUtils.register("turned:facilityby_cd", CONFIGURED_FEATURE, List.of());
        return FEATURE;
    }
