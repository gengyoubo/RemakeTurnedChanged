...
/* 32 */   public static FacilitybyCDFeature FEATURE = null;
...
/* 37 */     FEATURE = new FacilitybyCDFeature();
/* 38 */     CONFIGURED_FEATURE = FeatureUtils.m_206488_("turned:facilityby_cd", FEATURE, (FeatureConfiguration)FeatureConfiguration.f_67737_);
/* 39 */     PLACED_FEATURE = PlacementUtils.m_206509_("turned:facilityby_cd", CONFIGURED_FEATURE, List.of());
/* 40 */     return FEATURE;
/*    */   }
/*    */   
...
/* 62 */       this.template = context.m_159774_().m_6018_().m_8875_().m_74341_(new ResourceLocation("turned", "facility_complex_by_cd")); 
/* 63 */     if (this.template == null)
/* 64 */       return false; 
/* 65 */     boolean anyPlaced = false;
/* 66 */     if (context.m_159776_().nextInt(1000000) + 1 <= 5) {
...
/*    */           
/* 74 */           BlockPos spawnTo = new BlockPos(i + 0, j + 0, k + 0);
...
/* Location:              C:\Users\Administrator\Desktop\TurnedPatch-m1.18.2-vPTBv5.jar!\net\ltxprogrammer\turned\world\features\FacilitybyCDFeature.class
