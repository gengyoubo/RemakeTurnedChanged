...
/* loaded from: turned-730838-4352793_mapped_official_1.18.2.jar:net/ltxprogrammer/turned/world/features/HiddenbunkerinruinsFeature.class */
public class HiddenbunkerinruinsFeature extends Feature<NoneFeatureConfiguration> {
    public static HiddenbunkerinruinsFeature FEATURE = null;
    ...
    public static Feature<?> feature() {
        FEATURE = new HiddenbunkerinruinsFeature();
        CONFIGURED_FEATURE = FeatureUtils.register("turned:hiddenbunkerinruins", FEATURE, FeatureConfiguration.NONE);
        PLACED_FEATURE = PlacementUtils.register("turned:hiddenbunkerinruins", CONFIGURED_FEATURE, List.of());
        return FEATURE;
    }
    ...
    public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
        ...
        if (this.template == null) {
            this.template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation(LatexMod.MODID, "hidden_bunker"));
        }
