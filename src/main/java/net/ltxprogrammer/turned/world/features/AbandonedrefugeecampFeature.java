...
/* loaded from: turned-730838-4352793_mapped_official_1.18.2.jar:net/ltxprogrammer/turned/world/features/AbandonedrefugeecampFeature.class */
public class AbandonedrefugeecampFeature extends Feature<NoneFeatureConfiguration> {
    ...
    public static Feature<?> feature() {
        ...
        CONFIGURED_FEATURE = FeatureUtils.register("turned:abandonedrefugeecamp", FEATURE, FeatureConfiguration.NONE);
        PLACED_FEATURE = PlacementUtils.register("turned:abandonedrefugeecamp", CONFIGURED_FEATURE, List.of());
        return FEATURE;
    }
