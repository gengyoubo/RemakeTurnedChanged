...
/* loaded from: turned-730838-4352793_mapped_official_1.18.2.jar:net/ltxprogrammer/turned/world/features/Operativefacility2Feature.class */
public class Operativefacility2Feature extends Feature<NoneFeatureConfiguration> {
    public static Operativefacility2Feature FEATURE = null;
    ...
    public static Feature<?> feature() {
        FEATURE = new Operativefacility2Feature();
        CONFIGURED_FEATURE = FeatureUtils.register("turned:operativefacility_2", FEATURE, FeatureConfiguration.NONE);
        PLACED_FEATURE = PlacementUtils.register("turned:operativefacility_2", CONFIGURED_FEATURE, List.of());
        return FEATURE;
    }
    ...
    public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
        ...
        if (this.template == null) {
            this.template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation(LatexMod.MODID, "operative_facility_2"));
        }
        if (this.template == null) {
            return false;
        }
