...
/* 32 */   public static Sandbillagerbunker1Feature FEATURE = null;
...
/* 37 */     FEATURE = new Sandbillagerbunker1Feature();
/* 38 */     CONFIGURED_FEATURE = FeatureUtils.m_206488_("turned:sandbillagerbunker_1", FEATURE, (FeatureConfiguration)FeatureConfiguration.f_67737_);
/* 39 */     PLACED_FEATURE = PlacementUtils.m_206509_("turned:sandbillagerbunker_1", CONFIGURED_FEATURE, List.of());
/* 40 */     return FEATURE;
/*    */   }
/*    */   
...
/*    */   }
/*    */   
/* 47 */   public static final Set<ResourceLocation> GENERATE_BIOMES = Set.of(new ResourceLocation("badlands"), new ResourceLocation("desert"));
...
/* 54 */     this.base_blocks = List.of(Blocks.f_50069_, Blocks.f_50440_, Blocks.f_152481_, Blocks.f_50493_, Blocks.f_50546_, Blocks.f_49992_, Blocks.f_49993_);
/*    */   }
/*    */ 
/*    */   
...
/* 62 */       this.template = context.m_159774_().m_6018_().m_8875_().m_74341_(new ResourceLocation("turned", "village_sand_bunker_1")); 
/* 63 */     if (this.template == null)
/* 64 */       return false; 
/* 65 */     boolean anyPlaced = false;
/* 66 */     if (context.m_159776_().nextInt(1000000) + 1 <= 500) {
/* 67 */       int count = context.m_159776_().nextInt(2) + 1;
...
/*    */           
/* 74 */           BlockPos spawnTo = new BlockPos(i + 0, j + -8, k + 0);
...
/* 82 */               .m_159776_(), 2)) {
/*    */             
/* 84 */             Villagerbunker1OnStructureInstanceGeneratedProcedure.execute((LevelAccessor)world, x, y, z);
/* 85 */             anyPlaced = true;
/*    */           } 
/*    */         } 
/*    */       } 
...
/* Location:              C:\Users\Administrator\Desktop\TurnedPatch-m1.18.2-vPTBv5.jar!\net\ltxprogrammer\turned\world\features\Sandbillagerbunker1Feature.class
