...
/* loaded from: turned-730838-4352793_mapped_official_1.18.2.jar:net/ltxprogrammer/turned/world/features/Sandbillagerbunker1Feature.class */
public class Sandbillagerbunker1Feature extends Feature<NoneFeatureConfiguration> {
    ...
    public static Feature<?> feature() {
        ...
        CONFIGURED_FEATURE = FeatureUtils.register("turned:sandbillagerbunker_1", FEATURE, FeatureConfiguration.NONE);
        PLACED_FEATURE = PlacementUtils.register("turned:sandbillagerbunker_1", CONFIGURED_FEATURE, List.of());
        return FEATURE;
    }
