...
/*  36 */     super(LatexModMenus.BOXGUI, id);
...
/*     */       } 
/*     */     }
/*  77 */     this.customSlots.put(Integer.valueOf(0), m_38897_((Slot)new SlotItemHandler(this.internal, 0, 52, 17) {  }
/*     */         ));
/*  79 */     this.customSlots.put(Integer.valueOf(1), m_38897_((Slot)new SlotItemHandler(this.internal, 1, 70, 17) {  }
/*     */         ));
/*  81 */     this.customSlots.put(Integer.valueOf(2), m_38897_((Slot)new SlotItemHandler(this.internal, 2, 88, 17) {  }
/*     */         ));
/*  83 */     this.customSlots.put(Integer.valueOf(3), m_38897_((Slot)new SlotItemHandler(this.internal, 3, 106, 17) {  }
/*     */         ));
/*  85 */     this.customSlots.put(Integer.valueOf(4), m_38897_((Slot)new SlotItemHandler(this.internal, 4, 52, 35) {  }
/*     */         ));
/*  87 */     this.customSlots.put(Integer.valueOf(5), m_38897_((Slot)new SlotItemHandler(this.internal, 5, 70, 35) {  }
/*     */         ));
/*  89 */     this.customSlots.put(Integer.valueOf(6), m_38897_((Slot)new SlotItemHandler(this.internal, 6, 88, 35) {  }
/*     */         ));
/*  91 */     this.customSlots.put(Integer.valueOf(7), m_38897_((Slot)new SlotItemHandler(this.internal, 7, 106, 35) {  }
/*     */         ));
/*  93 */     this.customSlots.put(Integer.valueOf(8), m_38897_((Slot)new SlotItemHandler(this.internal, 8, 52, 53) {  }
/*     */         ));
/*  95 */     this.customSlots.put(Integer.valueOf(9), m_38897_((Slot)new SlotItemHandler(this.internal, 9, 70, 53) {  }
/*     */         ));
/*  97 */     this.customSlots.put(Integer.valueOf(10), m_38897_((Slot)new SlotItemHandler(this.internal, 10, 88, 53) {  }
/*     */         ));
/*  99 */     this.customSlots.put(Integer.valueOf(11), m_38897_((Slot)new SlotItemHandler(this.internal, 11, 106, 53) {  }));
/*     */     int si;
/* 101 */     for (si = 0; si < 3; si++) {
/* 102 */       for (int sj = 0; sj < 9; sj++)
/* 103 */         m_38897_(new Slot((Container)inv, sj + (si + 1) * 9, 8 + sj * 18, 84 + si * 18)); 
/* 104 */     }  for (si = 0; si < 9; si++) {
/* 105 */       m_38897_(new Slot((Container)inv, si, 8 + si * 18, 142));
/*     */     }
/*     */   }
/*     */   
...
/* Location:              C:\Users\Administrator\Desktop\TurnedPatch-m1.18.2-vPTBv5.jar!\net\ltxprogrammer\turned\world\inventory\BoxguiMenu.class
