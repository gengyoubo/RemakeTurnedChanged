                    ...
                    if (f <= (entity instanceof LivingEntity ? entity.getMaxHealth() : -1.0f) / 2.0f && Math.random() < 0.001d) {
                        ...
                        if (Math.random() < 0.3d) {
                            ...
                            if (serverLevel2 instanceof ServerLevel) {
                                Entity entityToSpawn2 = new DLbeeEntity((EntityType<DLbeeEntity>) LatexModEntities.D_LBEE.get(), serverLevel2);
                            ...
                            if (Math.random() < 0.3d) {
                                ...
                                if (serverLevel3 instanceof ServerLevel) {
                                    Entity entityToSpawn3 = new DLbeeEntity((EntityType<DLbeeEntity>) LatexModEntities.D_LBEE.get(), serverLevel3);
