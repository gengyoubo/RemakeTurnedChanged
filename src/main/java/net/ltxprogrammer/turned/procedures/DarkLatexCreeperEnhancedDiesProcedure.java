            ...
            if (!entity.isOnFire() || Math.random() > 0.9d) {
                ...
                if (world instanceof Level) {
                    ...
                    if (!_level3.isClientSide()) {
                        ItemEntity entityToSpawn3 = new ItemEntity(_level3, x, y, z, new ItemStack((ItemLike) ChangedItems.DARK_LATEX_CRYSTAL_FRAGMENT.get()));
                ...
                if (Math.random() < 0.35d) {
                    if (world instanceof Level) {
                        ...
                        if (!_level8.isClientSide()) {
                            ItemEntity entityToSpawn8 = new ItemEntity(_level8, x, y, z, new ItemStack((ItemLike) ChangedItems.DARK_LATEX_GOO.get()));
                    ...
                    if (world instanceof Level) {
                        ...
                        if (!_level11.isClientSide()) {
                            ItemEntity entityToSpawn11 = new ItemEntity(_level11, x, y, z, new ItemStack((ItemLike) ChangedItems.DARK_LATEX_CRYSTAL_FRAGMENT.get()));
                    ...
                    if (world instanceof Level) {
                        ...
                        if (!_level12.isClientSide()) {
                            ItemEntity entityToSpawn12 = new ItemEntity(_level12, x, y, z, new ItemStack((ItemLike) ChangedItems.DARK_LATEX_CRYSTAL_FRAGMENT.get()));
                ...
                if (Math.random() < 0.1d) {
                    if (world instanceof Level) {
                        ...
                        if (!_level13.isClientSide()) {
                            ItemEntity entityToSpawn13 = new ItemEntity(_level13, x, y, z, new ItemStack((ItemLike) ChangedItems.DARK_LATEX_CRYSTAL_FRAGMENT.get()));
                    ...
                    if (Math.random() < 0.1d) {
                        if (world instanceof Level) {
                            ...
                            if (!_level17.isClientSide()) {
                                ItemEntity entityToSpawn17 = new ItemEntity(_level17, x, y, z, new ItemStack((ItemLike) ChangedItems.DARK_LATEX_CRYSTAL_FRAGMENT.get()));
