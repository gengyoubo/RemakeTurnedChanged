...
/* loaded from: turned-730838-4352793_mapped_official_1.18.2.jar:net/ltxprogrammer/turned/procedures/AHVHertxRightClickedOnEntityProcedure.class */
        ...
        if (entity != null && sourceentity != null) {
            ...
            if (health2 < f) {
                if ((entity instanceof TamableAnimal) && ((TamableAnimal) entity).isTame()) {
                    ...
                    if (sourceentity instanceof LivingEntity) {
                        ((LivingEntity) sourceentity).addEffect(new MobEffectInstance(MobEffects.LUCK, 250, 1, false, false));
                    }
                }
                ...
                if ((sourceentity instanceof LivingEntity) && _tamIsTamedBy.isOwnedBy((LivingEntity) sourceentity)) {
                    if (world instanceof ServerLevel) {
                        ...
                        Entity entityToSpawn = new AHVHertxSitEntity((EntityType<AHVHertxSitEntity>) ((EntityType) LatexModEntities.AHV_HERTX_SIT.get()), (Level) _level);
