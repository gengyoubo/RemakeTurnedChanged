...
/* loaded from: turned-730838-4352793_mapped_official_1.18.2.jar:net/ltxprogrammer/turned/procedures/TargetwearinggoodberetProcedure.class */
public class TargetwearinggoodberetProcedure {
    public static boolean execute(Entity entity) {
        ...
        return !(itemStack.getItem() == LatexModItems.GOOD_BERET_HELMET.get());
    }
}
