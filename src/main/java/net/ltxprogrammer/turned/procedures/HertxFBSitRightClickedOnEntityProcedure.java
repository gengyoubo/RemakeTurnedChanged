...
/* loaded from: turned-730838-4352793_mapped_official_1.18.2.jar:net/ltxprogrammer/turned/procedures/HertxFBSitRightClickedOnEntityProcedure.class */
            ...
            if (health2 < f) {
                ...
                if ((sourceentity instanceof LivingEntity) && _tamIsTamedBy.isOwnedBy((LivingEntity) sourceentity)) {
                    if (world instanceof ServerLevel) {
                        ...
                        Entity entityToSpawn = new HertxvarFBEntity((EntityType<HertxvarFBEntity>) ((EntityType) LatexModEntities.HERTXVAR_FB.get()), (Level) _level);
