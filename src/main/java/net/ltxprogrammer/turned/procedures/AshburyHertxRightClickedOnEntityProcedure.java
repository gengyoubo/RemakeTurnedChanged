...
/* loaded from: turned-730838-4352793_mapped_official_1.18.2.jar:net/ltxprogrammer/turned/procedures/AshburyHertxRightClickedOnEntityProcedure.class */
            ...
            if (health2 < f) {
                ...
                if ((sourceentity instanceof LivingEntity) && _tamIsTamedBy.isOwnedBy((LivingEntity) sourceentity)) {
                    if (world instanceof ServerLevel) {
                        ...
                        Entity entityToSpawn = new AshburySitEntity((EntityType<AshburySitEntity>) ((EntityType) LatexModEntities.ASHBURY_SIT.get()), (Level) _level);
