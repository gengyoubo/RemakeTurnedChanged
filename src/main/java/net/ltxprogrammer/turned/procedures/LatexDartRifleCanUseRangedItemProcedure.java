...
/* 13 */     if (entity == null)
/* 14 */       return false; 
/* 15 */     LivingEntity _livEnt = (LivingEntity)entity; if (LatexModItems.DART.get() == ((entity instanceof LivingEntity) ? _livEnt.m_21206_() : ItemStack.f_41583_).m_41720_()) {
/* 16 */       if (entity instanceof Player) { Player _player = (Player)entity;
/* 17 */         ItemStack _stktoremove = new ItemStack((ItemLike)LatexModItems.LATEX_DART_RIFLE.get());
...
/* 22 */         ItemStack _setstack = new ItemStack((ItemLike)LatexModItems.DARTRIFLE.get());
...
/* Location:              C:\Users\Administrator\Desktop\TurnedPatch-m1.18.2-vPTBv5.jar!\net\ltxprogrammer\turned\procedures\LatexDartRifleCanUseRangedItemProcedure.class
