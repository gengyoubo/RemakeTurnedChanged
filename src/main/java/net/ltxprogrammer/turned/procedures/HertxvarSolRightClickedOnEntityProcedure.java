...
/* loaded from: turned-730838-4352793_mapped_official_1.18.2.jar:net/ltxprogrammer/turned/procedures/HertxvarSolRightClickedOnEntityProcedure.class */
        ...
        if (entity != null && sourceentity != null) {
            ...
            if (health2 < f) {
                if ((entity instanceof TamableAnimal) && ((TamableAnimal) entity).isTame()) {
                    ...
                    if (sourceentity instanceof LivingEntity) {
                        ((LivingEntity) sourceentity).addEffect(new MobEffectInstance(MobEffects.DAMAGE_RESISTANCE, 300, 1, false, false));
                    }
                    if (sourceentity instanceof LivingEntity) {
                        ((LivingEntity) sourceentity).addEffect(new MobEffectInstance(MobEffects.MOVEMENT_SLOWDOWN, 100, 1, false, false));
                    }
                }
                ...
                if ((sourceentity instanceof LivingEntity) && _tamIsTamedBy.isOwnedBy((LivingEntity) sourceentity)) {
                    if (world instanceof ServerLevel) {
                        ...
                        Entity entityToSpawn = new HertxSolWaitEntity((EntityType<HertxSolWaitEntity>) ((EntityType) LatexModEntities.HERTX_SOL_WAIT.get()), (Level) _level);
