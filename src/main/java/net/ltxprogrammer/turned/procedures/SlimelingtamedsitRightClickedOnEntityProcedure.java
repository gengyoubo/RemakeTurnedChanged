...
/* loaded from: turned-730838-4352793_mapped_official_1.18.2.jar:net/ltxprogrammer/turned/procedures/SlimelingtamedsitRightClickedOnEntityProcedure.class */
        ...
        if (entity != null && sourceentity != null && (entity instanceof TamableAnimal)) {
            ...
            if ((sourceentity instanceof LivingEntity) && _tamIsTamedBy.isOwnedBy((LivingEntity) sourceentity)) {
                if (world instanceof ServerLevel) {
                    ...
                    Entity entityToSpawn = new SlimelingTamedEntity((EntityType<SlimelingTamedEntity>) ((EntityType) LatexModEntities.SLIMELING_TAMED.get()), (Level) _level);
