...
/* loaded from: turned-730838-4352793_mapped_official_1.18.2.jar:net/ltxprogrammer/turned/procedures/ArmedDroneHertxDiesProcedure.class */
public class ArmedDroneHertxDiesProcedure {
    public static void execute(LevelAccessor world, double x, double y, double z) {
            ...
            if (Math.random() < 0.3d) {
                ...
                if (Math.random() < 0.2d) {
                    ...
                    if (Math.random() < 0.3d) {
                        ...
                        if (Math.random() < 0.2d && (world instanceof Level _level8)) {
            ...
            if (Math.random() < 0.1d) {
                if (world instanceof Level _level16) {
                    if (!_level16.isClientSide()) {
                        ItemEntity entityToSpawn16 = new ItemEntity(_level16, x, y, z, new ItemStack(LatexModItems.M_4_ASSAULT_RIFLE.get()));
                    ...
                    for (int index0 = 0; index0 < ((int) (Math.random() * 10.0d)); index0++) {
                        if (world instanceof Level _level17) {
                            if (!_level17.isClientSide()) {
                                ItemEntity entityToSpawn17 = new ItemEntity(_level17, x, y, z, new ItemStack(LatexModItems.RIFLE_AMMO.get()));
            ...
            if (Math.random() < 0.05d) {
                if (world instanceof Level _level18) {
                    if (!_level18.isClientSide()) {
                        ItemEntity entityToSpawn18 = new ItemEntity(_level18, x, y, z, new ItemStack(LatexModItems.HERTXVISOR.get()));
                ...
                if (Math.random() < 0.35d) {
                    if (world instanceof Level _level19) {
                        if (!_level19.isClientSide()) {
                            ItemEntity entityToSpawn19 = new ItemEntity(_level19, x, y, z, new ItemStack(LatexModItems.HERTXENGINEER_CHESTPLATE.get()));
                            entityToSpawn19.setPickUpDelay(20);
                            _level19.addFreshEntity(entityToSpawn19);
                        }
                    }
                    if (Math.random() < 0.4d && (world instanceof Level _level20)) {
                        if (!_level20.isClientSide()) {
                            ItemEntity entityToSpawn20 = new ItemEntity(_level20, x, y, z, new ItemStack(LatexModItems.HERTXENGINEER_LEGGINGS.get()));
        ...
        } else if (world instanceof Level _level21) {
            if (!_level21.isClientSide()) {
                _level21.explode(null, x, y, z, 3.0f, Explosion.BlockInteraction.BREAK);
            }
        }
    }
}
