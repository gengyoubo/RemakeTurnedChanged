...
/* loaded from: turned-730838-4352793_mapped_official_1.18.2.jar:net/ltxprogrammer/turned/procedures/NXTHertxRightClickedOnEntityProcedure.class */
        ...
        if (entity != null && sourceentity != null) {
            ...
            if (health2 < f) {
                if ((entity instanceof TamableAnimal) && ((TamableAnimal) entity).isTame()) {
                    ...
                    if (sourceentity instanceof LivingEntity) {
                        ((LivingEntity) sourceentity).addEffect(new MobEffectInstance(MobEffects.DAMAGE_BOOST, 200, 1, false, false));
                    }
                }
                ...
                if ((sourceentity instanceof LivingEntity) && _tamIsTamedBy.isOwnedBy((LivingEntity) sourceentity)) {
                    if (world instanceof ServerLevel) {
                        ...
                        Entity entityToSpawn = new NXTSitEntity((EntityType<NXTSitEntity>) ((EntityType) LatexModEntities.NXT_SIT.get()), (Level) _level);
