            ...
            if ((entity instanceof ScientistEntity) || (entity instanceof EvilScientistEntity) || (entity instanceof EvilSniperEntity)) {
                ...
                if (world instanceof Level) {
                    ...
                    if (!_level4.isClientSide()) {
                        _level4.playSound((Player) null, new BlockPos(x, y, z), ChangedSounds.POISON, SoundSource.NEUTRAL, 1.0f, 1.0f);
                    } else {
                ...
                if (world instanceof Level) {
                    ...
                    if (!_level6.isClientSide()) {
                        _level6.playSound((Player) null, new BlockPos(x, y, z), ChangedSounds.POISON, SoundSource.NEUTRAL, 1.0f, 1.0f);
                    } else {
                ...
                if (world instanceof ServerLevel) {
                    ...
                    Entity entityToSpawn4 = new DarkLatexYufeng((EntityType) ChangedEntities.DARK_LATEX_YUFENG.get(), _level7);
                ...
                if (world instanceof Level) {
                    ...
                    if (!_level8.isClientSide()) {
                        _level8.playSound((Player) null, new BlockPos(x, y, z), ChangedSounds.POISON, SoundSource.NEUTRAL, 1.0f, 1.0f);
                    } else {
                ...
                if (world instanceof Level) {
                    ...
                    if (!_level10.isClientSide()) {
                        _level10.playSound((Player) null, new BlockPos(x, y, z), ChangedSounds.POISON, SoundSource.NEUTRAL, 1.0f, 1.0f);
                    } else {
                ...
                if (world instanceof Level) {
                    ...
                    if (!_level12.isClientSide()) {
                        _level12.playSound((Player) null, new BlockPos(x, y, z), ChangedSounds.POISON, SoundSource.NEUTRAL, 1.0f, 1.0f);
                    } else {
                ...
                if (world instanceof Level) {
                    ...
                    if (!_level14.isClientSide()) {
                        _level14.playSound((Player) null, new BlockPos(x, y, z), ChangedSounds.POISON, SoundSource.NEUTRAL, 1.0f, 1.0f);
                    } else {
                ...
                if (world instanceof Level) {
                    ...
                    if (!_level16.isClientSide()) {
                        _level16.playSound((Player) null, new BlockPos(x, y, z), ChangedSounds.POISON, SoundSource.NEUTRAL, 1.0f, 1.0f);
                    } else {
                ...
                if (world instanceof Level) {
                    ...
                    if (!_level18.isClientSide()) {
                        _level18.playSound((Player) null, new BlockPos(x, y, z), ChangedSounds.POISON, SoundSource.NEUTRAL, 1.0f, 1.0f);
                    } else {
