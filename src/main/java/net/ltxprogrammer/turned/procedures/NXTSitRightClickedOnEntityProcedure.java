...
/* loaded from: turned-730838-4352793_mapped_official_1.18.2.jar:net/ltxprogrammer/turned/procedures/NXTSitRightClickedOnEntityProcedure.class */
        ...
        if (entity != null && sourceentity != null) {
            ...
            if (health2 < f) {
                if ((entity instanceof TamableAnimal) && ((TamableAnimal) entity).isTame()) {
                    ...
                    if (sourceentity instanceof LivingEntity) {
                        ((LivingEntity) sourceentity).addEffect(new MobEffectInstance(MobEffects.DAMAGE_BOOST, 250, 1, false, false));
                    }
                }
                ...
                if ((sourceentity instanceof LivingEntity) && _tamIsTamedBy.isOwnedBy((LivingEntity) sourceentity)) {
                    if (world instanceof ServerLevel) {
                        ...
                        Entity entityToSpawn = new NXTHertxEntity((EntityType<NXTHertxEntity>) ((EntityType) LatexModEntities.NXT_HERTX.get()), (Level) _level);
