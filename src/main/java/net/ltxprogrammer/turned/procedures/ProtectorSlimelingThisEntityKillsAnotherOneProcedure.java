...
/* 54 */     } else if (world.m_6106_().m_5470_().m_46207_(LatexModGameRules.DARKLATEXTRANSFUR) && Math.random() < 0.5D && (
...
/* 71 */         ProtectorSlimelingEntity protectorSlimelingEntity = new ProtectorSlimelingEntity((EntityType)LatexModEntities.PROTECTOR_SLIMELING.get(), (Level)_level);
/* 72 */         protectorSlimelingEntity.m_7678_(x, y, z, world.m_5822_().nextFloat() * 360.0F, 0.0F);
/* 73 */         if (protectorSlimelingEntity instanceof Mob) { Mob _mobToSpawn = (Mob)protectorSlimelingEntity;
/* 74 */           _mobToSpawn.m_6518_((ServerLevelAccessor)_level, world.m_6436_(protectorSlimelingEntity.m_142538_()), MobSpawnType.MOB_SUMMONED, null, null); }
/*    */         
/* 76 */         world.m_7967_((Entity)protectorSlimelingEntity); }
/*    */     
/*    */     } 
/*    */   }
/*    */ }
...
/* Location:              C:\Users\Administrator\Desktop\TurnedPatch-m1.18.2-vPTBv5.jar!\net\ltxprogrammer\turned\procedures\ProtectorSlimelingThisEntityKillsAnotherOneProcedure.class
