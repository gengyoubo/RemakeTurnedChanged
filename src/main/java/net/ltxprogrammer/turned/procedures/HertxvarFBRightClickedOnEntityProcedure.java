...
/* loaded from: turned-730838-4352793_mapped_official_1.18.2.jar:net/ltxprogrammer/turned/procedures/HertxvarFBRightClickedOnEntityProcedure.class */
            ...
            if (health2 < f) {
                ...
                if ((sourceentity instanceof LivingEntity) && _tamIsTamedBy.isOwnedBy((LivingEntity) sourceentity)) {
                    if (world instanceof ServerLevel _level) {
                        Entity entityToSpawn = new HertxFBSitEntity((EntityType<HertxFBSitEntity>) LatexModEntities.HERTX_FB_SIT.get(), _level);
