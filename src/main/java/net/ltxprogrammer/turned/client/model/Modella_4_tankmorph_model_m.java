...
/* loaded from: turned-730838-4352793_mapped_official_1.18.2.jar:net/ltxprogrammer/turned/client/model/Modella_4_tankmorph_model_m.class */
public class Modella_4_tankmorph_model_m<T extends Entity> extends EntityModel<T> {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(LatexMod.MODID, "modella_4_tankmorph_model_m"), "main");
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        partdefinition.addOrReplaceChild("Cannon", CubeListBuilder.create().texOffs(94, 57).addBox(-9.0f, 2.5f, 2.25f, 6.0f, 6.0f, 6.0f, new CubeDeformation(0.0f)).texOffs(42, 0).addBox(-8.0f, -1.5f, 3.75f, 4.0f, 4.0f, 4.0f, new CubeDeformation(0.0f)).texOffs(50, 97).addBox(-7.5f, -21.5f, 4.75f, 3.0f, 20.0f, 2.0f, new CubeDeformation(0.0f)).texOffs(106, 69).addBox(-8.5f, 8.5f, 4.25f, 5.0f, 4.0f, 3.0f, new CubeDeformation(0.0f)).texOffs(34, 42).addBox(-8.5f, 8.5f, 3.25f, 5.0f, 2.0f, 1.0f, new CubeDeformation(0.0f)), PartPose.offset(0.0f, -33.0f, 0.0f));
        partdefinition.addOrReplaceChild("LeftArm", CubeListBuilder.create().texOffs(95, 48).addBox(-6.45f, -4.75f, -2.0f, 4.0f, 2.0f, 5.0f, new CubeDeformation(0.0f)).texOffs(84, 84).addBox(-6.45f, -2.75f, -2.0f, 6.0f, 12.0f, 5.0f, new CubeDeformation(0.0f)).texOffs(88, 75).addBox(-5.95f, 8.25f, -2.5f, 6.0f, 1.0f, 6.0f, new CubeDeformation(0.0f)).texOffs(0, 70).addBox(-6.95f, 9.25f, -2.5f, 7.0f, 17.0f, 6.0f, new CubeDeformation(0.0f)), PartPose.offset(-9.0f, -30.0f, 0.0f));
        partdefinition.addOrReplaceChild("RightArm", CubeListBuilder.create().texOffs(84, 0).addBox(0.45f, -2.75f, -2.0f, 6.0f, 12.0f, 5.0f, new CubeDeformation(0.0f)).texOffs(101, 82).addBox(2.45f, -4.75f, -2.0f, 4.0f, 2.0f, 5.0f, new CubeDeformation(0.0f)).texOffs(94, 29).addBox(-0.05f, 8.25f, -2.5f, 6.0f, 1.0f, 6.0f, new CubeDeformation(0.0f)).texOffs(26, 76).addBox(-0.05f, 9.25f, -2.5f, 7.0f, 17.0f, 6.0f, new CubeDeformation(0.0f)), PartPose.offset(9.0f, -30.0f, 0.0f));
