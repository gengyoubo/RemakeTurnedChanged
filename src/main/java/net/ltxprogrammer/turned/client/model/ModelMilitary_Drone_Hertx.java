...
/* loaded from: turned-730838-4352793_mapped_official_1.18.2.jar:net/ltxprogrammer/turned/client/model/ModelMilitary_Drone_Hertx.class */
public class ModelMilitary_Drone_Hertx<T extends Entity> extends EntityModel<T> {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(LatexMod.MODID, "model_military_drone_hertx"), "main");
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        Tail.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(0, 15).addBox(-0.25f, 4.2f, 7.0f, 2.0f, 2.0f, 11.0f, new CubeDeformation(0.0f)), PartPose.offsetAndRotation(-0.75f, -9.2f, 0.0f, -0.7854f, 0.0f, 0.0f));
        PartDefinition M16 = partdefinition.addOrReplaceChild("LeftArm", CubeListBuilder.create().texOffs(54, 21).addBox(-2.0f, -1.8f, -2.0f, 3.0f, 7.0f, 4.0f, new CubeDeformation(0.0f)).texOffs(64, 7).addBox(-0.375f, -2.8f, -1.875f, 3.0f, 3.0f, 4.0f, new CubeDeformation(0.0f)).texOffs(39, 15).addBox(-3.0f, 5.2f, -2.0f, 4.0f, 6.0f, 4.0f, new CubeDeformation(0.0f)).texOffs(46, 10).addBox(-3.0f, 11.2f, 1.0f, 1.0f, 1.0f, 1.0f, new CubeDeformation(0.0f)).texOffs(26, 42).addBox(-3.0f, 11.2f, -2.0f, 1.0f, 1.0f, 1.0f, new CubeDeformation(0.0f)).texOffs(36, 12).addBox(-1.0f, 11.2f, -2.0f, 1.0f, 1.0f, 1.0f, new CubeDeformation(0.0f)).texOffs(10, 39).addBox(-3.0f, 11.2f, -0.5f, 1.0f, 1.0f, 1.0f, new CubeDeformation(0.0f)), PartPose.offsetAndRotation(-5.0f, 1.0f, 0.125f, -1.5704f, -0.1308f, 0.0379f)).addOrReplaceChild("M16", CubeListBuilder.create(), PartPose.offsetAndRotation(-0.4987f, 9.9293f, -2.0497f, 1.5708f, 0.0f, 0.0873f));
        ...
        Grip.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(0, 0).addBox(-0.5934f, 2.0486f, 1.6886f, 1.0f, 3.0f, 1.0f, new CubeDeformation(0.0f)), PartPose.offsetAndRotation(0.1225f, -0.4268f, -0.7684f, 0.3927f, 0.0f, 0.0f));
        Grip.addOrReplaceChild("cube_r7", CubeListBuilder.create().texOffs(48, 25).addBox(-0.4934f, 2.0486f, 0.5386f, 1.0f, 3.0f, 2.0f, new CubeDeformation(0.0f)), PartPose.offsetAndRotation(0.1225f, -0.7768f, 0.1316f, 0.3927f, 0.0f, 0.0f));
        M16.addOrReplaceChild("Mag", CubeListBuilder.create().texOffs(30, 25).addBox(-0.4934f, 1.9643f, -3.2225f, 1.0f, 3.0f, 2.0f, new CubeDeformation(0.0f)), PartPose.offset(0.1225f, -1.7768f, 0.0066f)).addOrReplaceChild("cube_r8", CubeListBuilder.create().texOffs(48, 0).addBox(-0.4934f, 4.6897f, -0.8395f, 1.0f, 3.0f, 2.0f, new CubeDeformation(0.0f)), PartPose.offsetAndRotation(0.0f, 0.1875f, -0.5f, -0.3927f, 0.0f, 0.0f));
        ...
        LeftLeg.addOrReplaceChild("cube_r10", CubeListBuilder.create().texOffs(57, 32).addBox(-2.0f, 4.3f, 3.0f, 4.0f, 6.0f, 3.0f, new CubeDeformation(0.0f)), PartPose.offsetAndRotation(-0.25f, 1.0f, 0.0f, -0.3927f, 0.0f, 0.0f));
        LeftLeg.addOrReplaceChild("cube_r11", CubeListBuilder.create().texOffs(0, 0).addBox(-3.5625f, -3.5f, -2.0f, 3.0f, 7.0f, 4.0f, new CubeDeformation(0.0f)), PartPose.offsetAndRotation(1.8125f, 6.0735f, -0.1237f, 0.7418f, 0.0f, 0.0f));
        LeftLeg.addOrReplaceChild("cube_r12", CubeListBuilder.create().texOffs(14, 48).addBox(-2.0f, -0.6f, -2.2f, 4.0f, 6.0f, 4.0f, new CubeDeformation(0.0f)), PartPose.offsetAndRotation(-0.125f, 1.0f, 0.0f, -0.3927f, 0.0f, 0.0f));
        ...
        RightLeg.addOrReplaceChild("cube_r13", CubeListBuilder.create().texOffs(36, 58).addBox(-2.0f, 4.3f, 3.0f, 4.0f, 6.0f, 3.0f, new CubeDeformation(0.0f)), PartPose.offsetAndRotation(0.25f, 1.0f, 0.0f, -0.3927f, 0.0f, 0.0f));
        RightLeg.addOrReplaceChild("cube_r14", CubeListBuilder.create().texOffs(50, 3).addBox(0.5625f, -3.5f, -2.0f, 3.0f, 7.0f, 4.0f, new CubeDeformation(0.0f)), PartPose.offsetAndRotation(-1.9375f, 6.0735f, -0.1237f, 0.7418f, 0.0f, 0.0f));
        RightLeg.addOrReplaceChild("cube_r15", CubeListBuilder.create().texOffs(40, 48).addBox(-2.0f, -0.6f, -2.2f, 4.0f, 6.0f, 4.0f, new CubeDeformation(0.0f)), PartPose.offsetAndRotation(0.125f, 1.0f, 0.0f, -0.3927f, 0.0f, 0.0f));
