...
/* loaded from: turned-730838-4352793_mapped_official_1.18.2.jar:net/ltxprogrammer/turned/client/model/ModelDrone_Hertx_Sit.class */
public class ModelDrone_Hertx_Sit<T extends Entity> extends EntityModel<T> {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(LatexMod.MODID, "model_drone_hertx_sit"), "main");
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        partdefinition.addOrReplaceChild("RightArm", CubeListBuilder.create().texOffs(14, 52).addBox(-1.0f, -1.8f, -2.0f, 3.0f, 7.0f, 4.0f, new CubeDeformation(0.0f)).texOffs(56, 9).addBox(-1.0f, -2.8f, -2.0f, 2.0f, 1.0f, 4.0f, new CubeDeformation(0.0f)).texOffs(0, 38).addBox(-1.0f, 5.2f, -2.0f, 4.0f, 6.0f, 4.0f, new CubeDeformation(0.0f)).texOffs(26, 19).addBox(0.0f, 11.2f, -2.0f, 1.0f, 1.0f, 1.0f, new CubeDeformation(0.0f)).texOffs(6, 0).addBox(2.0f, 11.2f, -2.0f, 1.0f, 1.0f, 1.0f, new CubeDeformation(0.0f)).texOffs(0, 0).addBox(2.0f, 11.2f, -0.5f, 1.0f, 1.0f, 1.0f, new CubeDeformation(0.0f)).texOffs(20, 23).addBox(2.0f, 11.2f, 1.0f, 1.0f, 1.0f, 1.0f, new CubeDeformation(0.0f)), PartPose.offsetAndRotation(5.0f, 13.0f, 0.125f, 0.0f, -0.48f, -0.2618f));
        partdefinition.addOrReplaceChild("LeftArm", CubeListBuilder.create().texOffs(52, 17).addBox(-2.0f, -1.8f, -2.0f, 3.0f, 7.0f, 4.0f, new CubeDeformation(0.0f)).texOffs(47, 59).addBox(-1.0f, -2.8f, -2.0f, 2.0f, 1.0f, 4.0f, new CubeDeformation(0.0f)).texOffs(24, 32).addBox(-3.0f, 5.2f, -2.0f, 4.0f, 6.0f, 4.0f, new CubeDeformation(0.0f)).texOffs(32, 10).addBox(-3.0f, 11.2f, 1.0f, 1.0f, 1.0f, 1.0f, new CubeDeformation(0.0f)).texOffs(32, 8).addBox(-3.0f, 11.2f, -2.0f, 1.0f, 1.0f, 1.0f, new CubeDeformation(0.0f)).texOffs(29, 20).addBox(-1.0f, 11.2f, -2.0f, 1.0f, 1.0f, 1.0f, new CubeDeformation(0.0f)).texOffs(0, 31).addBox(-3.0f, 11.2f, -0.5f, 1.0f, 1.0f, 1.0f, new CubeDeformation(0.0f)), PartPose.offsetAndRotation(-5.0f, 13.0f, 0.125f, 0.0f, 0.3491f, 0.3054f));
        PartDefinition RightLeg = partdefinition.addOrReplaceChild("RightLeg", CubeListBuilder.create().texOffs(56, 28).addBox(-2.0f, -0.8f, -2.0f, 4.0f, 2.0f, 4.0f, new CubeDeformation(0.0f)).texOffs(35, 37).addBox(-1.625f, 10.0f, -2.9102f, 4.0f, 3.0f, 5.0f, new CubeDeformation(0.0f)).texOffs(23, 13).addBox(1.375f, 11.0f, -3.9102f, 1.0f, 2.0f, 1.0f, new CubeDeformation(0.0f)).texOffs(0, 21).addBox(-1.625f, 11.0f, -3.9102f, 1.0f, 2.0f, 1.0f, new CubeDeformation(0.0f)), PartPose.offsetAndRotation(2.0f, 23.0f, -1.0f, -1.6844f, -0.3829f, -0.0894f));
        RightLeg.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(56, 0).addBox(-2.0f, 4.3f, 3.0f, 4.0f, 6.0f, 3.0f, new CubeDeformation(0.0f)), PartPose.offsetAndRotation(0.25f, 1.0f, 0.0f, -0.3927f, 0.0f, 0.0f));
        RightLeg.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(48, 48).addBox(0.5625f, -3.5f, -2.0f, 3.0f, 7.0f, 4.0f, new CubeDeformation(0.0f)), PartPose.offsetAndRotation(-1.9375f, 6.0735f, -0.1237f, 0.7418f, 0.0f, 0.0f));
        RightLeg.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(32, 45).addBox(-2.0f, -0.6f, -2.2f, 4.0f, 6.0f, 4.0f, new CubeDeformation(0.0f)), PartPose.offsetAndRotation(0.125f, 1.0f, 0.0f, -0.3927f, 0.0f, 0.0f));
        PartDefinition LeftLeg = partdefinition.addOrReplaceChild("LeftLeg", CubeListBuilder.create().texOffs(58, 45).addBox(-2.0f, -0.8f, -2.0f, 4.0f, 2.0f, 4.0f, new CubeDeformation(0.0f)).texOffs(36, 27).addBox(-2.375f, 10.0f, -2.9102f, 4.0f, 3.0f, 5.0f, new CubeDeformation(0.0f)).texOffs(3, 17).addBox(0.625f, 11.0f, -3.9102f, 1.0f, 2.0f, 1.0f, new CubeDeformation(0.0f)).texOffs(19, 13).addBox(-2.375f, 11.0f, -3.9102f, 1.0f, 2.0f, 1.0f, new CubeDeformation(0.0f)), PartPose.offsetAndRotation(-2.0f, 23.0f, -1.0f, -1.6325f, 0.2955f, 0.2562f));
        LeftLeg.addOrReplaceChild("cube_r7", CubeListBuilder.create().texOffs(55, 36).addBox(-2.0f, 4.3f, 3.0f, 4.0f, 6.0f, 3.0f, new CubeDeformation(0.0f)), PartPose.offsetAndRotation(-0.25f, 1.0f, 0.0f, -0.3927f, 0.0f, 0.0f));
        LeftLeg.addOrReplaceChild("cube_r8", CubeListBuilder.create().texOffs(0, 48).addBox(-3.5625f, -3.5f, -2.0f, 3.0f, 7.0f, 4.0f, new CubeDeformation(0.0f)), PartPose.offsetAndRotation(1.8125f, 6.0735f, -0.1237f, 0.7418f, 0.0f, 0.0f));
        LeftLeg.addOrReplaceChild("cube_r9", CubeListBuilder.create().texOffs(16, 42).addBox(-2.0f, -0.6f, -2.2f, 4.0f, 6.0f, 4.0f, new CubeDeformation(0.0f)), PartPose.offsetAndRotation(-0.125f, 1.0f, 0.0f, -0.3927f, 0.0f, 0.0f));
