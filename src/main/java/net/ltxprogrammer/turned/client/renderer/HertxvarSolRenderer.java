...
public class HertxvarSolRenderer extends MobRenderer<HertxvarSolEntity, Modelhertx_model_s1<HertxvarSolEntity>> {
    public HertxvarSolRenderer(EntityRendererProvider.Context context) {
        ...
        addLayer(new EyesLayer<>(this) { // from class: net.ltxprogrammer.turned.client.renderer.HertxvarSolRenderer.1
    ...
    public @NotNull ResourceLocation getTextureLocation(@NotNull HertxvarSolEntity entity) {
