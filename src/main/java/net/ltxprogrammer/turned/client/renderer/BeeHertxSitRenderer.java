...
public class BeeHertxSitRenderer extends MobRenderer<BeeHertxSitEntity, Modelbee_hertx_sit_model<BeeHertxSitEntity>> {
    public BeeHertxSitRenderer(EntityRendererProvider.Context context) {
        ...
        addLayer(new EyesLayer<>(this) { // from class: net.ltxprogrammer.turned.client.renderer.BeeHertxSitRenderer.1
    ...
    public @NotNull ResourceLocation getTextureLocation(@NotNull BeeHertxSitEntity entity) {
