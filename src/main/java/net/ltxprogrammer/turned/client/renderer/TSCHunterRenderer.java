...
public class TSCHunterRenderer extends MobRenderer<TSCHunterEntity, ModelTSC_Hunter_model<TSCHunterEntity>> {
    public TSCHunterRenderer(EntityRendererProvider.Context context) {
        ...
        addLayer(new EyesLayer<>(this) { // from class: net.ltxprogrammer.turned.client.renderer.TSCHunterRenderer.1
    ...
    public @NotNull ResourceLocation getTextureLocation(@NotNull TSCHunterEntity entity) {
