...
public class NXTSitRenderer extends MobRenderer<NXTSitEntity, Modelnxt_hertx_sit_model<NXTSitEntity>> {
    public NXTSitRenderer(EntityRendererProvider.Context context) {
        ...
        addLayer(new EyesLayer<>(this) { // from class: net.ltxprogrammer.turned.client.renderer.NXTSitRenderer.1
    ...
    public @NotNull ResourceLocation getTextureLocation(@NotNull NXTSitEntity entity) {
