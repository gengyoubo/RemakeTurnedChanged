...
/* loaded from: turned-730838-4352793_mapped_official_1.18.2.jar:net/ltxprogrammer/turned/client/renderer/ScientistRenderer.class */
public class ScientistRenderer extends HumanoidMobRenderer<ScientistEntity, HumanoidModel<ScientistEntity>> {
    ...
    public @NotNull ResourceLocation getTextureLocation(@NotNull ScientistEntity entity) {
        return new ResourceLocation("turned:textures/entities/scientist_steve.png");
    }
}
