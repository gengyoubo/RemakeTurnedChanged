...
/* loaded from: turned-730838-4352793_mapped_official_1.18.2.jar:net/ltxprogrammer/turned/client/renderer/EvilMilitaryRenderer.class */
public class EvilMilitaryRenderer extends HumanoidMobRenderer<EvilMilitaryEntity, HumanoidModel<EvilMilitaryEntity>> {
    public EvilMilitaryRenderer(EntityRendererProvider.Context context) {
    ...
    public ResourceLocation getTextureLocation(EvilMilitaryEntity entity) {
        return new ResourceLocation("turned:textures/entities/evil_military_steve.png");
    }
}
