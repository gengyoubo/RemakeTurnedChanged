...
/* loaded from: turned-730838-4352793_mapped_official_1.18.2.jar:net/ltxprogrammer/turned/client/renderer/EvilSniperRenderer.class */
public class EvilSniperRenderer extends HumanoidMobRenderer<EvilSniperEntity, HumanoidModel<EvilSniperEntity>> {
    ...
    public @NotNull ResourceLocation getTextureLocation(@NotNull EvilSniperEntity entity) {
