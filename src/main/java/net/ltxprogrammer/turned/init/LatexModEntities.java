...
public class LatexModEntities {
    ...
    static {
        ...
        DARK_LATEX_CENTAUR = register("dark_latex_centaur", Builder.of(DarkLatexCentaurEntity::new, MobCategory.MONSTER).setShouldReceiveVelocityUpdates(true).setTrackingRange(128).setUpdateInterval(3).setCustomClientFactory(DarkLatexCentaurEntity::new).sized(1.2F, 2.25F));
