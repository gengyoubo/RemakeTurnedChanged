...
public class AHVHertxSitEntity extends TamableAnimal {
    ...
    protected void registerGoals() {
        ...
        this.targetSelector.addGoal(2, new NearestAttackableTargetGoal(this, SlimelingEntity.class, false, false) {
            public boolean canUse() {
                double x = AHVHertxSitEntity.this.getX();
                double y = AHVHertxSitEntity.this.getY();
                double z = AHVHertxSitEntity.this.getZ();
                Entity entity = AHVHertxSitEntity.this;
                Level world = AHVHertxSitEntity.this.level;
    ...
    public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
        ...
        AHVHertxSitRightClickedOnEntityProcedure.execute(world, x, y, z, entity, sourceentity);
        return retval;
    }
