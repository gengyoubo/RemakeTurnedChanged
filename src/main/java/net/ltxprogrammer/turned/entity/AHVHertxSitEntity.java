...
/*     */ import net.ltxprogrammer.turned.procedures.AHVHertxSitRightClickedOnEntityProcedure;
...
/*     */ 
/*     */ public class AHVHertxSitEntity
/*     */   extends TamableAnimal {
/*     */   public AHVHertxSitEntity(PlayMessages.SpawnEntity packet, Level world) {
/*  61 */     this((EntityType<AHVHertxSitEntity>)LatexModEntities.AHV_HERTX_SIT.get(), world);
/*     */   }
/*     */   
...
/*  66 */     this.f_21364_ = 4;
/*  67 */     m_21557_(false);
/*  68 */     m_6593_((Component)new TextComponent("§a[Idle]"));
/*  69 */     m_20340_(true);
/*  70 */     m_21530_();
/*     */   }
/*     */ 
...
/*  90 */             double x = AHVHertxSitEntity.this.m_20185_();
/*  91 */             double y = AHVHertxSitEntity.this.m_20186_();
/*  92 */             double z = AHVHertxSitEntity.this.m_20189_();
/*  93 */             AHVHertxSitEntity aHVHertxSitEntity = AHVHertxSitEntity.this;
/*  94 */             Level world = AHVHertxSitEntity.this.f_19853_;
/*  95 */             return (super.m_8036_() && CheckiftamedProcedure.execute((LevelAccessor)world, x, y, z, (Entity)aHVHertxSitEntity));
/*     */           }
/*     */         });
...
/* 209 */     AHVHertxSitEntity aHVHertxSitEntity = this;
/* 210 */     Level world = this.f_19853_;
/*     */     
/* 212 */     AHVHertxSitRightClickedOnEntityProcedure.execute((LevelAccessor)world, x, y, z, (Entity)aHVHertxSitEntity, (Entity)sourceentity);
/* 213 */     return retval;
/*     */   }
/*     */ 
/*     */   
...
/* 224 */     AHVHertxSitEntity retval = (AHVHertxSitEntity)((EntityType)LatexModEntities.AHV_HERTX_SIT.get()).m_20615_((Level)serverWorld);
...
/* 231 */     return List.<Item>of((Item)ChangedItems.DARK_LATEX_GOO.get(), (Item)LatexModItems.SLIMEESSENCE.get(), (Item)LatexModItems.SLIMEESSENCE.get())
/* 232 */       .contains(stack.m_41720_());
/*     */   }
/*     */ 
/*     */   
...
/* 240 */     builder = builder.m_22268_(Attributes.f_22279_, 0.0D);
/* 241 */     builder = builder.m_22268_(Attributes.f_22276_, 30.0D);
/* 242 */     builder = builder.m_22268_(Attributes.f_22284_, 5.0D);
/* 243 */     builder = builder.m_22268_(Attributes.f_22281_, 0.0D);
...
/* Location:              C:\Users\Administrator\Desktop\TurnedPatch-m1.18.2-vPTBv5.jar!\net\ltxprogrammer\turned\entity\AHVHertxSitEntity.class
