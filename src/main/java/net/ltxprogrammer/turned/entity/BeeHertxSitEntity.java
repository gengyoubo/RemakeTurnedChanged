...
public class BeeHertxSitEntity extends TamableAnimal {
    ...
    public BeeHertxSitEntity(EntityType<BeeHertxSitEntity> type, Level world) {
        ...
        this.xpReward = 4;
        this.setNoAi(false);
        this.setCustomName(new TextComponent("§e[Idle]"));
    ...
    public @NotNull InteractionResult mobInteract(Player sourceentity, @NotNull InteractionHand hand) {
        ...
        BeeHertxSitRightClickedOnEntityProcedure.execute(world, x, y, z, entity, sourceentity);
        return retval;
    }
    ...
    public AgeableMob getBreedOffspring(@NotNull ServerLevel serverWorld, @NotNull AgeableMob ageable) {
        BeeHertxSitEntity retval = (BeeHertxSitEntity)((EntityType) LatexModEntities.BEE_HERTX_SIT.get()).create(serverWorld);
