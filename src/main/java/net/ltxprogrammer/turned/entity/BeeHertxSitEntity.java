...
/*     */ import net.ltxprogrammer.turned.procedures.BeeHertxSitRightClickedOnEntityProcedure;
...
/*  64 */     this.f_21364_ = 4;
/*  65 */     m_21557_(false);
/*  66 */     m_6593_((Component)new TextComponent("§e[Idle]"));
/*  67 */     m_20340_(true);
/*  68 */     m_21530_();
/*     */   }
/*     */ 
...
/*     */           }
/*     */         });
/*  85 */     this.f_21345_.m_25352_(2, (Goal)new LookAtPlayerGoal((Mob)this, Player.class, 3.0F));
/*  86 */     this.f_21345_.m_25352_(3, (Goal)new LookAtPlayerGoal((Mob)this, PathfinderMob.class, 6.0F));
...
/* 211 */     BeeHertxSitEntity retval = (BeeHertxSitEntity)((EntityType)LatexModEntities.BEE_HERTX_SIT.get()).m_20615_((Level)serverWorld);
...
/* 218 */     return List.<Item>of(new Item[] { Items.f_42784_, Items.f_42787_, (Item)ChangedItems.DARK_LATEX_GOO.get(), Blocks.f_50111_.m_5456_(), Blocks.f_50112_.m_5456_(), Blocks.f_50113_
/* 219 */           .m_5456_(), Blocks.f_50114_.m_5456_(), Blocks.f_50115_.m_5456_(), Blocks.f_50116_.m_5456_(), Blocks.f_50117_
/* 220 */           .m_5456_(), Blocks.f_50118_.m_5456_(), Blocks.f_50119_.m_5456_(), Blocks.f_50120_.m_5456_(), Blocks.f_50121_
/* 221 */           .m_5456_(), Blocks.f_50355_.m_5456_() }).contains(stack.m_41720_());
/*     */   }
/*     */ 
/*     */   
...
/* 228 */     AttributeSupplier.Builder builder = Mob.m_21552_();
/* 229 */     builder = builder.m_22268_(Attributes.f_22279_, 0.0D);
/* 230 */     builder = builder.m_22268_(Attributes.f_22276_, 30.0D);
/* 231 */     builder = builder.m_22268_(Attributes.f_22284_, 5.0D);
/* 232 */     builder = builder.m_22268_(Attributes.f_22281_, 0.0D);
/* 233 */     builder = builder.m_22268_(Attributes.f_22277_, 16.0D);
/* 234 */     builder = builder.m_22268_(Attributes.f_22278_, 0.5D);
/* 235 */     return builder;
/*     */   }
/*     */ }


/* Location:              C:\Users\Administrator\Desktop\TurnedPatch-m1.18.2-vPTBv5.jar!\net\ltxprogrammer\turned\entity\BeeHertxSitEntity.class
