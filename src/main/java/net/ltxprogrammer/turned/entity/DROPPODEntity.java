...
/* loaded from: turned-730838-4352793_mapped_official_1.18.2.jar:net/ltxprogrammer/turned/entity/DROPPODEntity.class */
public class DROPPODEntity extends PathfinderMob {
    public DROPPODEntity(PlayMessages.SpawnEntity packet, Level world) {
        this(LatexModEntities.DROPPOD.get(), world);
    }
