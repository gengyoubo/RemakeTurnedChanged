...
public class OverundershotgunEntity extends AbstractArrow implements ItemSupplier {
    public OverundershotgunEntity(PlayMessages.SpawnEntity packet, Level world) {
        super(LatexModEntities.OVERUNDERSHOTGUN.get(), world);
    }
    ...
    public static OverundershotgunEntity shoot(Level world, LivingEntity entity, Random random, float power, double damage, int knockback) {
        OverundershotgunEntity entityarrow = new OverundershotgunEntity(LatexModEntities.OVERUNDERSHOTGUN.get(), entity, world);
        ...
        world.playSound(null, entity.getX(), entity.getY(), entity.getZ(), Objects.requireNonNull(ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("turned:shotgun-blast"))), SoundSource.PLAYERS, 1.0f, (1.0f / ((random.nextFloat() * 0.5f) + 1.0f)) + (power / 2.0f));
        return entityarrow;
    }

    public static OverundershotgunEntity shoot(LivingEntity entity, LivingEntity target) {
        OverundershotgunEntity entityarrow = new OverundershotgunEntity(LatexModEntities.OVERUNDERSHOTGUN.get(), entity, entity.level);
        ...
        entity.level.playSound(null, entity.getX(), entity.getY(), entity.getZ(), Objects.requireNonNull(ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("turned:shotgun-blast"))), SoundSource.PLAYERS, 1.0f, 1.0f / ((new Random().nextFloat() * 0.5f) + 1.0f));
        return entityarrow;
    }
}
