...
public class TargetCheck {
    public static final Predicate<LivingEntity> IS_SLIMELING = entity -> {
        if (entity == null) {
            return false;
        }
        return entity.getType().is(TagKey.create(Registry.ENTITY_TYPE_REGISTRY, new ResourceLocation("turned:slimeling")));
    };
    public static final Predicate<LivingEntity> IS_LATEX = entity -> {
    ...
    public static final Predicate<LivingEntity> IS_EVIL = entity -> {
        if (entity == null) {
            return false;
        }
    ...
    public static final Predicate<LivingEntity> IS_GOOD = entity -> {
        if (entity == null) {
            return false;
        }
