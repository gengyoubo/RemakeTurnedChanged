...
/* 27 */     super((EntityType)LatexModEntities.AR_70_ASSAULT_RIFLE.get(), world);
/*    */   }
/*    */   
...
/* 72 */     AR70AssaultRifleEntity entityarrow = new AR70AssaultRifleEntity((EntityType<? extends AR70AssaultRifleEntity>)LatexModEntities.AR_70_ASSAULT_RIFLE.get(), entity, world);
...
/* 80 */         .getValue(new ResourceLocation("turned:rifle_shot")), SoundSource.PLAYERS, 1.0F, 1.0F / (random
...
/* 86 */     AR70AssaultRifleEntity entityarrow = new AR70AssaultRifleEntity((EntityType<? extends AR70AssaultRifleEntity>)LatexModEntities.AR_70_ASSAULT_RIFLE.get(), entity, entity.f_19853_);
...
/* 90 */     entityarrow.m_6686_(dx, dy - entityarrow.m_20186_() + Math.hypot(dx, dz) * 0.20000000298023224D, dz, 4.8F, 12.0F);
/* 91 */     entityarrow.m_20225_(true);
/* 92 */     entityarrow.m_36781_(1.0D);
/* 93 */     entityarrow.m_36735_(0);
...
/* 97 */         .getValue(new ResourceLocation("turned:rifle_shot")), SoundSource.PLAYERS, 1.0F, 1.0F / ((new Random())
...
/* Location:              C:\Users\Administrator\Desktop\TurnedPatch-m1.18.2-vPTBv5.jar!\net\ltxprogrammer\turned\entity\AR70AssaultRifleEntity.class
