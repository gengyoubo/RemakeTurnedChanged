...
public class NXTHertxEntity extends TamableAnimal {
    public NXTHertxEntity(PlayMessages.SpawnEntity packet, Level world) {
        this(LatexModEntities.NXT_HERTX.get(), world);
    }
    ...
    public boolean isFood(ItemStack stack) {
        return List.of(ChangedItems.DARK_LATEX_GOO.get(), Items.REDSTONE, LatexModItems.BATTERY.get()).contains(stack.getItem());
    }
