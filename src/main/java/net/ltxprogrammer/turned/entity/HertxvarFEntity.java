...
/*     */ import net.ltxprogrammer.turned.procedures.HertxvarFRightClickedOnEntityProcedure;
...
/*     */ 
/*     */ public class HertxvarFEntity
/*     */   extends TamableAnimal {
/*     */   public HertxvarFEntity(PlayMessages.SpawnEntity packet, Level world) {
/*  64 */     this((EntityType<HertxvarFEntity>)LatexModEntities.HERTXVAR_F.get(), world);
/*     */   }
/*     */   
...
/*  91 */             double x = HertxvarFEntity.this.m_20185_();
/*  92 */             double y = HertxvarFEntity.this.m_20186_();
/*  93 */             double z = HertxvarFEntity.this.m_20189_();
/*  94 */             HertxvarFEntity hertxvarFEntity = HertxvarFEntity.this;
/*  95 */             Level world = HertxvarFEntity.this.f_19853_;
/*  96 */             return (super.m_8036_() && CheckiftamedProcedure.execute((LevelAccessor)world, x, y, z, (Entity)hertxvarFEntity));
/*     */           }
/*     */         });
...
/* 101 */     this.f_21345_.m_25352_(5, (Goal)new FollowOwnerGoal(this, 1.0D, 3.0F, 64.0F, false));
...
/* 211 */     HertxvarFEntity hertxvarFEntity = this;
/* 212 */     Level world = this.f_19853_;
/*     */     
/* 214 */     HertxvarFRightClickedOnEntityProcedure.execute((LevelAccessor)world, x, y, z, (Entity)hertxvarFEntity, (Entity)sourceentity);
/* 215 */     return retval;
/*     */   }
/*     */ 
/*     */   
...
/* 232 */     HertxvarFEntity retval = (HertxvarFEntity)((EntityType)LatexModEntities.HERTXVAR_F.get()).m_20615_((Level)serverWorld);
...
/* 239 */     return List.<Item>of((Item)ChangedItems.DARK_LATEX_GOO.get(), (Item)LatexModItems.LATEX_SOUP.get()).contains(stack.m_41720_());
/*     */   }
/*     */ 
/*     */   
...
/* 247 */     builder = builder.m_22268_(Attributes.f_22279_, 0.32D);
/* 248 */     builder = builder.m_22268_(Attributes.f_22276_, 45.0D);
/* 249 */     builder = builder.m_22268_(Attributes.f_22284_, 6.0D);
/* 250 */     builder = builder.m_22268_(Attributes.f_22281_, 5.0D);
/* 251 */     builder = builder.m_22268_(Attributes.f_22277_, 16.0D);
/* 252 */     builder = builder.m_22268_(Attributes.f_22278_, 0.2D);
/* 253 */     return builder;
/*     */   }
/*     */ }


/* Location:              C:\Users\Administrator\Desktop\TurnedPatch-m1.18.2-vPTBv5.jar!\net\ltxprogrammer\turned\entity\HertxvarFEntity.class
