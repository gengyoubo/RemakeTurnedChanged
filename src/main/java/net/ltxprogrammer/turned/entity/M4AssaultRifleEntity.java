...
public class M4AssaultRifleEntity extends AbstractArrow implements ItemSupplier {
    public M4AssaultRifleEntity(PlayMessages.SpawnEntity packet, Level world) {
        super(LatexModEntities.M_4_ASSAULT_RIFLE.get(), world);
    }
    ...
    public static M4AssaultRifleEntity shoot(Level world, LivingEntity entity, Random random, float power, double damage, int knockback) {
        M4AssaultRifleEntity entityarrow = new M4AssaultRifleEntity(LatexModEntities.M_4_ASSAULT_RIFLE.get(), entity, world);
    ...
    public static void shoot(LivingEntity entity, LivingEntity target) {
        M4AssaultRifleEntity entityarrow = new M4AssaultRifleEntity(LatexModEntities.M_4_ASSAULT_RIFLE.get(), entity, entity.level);
