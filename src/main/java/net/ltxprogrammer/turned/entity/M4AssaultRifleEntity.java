...
/* loaded from: turned-730838-4352793_mapped_official_1.18.2.jar:net/ltxprogrammer/turned/entity/M4AssaultRifleEntity.class */
public class M4AssaultRifleEntity extends AbstractArrow implements ItemSupplier {
    ...
    public static M4AssaultRifleEntity shoot(LivingEntity entity, LivingEntity target) {
        ...
        entityarrow.setSilent(true);
        entityarrow.setBaseDamage(1.2000000000000002d);
