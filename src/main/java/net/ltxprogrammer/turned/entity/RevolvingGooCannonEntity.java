...
/*  34 */     super((EntityType)LatexModEntities.REVOLVING_GOO_CANNON.get(), world);
/*     */   }
/*     */   
...
/*  57 */     return new ItemStack((ItemLike)LatexModItems.BULLETICON.get());
/*     */   }
/*     */ 
/*     */   
/*     */   protected ItemStack m_7941_() {
/*  62 */     return new ItemStack((ItemLike)ChangedItems.DARK_LATEX_GOO.get());
/*     */   }
/*     */ 
/*     */   
...
/*  93 */     RevolvingGooCannonEntity entityarrow = new RevolvingGooCannonEntity((EntityType<? extends RevolvingGooCannonEntity>)LatexModEntities.REVOLVING_GOO_CANNON.get(), entity, world);
...
/* 101 */         .getValue(new ResourceLocation("block.slime_block.hit")), SoundSource.PLAYERS, 1.0F, 1.0F / (random
...
/* 107 */     RevolvingGooCannonEntity entityarrow = new RevolvingGooCannonEntity((EntityType<? extends RevolvingGooCannonEntity>)LatexModEntities.REVOLVING_GOO_CANNON.get(), entity, entity.f_19853_);
...
/* 111 */     entityarrow.m_6686_(dx, dy - entityarrow.m_20186_() + Math.hypot(dx, dz) * 0.20000000298023224D, dz, 2.4F, 12.0F);
/* 112 */     entityarrow.m_20225_(true);
/* 113 */     entityarrow.m_36781_(0.6D);
/* 114 */     entityarrow.m_36735_(1);
...
/* 118 */         .getValue(new ResourceLocation("block.slime_block.hit")), SoundSource.PLAYERS, 1.0F, 1.0F / ((new Random())
...
/* Location:              C:\Users\Administrator\Desktop\TurnedPatch-m1.18.2-vPTBv5.jar!\net\ltxprogrammer\turned\entity\RevolvingGooCannonEntity.class
