...
/*  59 */     this((EntityType<AshburySitEntity>)LatexModEntities.ASHBURY_SIT.get(), world);
/*     */   }
/*     */   
...
/*  64 */     this.f_21364_ = 4;
/*  65 */     m_21557_(false);
/*  66 */     m_6593_((Component)new TextComponent("§6[Idle]"));
/*  67 */     m_20340_(true);
/*  68 */     m_21530_();
/*     */   }
/*     */ 
...
/*     */           }
/*     */         });
/*  85 */     this.f_21345_.m_25352_(2, (Goal)new LookAtPlayerGoal((Mob)this, Player.class, 5.0F));
...
/* 196 */     AshburySitEntity ashburySitEntity = this;
/* 197 */     Level world = this.f_19853_;
/*     */     
/* 199 */     AshburySitRightClickedOnEntityProcedure.execute((LevelAccessor)world, x, y, z, (Entity)ashburySitEntity, (Entity)sourceentity);
/* 200 */     return retval;
/*     */   }
/*     */ 
/*     */   
...
/* 211 */     AshburySitEntity retval = (AshburySitEntity)((EntityType)LatexModEntities.ASHBURY_SIT.get()).m_20615_((Level)serverWorld);
...
/* 218 */     return List.<Item>of((Item)ChangedItems.DARK_LATEX_GOO.get(), (Item)LatexModItems.LATEX_SOUP.get(), Items.f_42536_).contains(stack.m_41720_());
/*     */   }
/*     */ 
/*     */   
...
/* Location:              C:\Users\Administrator\Desktop\TurnedPatch-m1.18.2-vPTBv5.jar!\net\ltxprogrammer\turned\entity\AshburySitEntity.class
