...
/*     */ 
/*     */ public class HertxSitEntity
/*     */   extends TamableAnimal {
/*     */   public HertxSitEntity(PlayMessages.SpawnEntity packet, Level world) {
/*  61 */     this((EntityType<HertxSitEntity>)LatexModEntities.HERTX_SIT.get(), world);
/*     */   }
/*     */   
...
/*  90 */             double x = HertxSitEntity.this.m_20185_();
/*  91 */             double y = HertxSitEntity.this.m_20186_();
/*  92 */             double z = HertxSitEntity.this.m_20189_();
/*  93 */             HertxSitEntity hertxSitEntity = HertxSitEntity.this;
/*  94 */             Level world = HertxSitEntity.this.f_19853_;
/*  95 */             return (super.m_8036_() && CheckiftamedProcedure.execute((LevelAccessor)world, x, y, z, (Entity)hertxSitEntity));
/*     */           }
/*     */         });
...
/* 209 */     HertxSitEntity hertxSitEntity = this;
/* 210 */     Level world = this.f_19853_;
/*     */     
/* 212 */     HertxSitRightClickedOnEntityProcedure.execute((LevelAccessor)world, x, y, z, (Entity)hertxSitEntity, (Entity)sourceentity);
/* 213 */     return retval;
/*     */   }
/*     */ 
/*     */   
...
/* 224 */     HertxSitEntity retval = (HertxSitEntity)((EntityType)LatexModEntities.HERTX_SIT.get()).m_20615_((Level)serverWorld);
...
/* Location:              C:\Users\Administrator\Desktop\TurnedPatch-m1.18.2-vPTBv5.jar!\net\ltxprogrammer\turned\entity\HertxSitEntity.class
