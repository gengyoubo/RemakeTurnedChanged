...
/*     */ import net.ltxprogrammer.turned.procedures.NXTSitRightClickedOnEntityProcedure;
...
/*     */ 
/*     */ public class NXTSitEntity
/*     */   extends TamableAnimal {
/*     */   public NXTSitEntity(PlayMessages.SpawnEntity packet, Level world) {
/*  59 */     this((EntityType<NXTSitEntity>)LatexModEntities.NXT_SIT.get(), world);
/*     */   }
/*     */   
...
/*  64 */     this.f_21364_ = 4;
/*  65 */     m_21557_(false);
/*  66 */     m_6593_((Component)new TextComponent("§c[Idle]"));
/*  67 */     m_20340_(true);
/*  68 */     m_21530_();
/*     */   }
/*     */ 
...
/* 196 */     NXTSitEntity nXTSitEntity = this;
/* 197 */     Level world = this.f_19853_;
/*     */     
/* 199 */     NXTSitRightClickedOnEntityProcedure.execute((LevelAccessor)world, x, y, z, (Entity)nXTSitEntity, (Entity)sourceentity);
/* 200 */     return retval;
/*     */   }
/*     */ 
/*     */   
...
/* 211 */     NXTSitEntity retval = (NXTSitEntity)((EntityType)LatexModEntities.NXT_SIT.get()).m_20615_((Level)serverWorld);
...
/* 218 */     return List.<Item>of(Items.f_42451_, (Item)ChangedItems.DARK_LATEX_GOO.get(), (Item)LatexModItems.BATTERY.get()).contains(stack.m_41720_());
/*     */   }
/*     */ 
/*     */   
...
/* Location:              C:\Users\Administrator\Desktop\TurnedPatch-m1.18.2-vPTBv5.jar!\net\ltxprogrammer\turned\entity\NXTSitEntity.class
