...
/* loaded from: turned-730838-4352793_mapped_official_1.18.2.jar:net/ltxprogrammer/turned/item/EvilBeretItem.class */
public abstract class EvilBeretItem extends ArmorItem {
    public EvilBeretItem(EquipmentSlot slot, Item.Properties properties) {
        super(new ArmorMaterial() { // from class: net.ltxprogrammer.turned.item.EvilBeretItem.1
    ...
    /* loaded from: turned-730838-4352793_mapped_official_1.18.2.jar:net/ltxprogrammer/turned/item/EvilBeretItem$Helmet.class */
    public static class Helmet extends EvilBeretItem {
        ...
        public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
            return "turned:textures/models/armor/red_beret__layer_1.png";
        }
    }
}
