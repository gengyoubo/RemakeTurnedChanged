...
/* loaded from: 1-1034197-5414946_mapped_official_1.18.2.jar:net/mcreator/latexes/client/gui/SupplyCrateGuiScreen.class */
public class SupplyCrateGuiScreen extends AbstractContainerScreen<SupplyCrateGuiMenu> {
    ...
    private static final ResourceLocation texture = new ResourceLocation("latex:textures/screens/supply_crate_gui.png");
