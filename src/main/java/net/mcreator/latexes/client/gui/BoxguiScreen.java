...
/* loaded from: 1-1034197-5414946_mapped_official_1.18.2.jar:net/mcreator/latexes/client/gui/BoxguiScreen.class */
public class BoxguiScreen extends AbstractContainerScreen<BoxguiMenu> {
    ...
    private static final ResourceLocation texture = new ResourceLocation("latex:textures/screens/boxgui.png");
