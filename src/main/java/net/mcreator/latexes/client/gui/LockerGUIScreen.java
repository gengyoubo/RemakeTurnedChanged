...
/* loaded from: 1-1034197-5414946_mapped_official_1.18.2.jar:net/mcreator/latexes/client/gui/LockerGUIScreen.class */
public class LockerGUIScreen extends AbstractContainerScreen<LockerGUIMenu> {
    ...
    private static final ResourceLocation texture = new ResourceLocation("latex:textures/screens/locker_gui.png");
