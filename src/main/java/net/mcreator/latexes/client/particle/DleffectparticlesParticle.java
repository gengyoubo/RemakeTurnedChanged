...
@OnlyIn(Dist.CLIENT)
/* loaded from: 1-1034197-5414946_mapped_official_1.18.2.jar:net/mcreator/latexes/client/particle/DleffectparticlesParticle.class */
public class DleffectparticlesParticle extends TextureSheetParticle {
    private final SpriteSet spriteSet;
    private float angularVelocity = 0.0f;
    private float angularAcceleration = 1.2f;
    ...
    /* loaded from: 1-1034197-5414946_mapped_official_1.18.2.jar:net/mcreator/latexes/client/particle/DleffectparticlesParticle$DleffectparticlesParticleProvider.class */
