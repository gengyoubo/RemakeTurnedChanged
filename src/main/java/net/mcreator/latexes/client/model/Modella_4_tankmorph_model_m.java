...
/*     */ {
/*  25 */   public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("latex", "modella_4_tankmorph_model_m"), "main");
/*     */   
...
/*  78 */         .addBox(-8.5F, 8.5F, 4.25F, 5.0F, 4.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(34, 42)
/*  79 */         .addBox(-8.5F, 8.5F, 3.25F, 5.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), 
/*  80 */         PartPose.offset(0.0F, -33.0F, 0.0F));
/*  81 */     PartDefinition LeftArm = partdefinition.addOrReplaceChild("LeftArm", 
/*  82 */         CubeListBuilder.create().texOffs(95, 48).addBox(-6.45F, -4.75F, -2.0F, 4.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(84, 84)
/*  83 */         .addBox(-6.45F, -2.75F, -2.0F, 6.0F, 12.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(88, 75)
/*  84 */         .addBox(-5.95F, 8.25F, -2.5F, 6.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(0, 70)
/*  85 */         .addBox(-6.95F, 9.25F, -2.5F, 7.0F, 17.0F, 6.0F, new CubeDeformation(0.0F)), 
/*  86 */         PartPose.offset(-9.0F, -30.0F, 0.0F));
/*  87 */     PartDefinition RightArm = partdefinition.addOrReplaceChild("RightArm", 
/*  88 */         CubeListBuilder.create().texOffs(84, 0).addBox(0.45F, -2.75F, -2.0F, 6.0F, 12.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(101, 82)
/*  89 */         .addBox(2.45F, -4.75F, -2.0F, 4.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(94, 29)
/*  90 */         .addBox(-0.05F, 8.25F, -2.5F, 6.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(26, 76)
/*  91 */         .addBox(-0.05F, 9.25F, -2.5F, 7.0F, 17.0F, 6.0F, new CubeDeformation(0.0F)), 
/*  92 */         PartPose.offset(9.0F, -30.0F, 0.0F));
...
/* 125 */     this.LeftArm.xRot = Mth.cos(limbSwing * 0.6662F) * limbSwingAmount;
/* 126 */     this.RightLeg.xRot = Mth.cos(limbSwing * 1.0F) * 1.0F * limbSwingAmount;
/*     */   }
/*     */ }


/* Location:              C:\Users\Administrator\.gradle\caches\forge_gradle\deobf_dependencies\curse\maven\1-1034197\5414946_mapped_official_1.18.2\1-1034197-5414946_mapped_official_1.18.2.jar!\net\mcreator\latexes\client\model\Modella_4_tankmorph_model_m.class
