...
/*     */ {
/*  25 */   public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("latex", "model_protector_remaster"), "main");
...
/*  87 */         CubeListBuilder.create().texOffs(14, 27).addBox(-1.8264F, 6.0152F, -2.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(27, 17)
/*  88 */         .addBox(0.1736F, 6.0152F, 1.0F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 30)
/*  89 */         .addBox(0.1736F, 6.0152F, -0.5F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(14, 30)
/*  90 */         .addBox(0.1736F, 6.0152F, -2.0F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(34, 48)
/*  91 */         .addBox(-1.8264F, -0.9848F, -2.0F, 4.0F, 7.0F, 4.0F, new CubeDeformation(0.0F)), 
/*  92 */         PartPose.offset(0.6527F, 5.5696F, 0.0F));
...
/*  97 */         CubeListBuilder.create().texOffs(45, 0).addBox(-2.1736F, -0.9848F, -2.0F, 4.0F, 7.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(0, 27)
/*  98 */         .addBox(0.8264F, 6.0152F, -2.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(21, 13)
/*  99 */         .addBox(-2.1736F, 6.0152F, -2.0F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 18)
/* 100 */         .addBox(-2.1736F, 6.0152F, -0.5F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(4, 0)
/* 101 */         .addBox(-2.1736F, 6.0152F, 1.0F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), 
/* 102 */         PartPose.offset(-0.6527F, 5.5696F, 0.0F));
...
/* 130 */         CubeListBuilder.create().texOffs(0, 13).addBox(-3.5F, -6.4F, -3.5F, 7.0F, 7.0F, 7.0F, new CubeDeformation(0.0F)), 
/* 131 */         PartPose.offset(0.0F, -3.0F, 0.0F));
/* 132 */     PartDefinition Ears = Head.addOrReplaceChild("Ears", CubeListBuilder.create(), PartPose.offset(0.0F, 0.6F, 0.0F));
...
/* Location:              C:\Users\Administrator\.gradle\caches\forge_gradle\deobf_dependencies\curse\maven\1-1034197\5414946_mapped_official_1.18.2\1-1034197-5414946_mapped_official_1.18.2.jar!\net\mcreator\latexes\client\model\ModelProtector_remaster.class
