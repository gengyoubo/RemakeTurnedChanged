...
/* loaded from: 1-1034197-5414946_mapped_official_1.18.2.jar:net/mcreator/latexes/client/renderer/CivilianRenderer.class */
public class CivilianRenderer extends HumanoidMobRenderer<CivilianEntity, HumanoidModel<CivilianEntity>> {
    ...
    public @NotNull ResourceLocation getTextureLocation(@NotNull CivilianEntity entity) {
        return new ResourceLocation("latex:textures/entities/medieval_civilian_steve.png");
    }
}
