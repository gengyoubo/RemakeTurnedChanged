...
/* loaded from: 1-1034197-5414946_mapped_official_1.18.2.jar:net/mcreator/latexes/init/LatexModEntities.class */
public class LatexModEntities {
    ...
    public static final RegistryObject<EntityType<YufengEntity>> YUFENG = register("yufeng", EntityType.Builder.of(YufengEntity::new, MobCategory.MONSTER).setShouldReceiveVelocityUpdates(true).setTrackingRange(128).setUpdateInterval(3).setCustomClientFactory(YufengEntity::new).sized(0.6f, 1.9f));
    ...
    public static final RegistryObject<EntityType<DarkLatexSnakeEntity>> DARK_LATEX_SNAKE = register("dark_latex_snake", EntityType.Builder.of(DarkLatexSnakeEntity::new, MobCategory.MONSTER).setShouldReceiveVelocityUpdates(true).setTrackingRange(124).setUpdateInterval(3).setCustomClientFactory(DarkLatexSnakeEntity::new).sized(0.5f, 3.4f));
    public static final RegistryObject<EntityType<DarkLatexDragonEntity>> DARK_LATEX_DRAGON = register("dark_latex_dragon", EntityType.Builder.of(DarkLatexDragonEntity::new, MobCategory.MONSTER).setShouldReceiveVelocityUpdates(true).setTrackingRange(96).setUpdateInterval(3).setCustomClientFactory(DarkLatexDragonEntity::new).sized(1.0f, 2.5f));
