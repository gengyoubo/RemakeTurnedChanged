...
/* 48 */             _entity.addEffect(new MobEffectInstance(MobEffects.DAMAGE_BOOST, 250, 1, false, false)); } 
/*    */         }  }
...
/* 54 */               NXTHertxEntity nXTHertxEntity = new NXTHertxEntity((EntityType)LatexModEntities.NXT_HERTX.get(), (Level)_level);
/* 55 */               nXTHertxEntity.moveTo(x, y, z, entity.getYRot(), entity.getXRot());
/* 56 */               nXTHertxEntity.setYBodyRot(entity.getYRot());
/* 57 */               nXTHertxEntity.setYHeadRot(entity.getYRot());
/* 58 */               if (nXTHertxEntity instanceof Mob) { Mob _mobToSpawn = (Mob)nXTHertxEntity;
/* 59 */                 _mobToSpawn.finalizeSpawn((ServerLevelAccessor)_level, world.getCurrentDifficultyAt(nXTHertxEntity.blockPosition()), MobSpawnType.MOB_SUMMONED, null, null); }
/*    */               
/* 61 */               world.addFreshEntity((Entity)nXTHertxEntity); }
/*    */             
...
/* Location:              C:\Users\Administrator\.gradle\caches\forge_gradle\deobf_dependencies\curse\maven\1-1034197\5414946_mapped_official_1.18.2\1-1034197-5414946_mapped_official_1.18.2.jar!\net\mcreator\latexes\procedures\NXTSitRightClickedOnEntityProcedure.class
