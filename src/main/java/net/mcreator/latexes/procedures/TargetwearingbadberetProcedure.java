...
/* loaded from: 1-1034197-5414946_mapped_official_1.18.2.jar:net/mcreator/latexes/procedures/TargetwearingbadberetProcedure.class */
public class TargetwearingbadberetProcedure {
    public static boolean execute(Entity entity) {
        ...
        if (!(itemStack.getItem() == LatexModItems.EVIL_BERET_HELMET.get())) {
            return true;
        }
        return false;
    }
