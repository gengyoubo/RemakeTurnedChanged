...
/* 15 */       _player.getCooldowns().addCooldown(itemstack.getItem(), 45); }
/* 16 */      if (world instanceof ServerLevel) { ServerLevel _level = (ServerLevel)world;
/* 17 */       _level.sendParticles((ParticleOptions)ParticleTypes.CAMPFIRE_COSY_SMOKE, x, y, z, 12, 0.5D, 0.5D, 0.5D, 0.25D); }
...
/* Location:              C:\Users\Administrator\.gradle\caches\forge_gradle\deobf_dependencies\curse\maven\1-1034197\5414946_mapped_official_1.18.2\1-1034197-5414946_mapped_official_1.18.2.jar!\net\mcreator\latexes\procedures\MatchLockMusketRangedItemUsedProcedure.class
