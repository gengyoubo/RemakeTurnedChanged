...
/* 52 */               HertxvarFBEntity hertxvarFBEntity = new HertxvarFBEntity((EntityType)LatexModEntities.HERTXVAR_FB.get(), (Level)_level);
/* 53 */               hertxvarFBEntity.moveTo(x, y, z, entity.getYRot(), entity.getXRot());
/* 54 */               hertxvarFBEntity.setYBodyRot(entity.getYRot());
/* 55 */               hertxvarFBEntity.setYHeadRot(entity.getYRot());
/* 56 */               if (hertxvarFBEntity instanceof Mob) { Mob _mobToSpawn = (Mob)hertxvarFBEntity;
/* 57 */                 _mobToSpawn.finalizeSpawn((ServerLevelAccessor)_level, world.getCurrentDifficultyAt(hertxvarFBEntity.blockPosition()), MobSpawnType.MOB_SUMMONED, null, null); }
/*    */               
/* 59 */               world.addFreshEntity((Entity)hertxvarFBEntity); }
/*    */             
...
/* Location:              C:\Users\Administrator\.gradle\caches\forge_gradle\deobf_dependencies\curse\maven\1-1034197\5414946_mapped_official_1.18.2\1-1034197-5414946_mapped_official_1.18.2.jar!\net\mcreator\latexes\procedures\HertxFBSitRightClickedOnEntityProcedure.class
