...
/*    */ 
/*    */ public class AshburyHertxRightClickedOnEntityProcedure {
...
/* 52 */               AshburySitEntity ashburySitEntity = new AshburySitEntity((EntityType)LatexModEntities.ASHBURY_SIT.get(), (Level)_level);
/* 53 */               ashburySitEntity.moveTo(x, y, z, entity.getYRot(), entity.getXRot());
/* 54 */               ashburySitEntity.setYBodyRot(entity.getYRot());
/* 55 */               ashburySitEntity.setYHeadRot(entity.getYRot());
/* 56 */               if (ashburySitEntity instanceof Mob) { Mob _mobToSpawn = (Mob)ashburySitEntity;
/* 57 */                 _mobToSpawn.finalizeSpawn((ServerLevelAccessor)_level, world.getCurrentDifficultyAt(ashburySitEntity.blockPosition()), MobSpawnType.MOB_SUMMONED, null, null); }
/*    */               
/* 59 */               world.addFreshEntity((Entity)ashburySitEntity); }
/*    */             
...
/* Location:              C:\Users\Administrator\.gradle\caches\forge_gradle\deobf_dependencies\curse\maven\1-1034197\5414946_mapped_official_1.18.2\1-1034197-5414946_mapped_official_1.18.2.jar!\net\mcreator\latexes\procedures\AshburyHertxRightClickedOnEntityProcedure.class
