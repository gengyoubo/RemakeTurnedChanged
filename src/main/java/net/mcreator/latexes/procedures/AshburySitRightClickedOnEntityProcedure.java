...
/*    */ 
/*    */ public class AshburySitRightClickedOnEntityProcedure {
...
/* 52 */               AshburyHertxEntity ashburyHertxEntity = new AshburyHertxEntity((EntityType)LatexModEntities.ASHBURY_HERTX.get(), (Level)_level);
/* 53 */               ashburyHertxEntity.moveTo(x, y, z, entity.getYRot(), entity.getXRot());
/* 54 */               ashburyHertxEntity.setYBodyRot(entity.getYRot());
/* 55 */               ashburyHertxEntity.setYHeadRot(entity.getYRot());
/* 56 */               if (ashburyHertxEntity instanceof Mob) { Mob _mobToSpawn = (Mob)ashburyHertxEntity;
/* 57 */                 _mobToSpawn.finalizeSpawn((ServerLevelAccessor)_level, world.getCurrentDifficultyAt(ashburyHertxEntity.blockPosition()), MobSpawnType.MOB_SUMMONED, null, null); }
/*    */               
/* 59 */               world.addFreshEntity((Entity)ashburyHertxEntity); }
/*    */             
...
/* Location:              C:\Users\Administrator\.gradle\caches\forge_gradle\deobf_dependencies\curse\maven\1-1034197\5414946_mapped_official_1.18.2\1-1034197-5414946_mapped_official_1.18.2.jar!\net\mcreator\latexes\procedures\AshburySitRightClickedOnEntityProcedure.class
