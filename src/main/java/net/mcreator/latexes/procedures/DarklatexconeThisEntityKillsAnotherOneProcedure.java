...
/* loaded from: 1-1034197-5414946_mapped_official_1.18.2.jar:net/mcreator/latexes/procedures/DarklatexconeThisEntityKillsAnotherOneProcedure.class */
public class DarklatexconeThisEntityKillsAnotherOneProcedure {
    /* JADX WARNING: Removed duplicated region for block: B:287:0x0d84  */
                        ...
                        if (z2) {
                            ...
                            if (entity instanceof FlyingMob) {
                                ...
                                if ((entity instanceof Skeleton) || (entity instanceof WitherSkeleton)) {
                                    ...
                                    Entity entityToSpawn14 = new DarklatexconeEntity((EntityType<DarklatexconeEntity>) ((EntityType) LatexModEntities.DARKLATEXCONE.get()), (Level) _level27);
