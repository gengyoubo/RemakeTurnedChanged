...
/*    */ 
/*    */ public class ProtectorSlimelingRightClickedOnEntityProcedure {
...
/* 49 */               _entity.addEffect(new MobEffectInstance(MobEffects.HEAL, 1, 1, false, false)); }
...
/* 79 */                 ProtectorSlimelingsitEntity protectorSlimelingsitEntity = new ProtectorSlimelingsitEntity((EntityType)LatexModEntities.PROTECTOR_SLIMELINGSIT.get(), (Level)_level);
/* 80 */                 protectorSlimelingsitEntity.moveTo(x, y, z, entity.getYRot(), entity.getXRot());
/* 81 */                 protectorSlimelingsitEntity.setYBodyRot(entity.getYRot());
/* 82 */                 protectorSlimelingsitEntity.setYHeadRot(entity.getYRot());
/* 83 */                 if (protectorSlimelingsitEntity instanceof Mob) { Mob _mobToSpawn = (Mob)protectorSlimelingsitEntity;
/* 84 */                   _mobToSpawn.finalizeSpawn((ServerLevelAccessor)_level, world.getCurrentDifficultyAt(protectorSlimelingsitEntity.blockPosition()), MobSpawnType.MOB_SUMMONED, null, null); }
/*    */                 
/* 86 */                 world.addFreshEntity((Entity)protectorSlimelingsitEntity); }
/*    */               
...
/* Location:              C:\Users\Administrator\.gradle\caches\forge_gradle\deobf_dependencies\curse\maven\1-1034197\5414946_mapped_official_1.18.2\1-1034197-5414946_mapped_official_1.18.2.jar!\net\mcreator\latexes\procedures\ProtectorSlimelingRightClickedOnEntityProcedure.class
