...
/*    */ 
/*    */ public class ArmedDronehertxrightclickProcedure {
...
/* 44 */             ArmedDroneHertxWaitEntity armedDroneHertxWaitEntity = new ArmedDroneHertxWaitEntity((EntityType)LatexModEntities.ARMED_DRONE_HERTX_WAIT.get(), (Level)_level);
/* 45 */             armedDroneHertxWaitEntity.moveTo(x, y, z, entity.getYRot(), entity.getXRot());
/* 46 */             armedDroneHertxWaitEntity.setYBodyRot(entity.getYRot());
/* 47 */             armedDroneHertxWaitEntity.setYHeadRot(entity.getYRot());
/* 48 */             if (armedDroneHertxWaitEntity instanceof Mob) { Mob _mobToSpawn = (Mob)armedDroneHertxWaitEntity;
/* 49 */               _mobToSpawn.finalizeSpawn((ServerLevelAccessor)_level, world.getCurrentDifficultyAt(armedDroneHertxWaitEntity.blockPosition()), MobSpawnType.MOB_SUMMONED, null, null); }
/*    */             
/* 51 */             world.addFreshEntity((Entity)armedDroneHertxWaitEntity); }
/*    */           
...
/* Location:              C:\Users\Administrator\.gradle\caches\forge_gradle\deobf_dependencies\curse\maven\1-1034197\5414946_mapped_official_1.18.2\1-1034197-5414946_mapped_official_1.18.2.jar!\net\mcreator\latexes\procedures\ArmedDronehertxrightclickProcedure.class
