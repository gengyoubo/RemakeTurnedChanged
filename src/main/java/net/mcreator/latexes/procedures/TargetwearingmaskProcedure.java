...
/* loaded from: 1-1034197-5414946_mapped_official_1.18.2.jar:net/mcreator/latexes/procedures/TargetwearingmaskProcedure.class */
public class TargetwearingmaskProcedure {
    public static boolean execute(Entity entity) {
        ...
        if (!(itemStack.getItem() == LatexModItems.DLMASK_HELMET.get())) {
            return true;
        }
        return false;
    }
