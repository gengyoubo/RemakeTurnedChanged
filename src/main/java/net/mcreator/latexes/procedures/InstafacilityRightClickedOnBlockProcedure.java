...
/* 22 */       StructureTemplate template = _serverworld.getStructureManager().getOrCreate(new ResourceLocation("latex", "operative_facility"));
/* 23 */       if (template != null) {
/* 24 */         template.placeInWorld((ServerLevelAccessor)_serverworld, new BlockPos(x, y - 2.0D, z), new BlockPos(x, y - 2.0D, z), (new StructurePlaceSettings())
...
/* 30 */       ItemStack _stktoremove = new ItemStack((ItemLike)LatexModItems.INSTAFACILITY.get());
...
/* Location:              C:\Users\Administrator\.gradle\caches\forge_gradle\deobf_dependencies\curse\maven\1-1034197\5414946_mapped_official_1.18.2\1-1034197-5414946_mapped_official_1.18.2.jar!\net\mcreator\latexes\procedures\InstafacilityRightClickedOnBlockProcedure.class
