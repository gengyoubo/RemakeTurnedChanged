...
/* 44 */             ArmedDroneHertxEntity armedDroneHertxEntity = new ArmedDroneHertxEntity((EntityType)LatexModEntities.ARMED_DRONE_HERTX.get(), (Level)_level);
/* 45 */             armedDroneHertxEntity.moveTo(x, y, z, entity.getYRot(), entity.getXRot());
/* 46 */             armedDroneHertxEntity.setYBodyRot(entity.getYRot());
/* 47 */             armedDroneHertxEntity.setYHeadRot(entity.getYRot());
/* 48 */             if (armedDroneHertxEntity instanceof Mob) { Mob _mobToSpawn = (Mob)armedDroneHertxEntity;
/* 49 */               _mobToSpawn.finalizeSpawn((ServerLevelAccessor)_level, world.getCurrentDifficultyAt(armedDroneHertxEntity.blockPosition()), MobSpawnType.MOB_SUMMONED, null, null); }
/*    */             
/* 51 */             world.addFreshEntity((Entity)armedDroneHertxEntity); }
/*    */           
...
/* Location:              C:\Users\Administrator\.gradle\caches\forge_gradle\deobf_dependencies\curse\maven\1-1034197\5414946_mapped_official_1.18.2\1-1034197-5414946_mapped_official_1.18.2.jar!\net\mcreator\latexes\procedures\ArmedDroneHertxWaitRightClickedOnEntityProcedure.class
