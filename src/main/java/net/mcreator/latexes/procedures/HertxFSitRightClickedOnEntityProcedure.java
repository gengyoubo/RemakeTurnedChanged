...
/*    */ 
/*    */ public class HertxFSitRightClickedOnEntityProcedure {
...
/* 52 */               HertxvarFEntity hertxvarFEntity = new HertxvarFEntity((EntityType)LatexModEntities.HERTXVAR_F.get(), (Level)_level);
/* 53 */               hertxvarFEntity.moveTo(x, y, z, entity.getYRot(), entity.getXRot());
/* 54 */               hertxvarFEntity.setYBodyRot(entity.getYRot());
/* 55 */               hertxvarFEntity.setYHeadRot(entity.getYRot());
/* 56 */               if (hertxvarFEntity instanceof Mob) { Mob _mobToSpawn = (Mob)hertxvarFEntity;
/* 57 */                 _mobToSpawn.finalizeSpawn((ServerLevelAccessor)_level, world.getCurrentDifficultyAt(hertxvarFEntity.blockPosition()), MobSpawnType.MOB_SUMMONED, null, null); }
/*    */               
/* 59 */               world.addFreshEntity((Entity)hertxvarFEntity); }
/*    */             
...
/* Location:              C:\Users\Administrator\.gradle\caches\forge_gradle\deobf_dependencies\curse\maven\1-1034197\5414946_mapped_official_1.18.2\1-1034197-5414946_mapped_official_1.18.2.jar!\net\mcreator\latexes\procedures\HertxFSitRightClickedOnEntityProcedure.class
