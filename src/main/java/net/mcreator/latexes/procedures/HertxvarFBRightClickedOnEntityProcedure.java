...
/* 52 */               HertxFBSitEntity hertxFBSitEntity = new HertxFBSitEntity((EntityType)LatexModEntities.HERTX_FB_SIT.get(), (Level)_level);
/* 53 */               hertxFBSitEntity.moveTo(x, y, z, entity.getYRot(), entity.getXRot());
/* 54 */               hertxFBSitEntity.setYBodyRot(entity.getYRot());
/* 55 */               hertxFBSitEntity.setYHeadRot(entity.getYRot());
/* 56 */               if (hertxFBSitEntity instanceof Mob) { Mob _mobToSpawn = (Mob)hertxFBSitEntity;
/* 57 */                 _mobToSpawn.finalizeSpawn((ServerLevelAccessor)_level, world.getCurrentDifficultyAt(hertxFBSitEntity.blockPosition()), MobSpawnType.MOB_SUMMONED, null, null); }
/*    */               
/* 59 */               world.addFreshEntity((Entity)hertxFBSitEntity); }
/*    */             
...
/* Location:              C:\Users\Administrator\.gradle\caches\forge_gradle\deobf_dependencies\curse\maven\1-1034197\5414946_mapped_official_1.18.2\1-1034197-5414946_mapped_official_1.18.2.jar!\net\mcreator\latexes\procedures\HertxvarFBRightClickedOnEntityProcedure.class
