...
/*    */ 
/*    */ public class BeeHertxRightClickedOnEntityProcedure {
...
/* 52 */               BeeHertxSitEntity beeHertxSitEntity = new BeeHertxSitEntity((EntityType)LatexModEntities.BEE_HERTX_SIT.get(), (Level)_level);
/* 53 */               beeHertxSitEntity.moveTo(x, y, z, entity.getYRot(), entity.getXRot());
/* 54 */               beeHertxSitEntity.setYBodyRot(entity.getYRot());
/* 55 */               beeHertxSitEntity.setYHeadRot(entity.getYRot());
/* 56 */               if (beeHertxSitEntity instanceof Mob) { Mob _mobToSpawn = (Mob)beeHertxSitEntity;
/* 57 */                 _mobToSpawn.finalizeSpawn((ServerLevelAccessor)_level, world.getCurrentDifficultyAt(beeHertxSitEntity.blockPosition()), MobSpawnType.MOB_SUMMONED, null, null); }
/*    */               
/* 59 */               world.addFreshEntity((Entity)beeHertxSitEntity); }
/*    */             
...
/* Location:              C:\Users\Administrator\.gradle\caches\forge_gradle\deobf_dependencies\curse\maven\1-1034197\5414946_mapped_official_1.18.2\1-1034197-5414946_mapped_official_1.18.2.jar!\net\mcreator\latexes\procedures\BeeHertxRightClickedOnEntityProcedure.class
