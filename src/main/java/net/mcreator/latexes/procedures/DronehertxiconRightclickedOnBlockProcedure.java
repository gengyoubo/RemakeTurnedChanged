...
/* loaded from: 1-1034197-5414946_mapped_official_1.18.2.jar:net/mcreator/latexes/procedures/DronehertxiconRightclickedOnBlockProcedure.class */
    ...
    public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
        if (entity != null) {
            ...
            if (entity instanceof Player) {
                ...
                ItemStack _stktoremove = new ItemStack((ItemLike) LatexModItems.DRONEHERTXICON.get());
