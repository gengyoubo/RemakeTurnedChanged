...
/* loaded from: 1-1034197-5414946_mapped_official_1.18.2.jar:net/mcreator/latexes/procedures/BeeHertxThisEntityKillsAnotherOneProcedure.class */
public class BeeHertxThisEntityKillsAnotherOneProcedure {
    public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
        if (entity != null) {
            if (entity.getType().is(TagKey.create(Registry.ENTITY_TYPE_REGISTRY, new ResourceLocation("latex:darklatexes")))) {
                ...
                new AnonymousClass3(x, y, z).start(world, (int) (Math.random() * 50.0d * 20.0d));
            }
        }
    }

    /* renamed from: net.mcreator.latexes.procedures.BeeHertxThisEntityKillsAnotherOneProcedure$1  reason: invalid class name */
    /* loaded from: 1-1034197-5414946_mapped_official_1.18.2.jar:net/mcreator/latexes/procedures/BeeHertxThisEntityKillsAnotherOneProcedure$1.class */
    class AnonymousClass1 {
        ...
        private void run() {
            ...
            if (level instanceof Level) {
                Level _level = level;
                if (!_level.isClientSide()) {
                    _level.playSound((Player) null, new BlockPos(this.val$x, this.val$y, this.val$z), ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("latex:robot_burp")), SoundSource.NEUTRAL, 1.0f, 2.0f);
                } else {
                    _level.playLocalSound(this.val$x, this.val$y, this.val$z, ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("latex:robot_burp")), SoundSource.NEUTRAL, 1.0f, 2.0f, false);
                }
            }
    ...
    /* renamed from: net.mcreator.latexes.procedures.BeeHertxThisEntityKillsAnotherOneProcedure$2  reason: invalid class name */
    /* loaded from: 1-1034197-5414946_mapped_official_1.18.2.jar:net/mcreator/latexes/procedures/BeeHertxThisEntityKillsAnotherOneProcedure$2.class */
            ...
            if (Math.random() < 0.1d) {
                ...
                if (level5 instanceof Level) {
                    ...
                    if (!_level5.isClientSide()) {
                        ItemEntity entityToSpawn4 = new ItemEntity(_level5, this.val$x, this.val$y, this.val$z, new ItemStack((ItemLike) LatexModItems.BROKENDLMASK.get()));
                ...
                if (level6 instanceof Level) {
                    ...
                    if (!_level6.isClientSide()) {
                        ItemEntity entityToSpawn5 = new ItemEntity(_level6, this.val$x, this.val$y, this.val$z, new ItemStack(Items.HONEY_BOTTLE));
    ...
    /* renamed from: net.mcreator.latexes.procedures.BeeHertxThisEntityKillsAnotherOneProcedure$3  reason: invalid class name */
    /* loaded from: 1-1034197-5414946_mapped_official_1.18.2.jar:net/mcreator/latexes/procedures/BeeHertxThisEntityKillsAnotherOneProcedure$3.class */
