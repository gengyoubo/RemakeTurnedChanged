...
/* loaded from: 1-1034197-5414946_mapped_official_1.18.2.jar:net/mcreator/latexes/procedures/DarkLatexSpiderQueenThisEntityKillsAnotherOneProcedure.class */
public class DarkLatexSpiderQueenThisEntityKillsAnotherOneProcedure {
    /* JADX WARNING: Removed duplicated region for block: B:203:0x08eb  */
                        ...
                        if (z2) {
                            ...
                            if (world instanceof Level) {
                                ...
                                if (!_level17.isClientSide()) {
                                    _level17.playSound((Player) null, new BlockPos(x, y, z), ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("latex:transfur")), SoundSource.NEUTRAL, 1.0f, 2.0f);
                                } else {
                                    _level17.playLocalSound(x, y, z, ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("latex:transfur")), SoundSource.NEUTRAL, 1.0f, 2.0f, false);
                                }
                            }
                            new AnonymousClass4(x, y, z).start(world, 200);
                            return false;
                        }
                    }
                }
    ...
    /* renamed from: net.mcreator.latexes.procedures.DarkLatexSpiderQueenThisEntityKillsAnotherOneProcedure$1  reason: invalid class name */
    /* loaded from: 1-1034197-5414946_mapped_official_1.18.2.jar:net/mcreator/latexes/procedures/DarkLatexSpiderQueenThisEntityKillsAnotherOneProcedure$1.class */
    ...
    /* renamed from: net.mcreator.latexes.procedures.DarkLatexSpiderQueenThisEntityKillsAnotherOneProcedure$2  reason: invalid class name */
    /* loaded from: 1-1034197-5414946_mapped_official_1.18.2.jar:net/mcreator/latexes/procedures/DarkLatexSpiderQueenThisEntityKillsAnotherOneProcedure$2.class */
    ...
    /* renamed from: net.mcreator.latexes.procedures.DarkLatexSpiderQueenThisEntityKillsAnotherOneProcedure$3  reason: invalid class name */
    /* loaded from: 1-1034197-5414946_mapped_official_1.18.2.jar:net/mcreator/latexes/procedures/DarkLatexSpiderQueenThisEntityKillsAnotherOneProcedure$3.class */
    ...
    /* renamed from: net.mcreator.latexes.procedures.DarkLatexSpiderQueenThisEntityKillsAnotherOneProcedure$4  reason: invalid class name */
    /* loaded from: 1-1034197-5414946_mapped_official_1.18.2.jar:net/mcreator/latexes/procedures/DarkLatexSpiderQueenThisEntityKillsAnotherOneProcedure$4.class */
    class AnonymousClass4 {
        ...
        private void run() {
            ...
            if (level5 instanceof Level) {
                ...
                if (!_level5.isClientSide()) {
                    ItemEntity entityToSpawn4 = new ItemEntity(_level5, this.val$x, this.val$y, this.val$z, new ItemStack(Blocks.SKELETON_SKULL));
