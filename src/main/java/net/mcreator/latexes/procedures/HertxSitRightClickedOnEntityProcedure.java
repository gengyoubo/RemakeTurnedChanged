...
/*    */ 
/*    */ public class HertxSitRightClickedOnEntityProcedure {
...
/* 52 */               HertxEntity hertxEntity = new HertxEntity((EntityType)LatexModEntities.HERTX.get(), (Level)_level);
/* 53 */               hertxEntity.moveTo(x, y, z, entity.getYRot(), entity.getXRot());
/* 54 */               hertxEntity.setYBodyRot(entity.getYRot());
/* 55 */               hertxEntity.setYHeadRot(entity.getYRot());
/* 56 */               if (hertxEntity instanceof Mob) { Mob _mobToSpawn = (Mob)hertxEntity;
/* 57 */                 _mobToSpawn.finalizeSpawn((ServerLevelAccessor)_level, world.getCurrentDifficultyAt(hertxEntity.blockPosition()), MobSpawnType.MOB_SUMMONED, null, null); }
/*    */               
/* 59 */               world.addFreshEntity((Entity)hertxEntity); }
/*    */             
...
/* Location:              C:\Users\Administrator\.gradle\caches\forge_gradle\deobf_dependencies\curse\maven\1-1034197\5414946_mapped_official_1.18.2\1-1034197-5414946_mapped_official_1.18.2.jar!\net\mcreator\latexes\procedures\HertxSitRightClickedOnEntityProcedure.class
