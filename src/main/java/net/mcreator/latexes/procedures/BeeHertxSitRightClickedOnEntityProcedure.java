...
/* 52 */               BeeHertxEntity beeHertxEntity = new BeeHertxEntity((EntityType)LatexModEntities.BEE_HERTX.get(), (Level)_level);
/* 53 */               beeHertxEntity.moveTo(x, y, z, entity.getYRot(), entity.getXRot());
/* 54 */               beeHertxEntity.setYBodyRot(entity.getYRot());
/* 55 */               beeHertxEntity.setYHeadRot(entity.getYRot());
/* 56 */               if (beeHertxEntity instanceof Mob) { Mob _mobToSpawn = (Mob)beeHertxEntity;
/* 57 */                 _mobToSpawn.finalizeSpawn((ServerLevelAccessor)_level, world.getCurrentDifficultyAt(beeHertxEntity.blockPosition()), MobSpawnType.MOB_SUMMONED, null, null); }
/*    */               
/* 59 */               world.addFreshEntity((Entity)beeHertxEntity); }
/*    */             
...
/* Location:              C:\Users\Administrator\.gradle\caches\forge_gradle\deobf_dependencies\curse\maven\1-1034197\5414946_mapped_official_1.18.2\1-1034197-5414946_mapped_official_1.18.2.jar!\net\mcreator\latexes\procedures\BeeHertxSitRightClickedOnEntityProcedure.class
