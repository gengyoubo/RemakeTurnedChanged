...
/* 48 */             _entity.addEffect(new MobEffectInstance(MobEffects.DAMAGE_RESISTANCE, 300, 1, false, false)); }
/* 49 */            if (sourceentity instanceof LivingEntity) { LivingEntity _entity = (LivingEntity)sourceentity;
/* 50 */             _entity.addEffect(new MobEffectInstance(MobEffects.MOVEMENT_SLOWDOWN, 100, 1, false, false)); } 
/*    */         }  }
/* 52 */       else if (entity instanceof TamableAnimal) { TamableAnimal _tamIsTamedBy = (TamableAnimal)entity; if (sourceentity instanceof LivingEntity) { LivingEntity livingEntity = (LivingEntity)sourceentity; if (_tamIsTamedBy
/* 53 */             .isOwnedBy(livingEntity)) {
/*    */             
/* 55 */             if (world instanceof ServerLevel) { ServerLevel _level = (ServerLevel)world;
/* 56 */               HertxSolWaitEntity hertxSolWaitEntity = new HertxSolWaitEntity((EntityType)LatexModEntities.HERTX_SOL_WAIT.get(), (Level)_level);
/* 57 */               hertxSolWaitEntity.moveTo(x, y, z, entity.getYRot(), entity.getXRot());
/* 58 */               hertxSolWaitEntity.setYBodyRot(entity.getYRot());
/* 59 */               hertxSolWaitEntity.setYHeadRot(entity.getYRot());
/* 60 */               if (hertxSolWaitEntity instanceof Mob) { Mob _mobToSpawn = (Mob)hertxSolWaitEntity;
/* 61 */                 _mobToSpawn.finalizeSpawn((ServerLevelAccessor)_level, world.getCurrentDifficultyAt(hertxSolWaitEntity.blockPosition()), MobSpawnType.MOB_SUMMONED, null, null); }
/*    */               
/* 63 */               world.addFreshEntity((Entity)hertxSolWaitEntity); }
/*    */             
...
/* Location:              C:\Users\Administrator\.gradle\caches\forge_gradle\deobf_dependencies\curse\maven\1-1034197\5414946_mapped_official_1.18.2\1-1034197-5414946_mapped_official_1.18.2.jar!\net\mcreator\latexes\procedures\HertxvarSolRightClickedOnEntityProcedure.class
