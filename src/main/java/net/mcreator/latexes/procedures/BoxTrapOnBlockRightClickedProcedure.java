...
/* loaded from: 1-1034197-5414946_mapped_official_1.18.2.jar:net/mcreator/latexes/procedures/BoxTrapOnBlockRightClickedProcedure.class */
    ...
    public static void execute(LevelAccessor world, double x, double y, double z) {
        ...
        if (Math.random() < 0.4d) {
            ...
            if (world instanceof ServerLevel) {
                ...
                Entity entityToSpawn5 = new YufengEntity((EntityType<YufengEntity>) ((EntityType) LatexModEntities.YUFENG.get()), (Level) _level5);
