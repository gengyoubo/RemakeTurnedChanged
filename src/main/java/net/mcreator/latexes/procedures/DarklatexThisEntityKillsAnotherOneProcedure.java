...
/* loaded from: 1-1034197-5414946_mapped_official_1.18.2.jar:net/mcreator/latexes/procedures/DarklatexThisEntityKillsAnotherOneProcedure.class */
public class DarklatexThisEntityKillsAnotherOneProcedure {
    /* JADX WARNING: Removed duplicated region for block: B:324:0x0f69  */
                            ...
                            if (entity instanceof FlyingMob) {
                                ...
                                if ((entity instanceof Skeleton) || (entity instanceof WitherSkeleton)) {
                                    ...
                                    if (Math.random() < 0.1d) {
                                        ...
                                        Entity entityToSpawn14 = new YufengEntity((EntityType<YufengEntity>) ((EntityType) LatexModEntities.YUFENG.get()), (Level) _level27);
                                        ...
                                        if (world instanceof Level) {
                                            ...
                                            if (!_level28.isClientSide()) {
                                                _level28.playSound((Player) null, new BlockPos(x, y, z), ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("latex:transfur")), SoundSource.NEUTRAL, 1.0f, 1.0f);
                                            } else {
                                                _level28.playLocalSound(x, y, z, ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("latex:transfur")), SoundSource.NEUTRAL, 1.0f, 1.0f, false);
                                            }
                                        }
                                        if (!(world instanceof ServerLevel)) {
                                            return false;
                                        ...
                                        Entity entityToSpawn15 = new DarkLatexCentaurEntity((EntityType<DarkLatexCentaurEntity>) ((EntityType) LatexModEntities.DARK_LATEX_CENTAUR.get()), (Level) _level29);
                                        entityToSpawn15.moveTo(x, y, z, world.getRandom().nextFloat() * 360.0f, 0.0f);
                                        if (entityToSpawn15 instanceof Mob) {
                                            ((Mob) entityToSpawn15).finalizeSpawn(_level29, world.getCurrentDifficultyAt(entityToSpawn15.blockPosition()), MobSpawnType.MOB_SUMMONED, (SpawnGroupData) null, (CompoundTag) null);
                                        }
                                        ...
                                        if (world instanceof Level) {
                                            ...
                                            if (!_level30.isClientSide()) {
                                                _level30.playSound((Player) null, new BlockPos(x, y, z), ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("latex:transfur")), SoundSource.NEUTRAL, 1.0f, 1.0f);
                                            } else {
                                                _level30.playLocalSound(x, y, z, ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("latex:transfur")), SoundSource.NEUTRAL, 1.0f, 1.0f, false);
                                            }
                                        }
                                        if (!(world instanceof ServerLevel)) {
                                            return false;
                                        ...
                                        Entity entityToSpawn16 = new DarklatexEntity((EntityType<DarklatexEntity>) ((EntityType) LatexModEntities.DARKLATEX.get()), (Level) _level31);
                                        entityToSpawn16.moveTo(x, y, z, world.getRandom().nextFloat() * 360.0f, 0.0f);
                                        if (entityToSpawn16 instanceof Mob) {
                                            ((Mob) entityToSpawn16).finalizeSpawn(_level31, world.getCurrentDifficultyAt(entityToSpawn16.blockPosition()), MobSpawnType.MOB_SUMMONED, (SpawnGroupData) null, (CompoundTag) null);
                                        }
