...
/*    */ 
/*    */ public class HertxvarFRightClickedOnEntityProcedure {
...
/* 52 */               HertxFSitEntity hertxFSitEntity = new HertxFSitEntity((EntityType)LatexModEntities.HERTX_F_SIT.get(), (Level)_level);
/* 53 */               hertxFSitEntity.moveTo(x, y, z, entity.getYRot(), entity.getXRot());
/* 54 */               hertxFSitEntity.setYBodyRot(entity.getYRot());
/* 55 */               hertxFSitEntity.setYHeadRot(entity.getYRot());
/* 56 */               if (hertxFSitEntity instanceof Mob) { Mob _mobToSpawn = (Mob)hertxFSitEntity;
/* 57 */                 _mobToSpawn.finalizeSpawn((ServerLevelAccessor)_level, world.getCurrentDifficultyAt(hertxFSitEntity.blockPosition()), MobSpawnType.MOB_SUMMONED, null, null); }
/*    */               
/* 59 */               world.addFreshEntity((Entity)hertxFSitEntity); }
/*    */             
...
/* Location:              C:\Users\Administrator\.gradle\caches\forge_gradle\deobf_dependencies\curse\maven\1-1034197\5414946_mapped_official_1.18.2\1-1034197-5414946_mapped_official_1.18.2.jar!\net\mcreator\latexes\procedures\HertxvarFRightClickedOnEntityProcedure.class
