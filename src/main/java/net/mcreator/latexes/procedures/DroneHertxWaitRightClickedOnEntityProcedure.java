...
/* 45 */             DroneHertxEntity droneHertxEntity = new DroneHertxEntity((EntityType)LatexModEntities.DRONE_HERTX.get(), (Level)_level);
/* 46 */             droneHertxEntity.moveTo(x, y, z, entity.getYRot(), entity.getXRot());
/* 47 */             droneHertxEntity.setYBodyRot(entity.getYRot());
/* 48 */             droneHertxEntity.setYHeadRot(entity.getYRot());
/* 49 */             if (droneHertxEntity instanceof Mob) { Mob _mobToSpawn = (Mob)droneHertxEntity;
/* 50 */               _mobToSpawn.finalizeSpawn((ServerLevelAccessor)_level, world.getCurrentDifficultyAt(droneHertxEntity.blockPosition()), MobSpawnType.MOB_SUMMONED, null, null); }
/*    */             
/* 52 */             world.addFreshEntity((Entity)droneHertxEntity); }
/*    */           
...
/* Location:              C:\Users\Administrator\.gradle\caches\forge_gradle\deobf_dependencies\curse\maven\1-1034197\5414946_mapped_official_1.18.2\1-1034197-5414946_mapped_official_1.18.2.jar!\net\mcreator\latexes\procedures\DroneHertxWaitRightClickedOnEntityProcedure.class
