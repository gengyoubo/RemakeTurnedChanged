...
/* 14 */     if (entity == null)
/* 15 */       return false; 
/* 16 */     LivingEntity _livEnt = (LivingEntity)entity; if (LatexModItems.DART.get() == ((entity instanceof LivingEntity) ? _livEnt.getOffhandItem() : ItemStack.EMPTY).getItem()) {
/* 17 */       if (entity instanceof Player) { Player _player = (Player)entity;
/* 18 */         ItemStack _stktoremove = new ItemStack((ItemLike)LatexModItems.LATEX_DART_RIFLE.get());
...
/* 23 */         ItemStack _setstack = new ItemStack((ItemLike)LatexModItems.DARTRIFLE.get());
...
/* Location:              C:\Users\Administrator\.gradle\caches\forge_gradle\deobf_dependencies\curse\maven\1-1034197\5414946_mapped_official_1.18.2\1-1034197-5414946_mapped_official_1.18.2.jar!\net\mcreator\latexes\procedures\LatexDartRifleCanUseRangedItemProcedure.class
