...
/* loaded from: 1-1034197-5414946_mapped_official_1.18.2.jar:net/mcreator/latexes/item/DLPickaxeItem.class */
public class DLPickaxeItem extends PickaxeItem {

    /* renamed from: net.mcreator.latexes.item.DLPickaxeItem$1  reason: invalid class name */
    /* loaded from: 1-1034197-5414946_mapped_official_1.18.2.jar:net/mcreator/latexes/item/DLPickaxeItem$1.class */
    ...
    public DLPickaxeItem() {
        super(new AnonymousClass1(), 1, -3.0f, new Item.Properties().tab(LatexModTabs.TAB_LATEXITEMS));
    }
