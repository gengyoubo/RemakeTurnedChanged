...
/*  37 */     super(LatexModMenus.BOXGUI, id);
...
/*     */       } 
/*     */     }
/*  78 */     this.customSlots.put(Integer.valueOf(0), addSlot((Slot)new SlotItemHandler(this.internal, 0, 52, 17) {  }
/*     */         ));
/*  80 */     this.customSlots.put(Integer.valueOf(1), addSlot((Slot)new SlotItemHandler(this.internal, 1, 70, 17) {  }
/*     */         ));
/*  82 */     this.customSlots.put(Integer.valueOf(2), addSlot((Slot)new SlotItemHandler(this.internal, 2, 88, 17) {  }
/*     */         ));
/*  84 */     this.customSlots.put(Integer.valueOf(3), addSlot((Slot)new SlotItemHandler(this.internal, 3, 106, 17) {  }
/*     */         ));
/*  86 */     this.customSlots.put(Integer.valueOf(4), addSlot((Slot)new SlotItemHandler(this.internal, 4, 52, 35) {  }
/*     */         ));
/*  88 */     this.customSlots.put(Integer.valueOf(5), addSlot((Slot)new SlotItemHandler(this.internal, 5, 70, 35) {  }
/*     */         ));
/*  90 */     this.customSlots.put(Integer.valueOf(6), addSlot((Slot)new SlotItemHandler(this.internal, 6, 88, 35) {  }
/*     */         ));
/*  92 */     this.customSlots.put(Integer.valueOf(7), addSlot((Slot)new SlotItemHandler(this.internal, 7, 106, 35) {  }
/*     */         ));
/*  94 */     this.customSlots.put(Integer.valueOf(8), addSlot((Slot)new SlotItemHandler(this.internal, 8, 52, 53) {  }
/*     */         ));
/*  96 */     this.customSlots.put(Integer.valueOf(9), addSlot((Slot)new SlotItemHandler(this.internal, 9, 70, 53) {  }
/*     */         ));
/*  98 */     this.customSlots.put(Integer.valueOf(10), addSlot((Slot)new SlotItemHandler(this.internal, 10, 88, 53) {  }
/*     */         ));
/* 100 */     this.customSlots.put(Integer.valueOf(11), addSlot((Slot)new SlotItemHandler(this.internal, 11, 106, 53) {  }));
/*     */     int si;
/* 102 */     for (si = 0; si < 3; si++) {
/* 103 */       for (int sj = 0; sj < 9; sj++)
/* 104 */         addSlot(new Slot((Container)inv, sj + (si + 1) * 9, 8 + sj * 18, 84 + si * 18)); 
/* 105 */     }  for (si = 0; si < 9; si++) {
/* 106 */       addSlot(new Slot((Container)inv, si, 8 + si * 18, 142));
/*     */     }
/*     */   }
/*     */   
...
/* Location:              C:\Users\Administrator\.gradle\caches\forge_gradle\deobf_dependencies\curse\maven\1-1034197\5414946_mapped_official_1.18.2\1-1034197-5414946_mapped_official_1.18.2.jar!\net\mcreator\latexes\world\inventory\BoxguiMenu.class
