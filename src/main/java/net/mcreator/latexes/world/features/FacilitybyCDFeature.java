...
/* 33 */   public static FacilitybyCDFeature FEATURE = null;
...
/* 38 */     FEATURE = new FacilitybyCDFeature();
/* 39 */     CONFIGURED_FEATURE = FeatureUtils.register("latex:facilityby_cd", FEATURE, (FeatureConfiguration)FeatureConfiguration.NONE);
/* 40 */     PLACED_FEATURE = PlacementUtils.register("latex:facilityby_cd", CONFIGURED_FEATURE, List.of());
/* 41 */     return FEATURE;
/*    */   }
/*    */   
...
/* 63 */       this.template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("latex", "facility_complex_by_cd")); 
/* 64 */     if (this.template == null)
/* 65 */       return false; 
/* 66 */     boolean anyPlaced = false;
/* 67 */     if (context.random().nextInt(1000000) + 1 <= 5) {
...
/*    */           
/* 75 */           BlockPos spawnTo = new BlockPos(i + 0, j + 0, k + 0);
...
/* Location:              C:\Users\Administrator\.gradle\caches\forge_gradle\deobf_dependencies\curse\maven\1-1034197\5414946_mapped_official_1.18.2\1-1034197-5414946_mapped_official_1.18.2.jar!\net\mcreator\latexes\world\features\FacilitybyCDFeature.class
