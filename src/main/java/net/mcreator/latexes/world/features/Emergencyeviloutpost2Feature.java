...
/* loaded from: 1-1034197-5414946_mapped_official_1.18.2.jar:net/mcreator/latexes/world/features/Emergencyeviloutpost2Feature.class */
public class Emergencyeviloutpost2Feature extends Feature<NoneFeatureConfiguration> {
    ...
    public static Feature<?> feature() {
        ...
        CONFIGURED_FEATURE = FeatureUtils.register("latex:emergencyeviloutpost_2", FEATURE, FeatureConfiguration.NONE);
        PLACED_FEATURE = PlacementUtils.register("latex:emergencyeviloutpost_2", CONFIGURED_FEATURE, List.of());
        return FEATURE;
    }
