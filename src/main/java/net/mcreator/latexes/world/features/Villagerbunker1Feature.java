...
/* 33 */   public static Villagerbunker1Feature FEATURE = null;
...
/* 38 */     FEATURE = new Villagerbunker1Feature();
/* 39 */     CONFIGURED_FEATURE = FeatureUtils.register("latex:villagerbunker_1", FEATURE, (FeatureConfiguration)FeatureConfiguration.NONE);
/* 40 */     PLACED_FEATURE = PlacementUtils.register("latex:villagerbunker_1", CONFIGURED_FEATURE, List.of());
/* 41 */     return FEATURE;
/*    */   }
/*    */   
...
/*    */   }
/*    */   
/* 48 */   public static final Set<ResourceLocation> GENERATE_BIOMES = Set.of(new ResourceLocation("sunflower_plains"), new ResourceLocation("taiga"), new ResourceLocation("plains"), new ResourceLocation("savanna"), new ResourceLocation("snowy_taiga"), new ResourceLocation("swamp"));
/*    */   
...
/* 64 */       this.template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("latex", "villager_bunker_1")); 
/* 65 */     if (this.template == null)
/* 66 */       return false; 
/* 67 */     boolean anyPlaced = false;
/* 68 */     if (context.random().nextInt(1000000) + 1 <= 505) {
...
/*    */           
/* 76 */           BlockPos spawnTo = new BlockPos(i + 0, j + -6, k + 0);
...
/* Location:              C:\Users\Administrator\.gradle\caches\forge_gradle\deobf_dependencies\curse\maven\1-1034197\5414946_mapped_official_1.18.2\1-1034197-5414946_mapped_official_1.18.2.jar!\net\mcreator\latexes\world\features\Villagerbunker1Feature.class
