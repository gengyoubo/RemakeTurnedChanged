...
/* 30 */   public static AbandonedrefugeecampFeature FEATURE = null;
...
/* 35 */     FEATURE = new AbandonedrefugeecampFeature();
/* 36 */     CONFIGURED_FEATURE = FeatureUtils.register("latex:abandonedrefugeecamp", FEATURE, (FeatureConfiguration)FeatureConfiguration.NONE);
/* 37 */     PLACED_FEATURE = PlacementUtils.register("latex:abandonedrefugeecamp", CONFIGURED_FEATURE, List.of());
/* 38 */     return FEATURE;
/*    */   }
/*    */   
...
/* 63 */       this.template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("latex", "abandoned_refugee_camp")); 
...
/* Location:              C:\Users\Administrator\.gradle\caches\forge_gradle\deobf_dependencies\curse\maven\1-1034197\5414946_mapped_official_1.18.2\1-1034197-5414946_mapped_official_1.18.2.jar!\net\mcreator\latexes\world\features\AbandonedrefugeecampFeature.class
