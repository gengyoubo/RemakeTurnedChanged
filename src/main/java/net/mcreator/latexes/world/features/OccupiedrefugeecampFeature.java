...
/* loaded from: 1-1034197-5414946_mapped_official_1.18.2.jar:net/mcreator/latexes/world/features/OccupiedrefugeecampFeature.class */
public class OccupiedrefugeecampFeature extends Feature<NoneFeatureConfiguration> {
    ...
    public static Feature<?> feature() {
        ...
        CONFIGURED_FEATURE = FeatureUtils.register("latex:occupiedrefugeecamp", FEATURE, FeatureConfiguration.NONE);
        PLACED_FEATURE = PlacementUtils.register("latex:occupiedrefugeecamp", CONFIGURED_FEATURE, List.of());
        return FEATURE;
    }
