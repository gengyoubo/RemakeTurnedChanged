...
/*    */ 
/*    */ public class OperativefacilityFeature extends Feature<NoneFeatureConfiguration> {
/* 33 */   public static OperativefacilityFeature FEATURE = null;
...
/* 38 */     FEATURE = new OperativefacilityFeature();
/* 39 */     CONFIGURED_FEATURE = FeatureUtils.register("latex:operativefacility", FEATURE, (FeatureConfiguration)FeatureConfiguration.NONE);
/* 40 */     PLACED_FEATURE = PlacementUtils.register("latex:operativefacility", CONFIGURED_FEATURE, List.of());
/* 41 */     return FEATURE;
/*    */   }
/*    */   
...
/*    */   
/*    */   public OperativefacilityFeature() {
...
/* 63 */       this.template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("latex", "operative_facility")); 
/* 64 */     if (this.template == null)
/* 65 */       return false; 
/* 66 */     boolean anyPlaced = false;
/* 67 */     if (context.random().nextInt(1000000) + 1 <= 65) {
...
/* 84 */               .random(), 2)) {
/*    */             
/* 86 */             OperativefacilityOnStructureInstanceGeneratedProcedure.execute((LevelAccessor)world, x, y, z);
/* 87 */             anyPlaced = true;
/*    */           } 
/*    */         } 
/*    */       } 
...
/* Location:              C:\Users\Administrator\.gradle\caches\forge_gradle\deobf_dependencies\curse\maven\1-1034197\5414946_mapped_official_1.18.2\1-1034197-5414946_mapped_official_1.18.2.jar!\net\mcreator\latexes\world\features\OperativefacilityFeature.class
