...
/* loaded from: 1-1034197-5414946_mapped_official_1.18.2.jar:net/mcreator/latexes/world/features/AbandonedsmallvillageFeature.class */
public class AbandonedsmallvillageFeature extends Feature<NoneFeatureConfiguration> {
    ...
    public static Feature<?> feature() {
        ...
        CONFIGURED_FEATURE = FeatureUtils.register("latex:abandonedsmallvillage", FEATURE, FeatureConfiguration.NONE);
        PLACED_FEATURE = PlacementUtils.register("latex:abandonedsmallvillage", CONFIGURED_FEATURE, List.of());
        return FEATURE;
    }
