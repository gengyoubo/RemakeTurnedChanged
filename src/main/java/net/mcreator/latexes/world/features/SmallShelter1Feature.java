...
/*    */ 
/*    */ public class SmallShelter1Feature extends Feature<NoneFeatureConfiguration> {
/* 30 */   public static SmallShelter1Feature FEATURE = null;
...
/* 35 */     FEATURE = new SmallShelter1Feature();
/* 36 */     CONFIGURED_FEATURE = FeatureUtils.register("latex:small_shelter_1", FEATURE, (FeatureConfiguration)FeatureConfiguration.NONE);
/* 37 */     PLACED_FEATURE = PlacementUtils.register("latex:small_shelter_1", CONFIGURED_FEATURE, List.of());
/* 38 */     return FEATURE;
/*    */   }
/*    */   
...
/* 63 */       this.template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("latex", "small_shelter_1")); 
/* 64 */     if (this.template == null)
/* 65 */       return false; 
/* 66 */     boolean anyPlaced = false;
/* 67 */     if (context.random().nextInt(1000000) + 1 <= 375) {
/* 68 */       int count = context.random().nextInt(2) + 1;
...
/* Location:              C:\Users\Administrator\.gradle\caches\forge_gradle\deobf_dependencies\curse\maven\1-1034197\5414946_mapped_official_1.18.2\1-1034197-5414946_mapped_official_1.18.2.jar!\net\mcreator\latexes\world\features\SmallShelter1Feature.class
