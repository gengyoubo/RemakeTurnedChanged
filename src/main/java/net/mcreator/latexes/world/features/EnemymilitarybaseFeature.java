...
/*    */ 
/*    */ public class EnemymilitarybaseFeature extends Feature<NoneFeatureConfiguration> {
/* 30 */   public static EnemymilitarybaseFeature FEATURE = null;
...
/* 35 */     FEATURE = new EnemymilitarybaseFeature();
/* 36 */     CONFIGURED_FEATURE = FeatureUtils.register("latex:enemymilitarybase", FEATURE, (FeatureConfiguration)FeatureConfiguration.NONE);
/* 37 */     PLACED_FEATURE = PlacementUtils.register("latex:enemymilitarybase", CONFIGURED_FEATURE, List.of());
/* 38 */     return FEATURE;
/*    */   }
/*    */   
...
/*    */   
/*    */   public EnemymilitarybaseFeature() {
...
/* 63 */       this.template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("latex", "military_base")); 
/* 64 */     if (this.template == null)
/* 65 */       return false; 
/* 66 */     boolean anyPlaced = false;
/* 67 */     if (context.random().nextInt(1000000) + 1 <= 55) {
...
/*    */           
/* 75 */           BlockPos spawnTo = new BlockPos(i + 0, j + -6, k + 0);
...
/* Location:              C:\Users\Administrator\.gradle\caches\forge_gradle\deobf_dependencies\curse\maven\1-1034197\5414946_mapped_official_1.18.2\1-1034197-5414946_mapped_official_1.18.2.jar!\net\mcreator\latexes\world\features\EnemymilitarybaseFeature.class
