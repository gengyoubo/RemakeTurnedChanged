...
/* loaded from: 1-1034197-5414946_mapped_official_1.18.2.jar:net/mcreator/latexes/world/features/Shelterruins1Feature.class */
public class Shelterruins1Feature extends Feature<NoneFeatureConfiguration> {
    ...
    public static Feature<?> feature() {
        ...
        CONFIGURED_FEATURE = FeatureUtils.register("latex:shelterruins_1", FEATURE, FeatureConfiguration.NONE);
        PLACED_FEATURE = PlacementUtils.register("latex:shelterruins_1", CONFIGURED_FEATURE, List.of());
        return FEATURE;
    }
