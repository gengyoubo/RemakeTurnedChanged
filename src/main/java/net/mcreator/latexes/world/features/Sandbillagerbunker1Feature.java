...
/* 33 */   public static Sandbillagerbunker1Feature FEATURE = null;
...
/* 38 */     FEATURE = new Sandbillagerbunker1Feature();
/* 39 */     CONFIGURED_FEATURE = FeatureUtils.register("latex:sandbillagerbunker_1", FEATURE, (FeatureConfiguration)FeatureConfiguration.NONE);
/* 40 */     PLACED_FEATURE = PlacementUtils.register("latex:sandbillagerbunker_1", CONFIGURED_FEATURE, List.of());
/* 41 */     return FEATURE;
/*    */   }
/*    */   
...
/*    */   }
/*    */   
/* 48 */   public static final Set<ResourceLocation> GENERATE_BIOMES = Set.of(new ResourceLocation("badlands"), new ResourceLocation("desert"));
...
/* 55 */     this.base_blocks = List.of(Blocks.STONE, Blocks.GRASS_BLOCK, Blocks.DIRT_PATH, Blocks.DIRT, Blocks.COARSE_DIRT, Blocks.SAND, Blocks.RED_SAND);
/*    */   }
/*    */ 
/*    */   
...
/* 63 */       this.template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("latex", "village_sand_bunker_1")); 
...
/*    */           
/* 75 */           BlockPos spawnTo = new BlockPos(i + 0, j + -8, k + 0);
...
/* Location:              C:\Users\Administrator\.gradle\caches\forge_gradle\deobf_dependencies\curse\maven\1-1034197\5414946_mapped_official_1.18.2\1-1034197-5414946_mapped_official_1.18.2.jar!\net\mcreator\latexes\world\features\Sandbillagerbunker1Feature.class
