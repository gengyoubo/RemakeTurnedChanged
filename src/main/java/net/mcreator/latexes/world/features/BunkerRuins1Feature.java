...
/* 30 */   public static BunkerRuins1Feature FEATURE = null;
...
/* 35 */     FEATURE = new BunkerRuins1Feature();
/* 36 */     CONFIGURED_FEATURE = FeatureUtils.register("latex:bunker_ruins_1", FEATURE, (FeatureConfiguration)FeatureConfiguration.NONE);
/* 37 */     PLACED_FEATURE = PlacementUtils.register("latex:bunker_ruins_1", CONFIGURED_FEATURE, List.of());
/* 38 */     return FEATURE;
/*    */   }
/*    */   
...
/* 54 */     this.base_blocks = List.of(Blocks.STONE, Blocks.GRASS_BLOCK, Blocks.DIRT_PATH, Blocks.DIRT, Blocks.COARSE_DIRT, Blocks.SAND, Blocks.RED_SAND);
/*    */   }
/*    */ 
/*    */   
...
/* 62 */       this.template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("latex", "ruins_with_bunker")); 
/* 63 */     if (this.template == null)
/* 64 */       return false; 
/* 65 */     boolean anyPlaced = false;
/* 66 */     if (context.random().nextInt(1000000) + 1 <= 500) {
...
/*    */           
/* 74 */           BlockPos spawnTo = new BlockPos(i + 0, j + -6, k + 0);
...
/* Location:              C:\Users\Administrator\.gradle\caches\forge_gradle\deobf_dependencies\curse\maven\1-1034197\5414946_mapped_official_1.18.2\1-1034197-5414946_mapped_official_1.18.2.jar!\net\mcreator\latexes\world\features\BunkerRuins1Feature.class
