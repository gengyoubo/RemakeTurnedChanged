...
/*    */ 
/*    */ public class HiddenbunkerinruinsFeature extends Feature<NoneFeatureConfiguration> {
/* 30 */   public static HiddenbunkerinruinsFeature FEATURE = null;
...
/* 35 */     FEATURE = new HiddenbunkerinruinsFeature();
/* 36 */     CONFIGURED_FEATURE = FeatureUtils.register("latex:hiddenbunkerinruins", FEATURE, (FeatureConfiguration)FeatureConfiguration.NONE);
/* 37 */     PLACED_FEATURE = PlacementUtils.register("latex:hiddenbunkerinruins", CONFIGURED_FEATURE, List.of());
/* 38 */     return FEATURE;
/*    */   }
/*    */   
...
/*    */   
/*    */   public HiddenbunkerinruinsFeature() {
...
/* 63 */       this.template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("latex", "hidden_bunker")); 
/* 64 */     if (this.template == null)
/* 65 */       return false; 
/* 66 */     boolean anyPlaced = false;
/* 67 */     if (context.random().nextInt(1000000) + 1 <= 375) {
...
/*    */           
/* 75 */           BlockPos spawnTo = new BlockPos(i + 0, j + -10, k + 0);
/* 76 */           if (this.template.placeInWorld((ServerLevelAccessor)context.level(), spawnTo, spawnTo, (new StructurePlaceSettings())
/* 77 */               .setMirror(Mirror.values()[context.random().nextInt(2)])
/* 78 */               .setRotation(Rotation.values()[context.random().nextInt(3)]).setRandom(context.random())
/* 79 */               .addProcessor((StructureProcessor)BlockIgnoreProcessor.STRUCTURE_BLOCK).setIgnoreEntities(false), context
/* 80 */               .random(), 2))
/* 81 */             anyPlaced = true; 
/*    */         } 
/*    */       } 
...
/* Location:              C:\Users\Administrator\.gradle\caches\forge_gradle\deobf_dependencies\curse\maven\1-1034197\5414946_mapped_official_1.18.2\1-1034197-5414946_mapped_official_1.18.2.jar!\net\mcreator\latexes\world\features\HiddenbunkerinruinsFeature.class
