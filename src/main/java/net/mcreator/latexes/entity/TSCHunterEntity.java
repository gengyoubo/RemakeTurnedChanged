...
public class TSCHunterEntity extends Monster {
    ...
    protected void registerGoals() {
        ...
        this.targetSelector.addGoal(5, new NearestAttackableTargetGoal(this, Mob.class, true, false) {
            public boolean canUse() {
                double x = TSCHunterEntity.this.getX();
                double y = TSCHunterEntity.this.getY();
                double z = TSCHunterEntity.this.getZ();
                Entity entity = TSCHunterEntity.this;
                Level world = TSCHunterEntity.this.level;
        ...
        this.goalSelector.addGoal(12, new RemoveBlockGoal((Block)LatexModBlocks.DARKLATEXBLOCK.get(), this, 1.0, 3));
        this.goalSelector.addGoal(13, new RemoveBlockGoal((Block)LatexModBlocks.DARKLATEXBLOCKHARMLESS.get(), this, 1.0, 3));
        this.goalSelector.addGoal(14, new RemoveBlockGoal((Block)LatexModBlocks.DARKLATEXBLOCKCRYSTALGROW.get(), this, 1.0, 3));
        this.goalSelector.addGoal(15, new RemoveBlockGoal((Block)LatexModBlocks.DARKLATEXHIVE.get(), this, 1.0, 3));
        this.goalSelector.addGoal(16, new OpenDoorGoal(this, false));
        this.goalSelector.addGoal(17, new LookAtPlayerGoal(this, LivingEntity.class, 6.0F) {
            public boolean canUse() {
                double x = TSCHunterEntity.this.getX();
                double y = TSCHunterEntity.this.getY();
                double z = TSCHunterEntity.this.getZ();
    ...
    public void die(DamageSource source) {
        super.die(source);
        TSCHunterEntityDiesProcedure.execute(this.level, this.getX(), this.getY(), this.getZ());
    }

    public void awardKillScore(Entity entity, int score, DamageSource damageSource) {
        super.awardKillScore(entity, score, damageSource);
        TSCHunterThisEntityKillsAnotherOneProcedure.execute(this.level, this.getX(), this.getY(), this.getZ(), entity, this);
    }
    ...
    public static AttributeSupplier.Builder createAttributes() {
        ...
        builder = builder.add(Attributes.MAX_HEALTH, 85.0);
        builder = builder.add(Attributes.ARMOR, 8.0);
        builder = builder.add(Attributes.ATTACK_DAMAGE, 4.0);
        builder = builder.add(Attributes.FOLLOW_RANGE, 16.0);
        builder = builder.add(Attributes.KNOCKBACK_RESISTANCE, 0.7999999999999999);
        return builder;
    }
}
