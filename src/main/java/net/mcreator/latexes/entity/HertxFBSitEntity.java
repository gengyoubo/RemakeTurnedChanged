...
/* loaded from: 1-1034197-5414946_mapped_official_1.18.2.jar:net/mcreator/latexes/entity/HertxFBSitEntity.class */
public class HertxFBSitEntity extends TamableAnimal {
    public HertxFBSitEntity(PlayMessages.SpawnEntity packet, Level world) {
        this((EntityType) LatexModEntities.HERTX_FB_SIT.get(), world);
    }
    ...
    public HertxFBSitEntity(EntityType<HertxFBSitEntity> type, Level world) {
        ...
        this.xpReward = 4;
        setNoAi(false);
        setCustomName(new TextComponent("§3[Idle]"));
    ...
    /* renamed from: net.mcreator.latexes.entity.HertxFBSitEntity$1  reason: invalid class name */
    /* loaded from: 1-1034197-5414946_mapped_official_1.18.2.jar:net/mcreator/latexes/entity/HertxFBSitEntity$1.class */
    ...
    /* renamed from: net.mcreator.latexes.entity.HertxFBSitEntity$2  reason: invalid class name */
    /* loaded from: 1-1034197-5414946_mapped_official_1.18.2.jar:net/mcreator/latexes/entity/HertxFBSitEntity$2.class */
    class AnonymousClass2 extends NearestAttackableTargetGoal {
        ...
        public boolean canUse() {
            return canUse() && CheckiftamedProcedure.execute(HertxFBSitEntity.this.level, HertxFBSitEntity.this.getX(), HertxFBSitEntity.this.getY(), HertxFBSitEntity.this.getZ(), HertxFBSitEntity.this);
        }
    }
    ...
    public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
        ...
        HertxFBSitRightClickedOnEntityProcedure.execute(this.level, getX(), getY(), getZ(), this, sourceentity);
        return retval;
    }
    ...
    public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
        HertxFBSitEntity retval = ((EntityType) LatexModEntities.HERTX_FB_SIT.get()).create(serverWorld);
