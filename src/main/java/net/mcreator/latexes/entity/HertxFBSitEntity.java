...
public class HertxFBSitEntity extends TamableAnimal {
    ...
    public HertxFBSitEntity(EntityType<HertxFBSitEntity> type, Level world) {
        ...
        this.xpReward = 4;
        this.setNoAi(false);
        this.setCustomName(new TextComponent("§3[Idle]"));
    ...
    protected void registerGoals() {
        ...
        this.targetSelector.addGoal(2, new NearestAttackableTargetGoal(this, SlimelingEntity.class, false, false) {
            public boolean canUse() {
                double x = HertxFBSitEntity.this.getX();
                double y = HertxFBSitEntity.this.getY();
                double z = HertxFBSitEntity.this.getZ();
                Entity entity = HertxFBSitEntity.this;
                Level world = HertxFBSitEntity.this.level;
    ...
    public @NotNull InteractionResult mobInteract(Player sourceentity, @NotNull InteractionHand hand) {
        ...
        HertxFBSitRightClickedOnEntityProcedure.execute(world, x, y, z, entity, sourceentity);
        return retval;
    }
    ...
    public AgeableMob getBreedOffspring(@NotNull ServerLevel serverWorld, @NotNull AgeableMob ageable) {
        HertxFBSitEntity retval = (HertxFBSitEntity)((EntityType)LatexModEntities.HERTX_FB_SIT.get()).create(serverWorld);
