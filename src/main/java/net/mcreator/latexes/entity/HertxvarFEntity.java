...
/*  63 */     this((EntityType<HertxvarFEntity>)LatexModEntities.HERTXVAR_F.get(), world);
/*     */   }
/*     */   
...
/*  90 */             double x = HertxvarFEntity.this.getX();
/*  91 */             double y = HertxvarFEntity.this.getY();
/*  92 */             double z = HertxvarFEntity.this.getZ();
/*  93 */             HertxvarFEntity hertxvarFEntity = HertxvarFEntity.this;
/*  94 */             Level world = HertxvarFEntity.this.level;
/*  95 */             return (super.canUse() && CheckiftamedProcedure.execute((LevelAccessor)world, x, y, z, (Entity)hertxvarFEntity));
/*     */           }
/*     */         });
...
/* 208 */     double y = getY();
/* 209 */     double z = getZ();
/* 210 */     HertxvarFEntity hertxvarFEntity = this;
/* 211 */     Level world = this.level;
/*     */     
/* 213 */     HertxvarFRightClickedOnEntityProcedure.execute((LevelAccessor)world, x, y, z, (Entity)hertxvarFEntity, (Entity)sourceentity);
/* 214 */     return retval;
/*     */   }
/*     */ 
/*     */   
...
/* 231 */     HertxvarFEntity retval = (HertxvarFEntity)((EntityType)LatexModEntities.HERTXVAR_F.get()).create((Level)serverWorld);
...
/* 238 */     return List.<Item>of((Item)LatexModItems.DARKLATEXGOO.get(), (Item)LatexModItems.LATEX_SOUP.get()).contains(stack.getItem());
/*     */   }
/*     */ 
/*     */   
...
/* Location:              C:\Users\Administrator\.gradle\caches\forge_gradle\deobf_dependencies\curse\maven\1-1034197\5414946_mapped_official_1.18.2\1-1034197-5414946_mapped_official_1.18.2.jar!\net\mcreator\latexes\entity\HertxvarFEntity.class
