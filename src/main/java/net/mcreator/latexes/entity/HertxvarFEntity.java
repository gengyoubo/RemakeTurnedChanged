...
public class HertxvarFEntity extends TamableAnimal {
    ...
    protected void registerGoals() {
        ...
        this.targetSelector.addGoal(2, new NearestAttackableTargetGoal(this, SlimelingEntity.class, false, false) {
            public boolean canUse() {
                double x = HertxvarFEntity.this.getX();
                double y = HertxvarFEntity.this.getY();
                double z = HertxvarFEntity.this.getZ();
                Entity entity = HertxvarFEntity.this;
                Level world = HertxvarFEntity.this.level;
    ...
    public @NotNull InteractionResult mobInteract(Player sourceentity, @NotNull InteractionHand hand) {
        ...
        HertxvarFRightClickedOnEntityProcedure.execute(world, x, y, z, entity, sourceentity);
        return retval;
    }
