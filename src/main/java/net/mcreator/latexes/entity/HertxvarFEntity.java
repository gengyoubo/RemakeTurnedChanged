...
import net.mcreator.latexes.procedures.HertxvarFRightClickedOnEntityProcedure;
...
/* loaded from: 1-1034197-5414946_mapped_official_1.18.2.jar:net/mcreator/latexes/entity/HertxvarFEntity.class */
public class HertxvarFEntity extends TamableAnimal {
    ...
    /* renamed from: net.mcreator.latexes.entity.HertxvarFEntity$1  reason: invalid class name */
    /* loaded from: 1-1034197-5414946_mapped_official_1.18.2.jar:net/mcreator/latexes/entity/HertxvarFEntity$1.class */
    ...
    /* renamed from: net.mcreator.latexes.entity.HertxvarFEntity$2  reason: invalid class name */
    /* loaded from: 1-1034197-5414946_mapped_official_1.18.2.jar:net/mcreator/latexes/entity/HertxvarFEntity$2.class */
    class AnonymousClass2 extends NearestAttackableTargetGoal {
        ...
        public boolean canUse() {
            return canUse() && CheckiftamedProcedure.execute(HertxvarFEntity.this.level, HertxvarFEntity.this.getX(), HertxvarFEntity.this.getY(), HertxvarFEntity.this.getZ(), HertxvarFEntity.this);
        }
    }
    ...
    public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
        ...
        HertxvarFRightClickedOnEntityProcedure.execute(this.level, getX(), getY(), getZ(), this, sourceentity);
        return retval;
    }
    ...
    public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
        HertxvarFEntity retval = ((EntityType) LatexModEntities.HERTXVAR_F.get()).create(serverWorld);
