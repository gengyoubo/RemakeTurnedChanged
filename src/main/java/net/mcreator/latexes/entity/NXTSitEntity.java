...
/*     */ import net.mcreator.latexes.procedures.NXTSitRightClickedOnEntityProcedure;
...
/*  58 */     this((EntityType<NXTSitEntity>)LatexModEntities.NXT_SIT.get(), world);
/*     */   }
/*     */   
...
/*  63 */     this.xpReward = 4;
/*  64 */     setNoAi(false);
/*  65 */     setCustomName((Component)new TextComponent("§c[Idle]"));
...
/*     */           }
/*     */         });
/*  84 */     this.goalSelector.addGoal(2, (Goal)new LookAtPlayerGoal((Mob)this, Player.class, 3.0F));
...
/* 193 */     double y = getY();
/* 194 */     double z = getZ();
/* 195 */     NXTSitEntity nXTSitEntity = this;
/* 196 */     Level world = this.level;
/*     */     
/* 198 */     NXTSitRightClickedOnEntityProcedure.execute((LevelAccessor)world, x, y, z, (Entity)nXTSitEntity, (Entity)sourceentity);
/* 199 */     return retval;
/*     */   }
/*     */ 
/*     */   
...
/* 210 */     NXTSitEntity retval = (NXTSitEntity)((EntityType)LatexModEntities.NXT_SIT.get()).create((Level)serverWorld);
...
/* 217 */     return List.<Item>of(Items.REDSTONE, (Item)LatexModItems.DARKLATEXGOO.get(), (Item)LatexModItems.BATTERY.get()).contains(stack.getItem());
/*     */   }
/*     */ 
/*     */   
...
/* Location:              C:\Users\Administrator\.gradle\caches\forge_gradle\deobf_dependencies\curse\maven\1-1034197\5414946_mapped_official_1.18.2\1-1034197-5414946_mapped_official_1.18.2.jar!\net\mcreator\latexes\entity\NXTSitEntity.class
