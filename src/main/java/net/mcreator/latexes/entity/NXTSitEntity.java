...
/* loaded from: 1-1034197-5414946_mapped_official_1.18.2.jar:net/mcreator/latexes/entity/NXTSitEntity.class */
public class NXTSitEntity extends TamableAnimal {
    ...
    public NXTSitEntity(EntityType<NXTSitEntity> type, Level world) {
        ...
        this.xpReward = 4;
        setNoAi(false);
        setCustomName(new TextComponent("§c[Idle]"));
    ...
    /* renamed from: net.mcreator.latexes.entity.NXTSitEntity$1  reason: invalid class name */
    /* loaded from: 1-1034197-5414946_mapped_official_1.18.2.jar:net/mcreator/latexes/entity/NXTSitEntity$1.class */
    ...
    public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
        ...
        NXTSitRightClickedOnEntityProcedure.execute(this.level, getX(), getY(), getZ(), this, sourceentity);
        return retval;
    }
    ...
    public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
        NXTSitEntity retval = ((EntityType) LatexModEntities.NXT_SIT.get()).create(serverWorld);
        retval.finalizeSpawn(serverWorld, serverWorld.getCurrentDifficultyAt(retval.blockPosition()), MobSpawnType.BREEDING, null, null);
        return retval;
    }

    public boolean isFood(ItemStack stack) {
        return List.of(Items.REDSTONE, (Item) LatexModItems.DARKLATEXGOO.get(), (Item) LatexModItems.BATTERY.get()).contains(stack.getItem());
    }
