...
/* loaded from: 1-1034197-5414946_mapped_official_1.18.2.jar:net/mcreator/latexes/entity/ProtectorSlimelingsitEntity.class */
public class ProtectorSlimelingsitEntity extends TamableAnimal {
    ...
    public ProtectorSlimelingsitEntity(EntityType<ProtectorSlimelingsitEntity> type, Level world) {
        ...
        this.xpReward = 6;
        setNoAi(false);
        setCustomName(new TextComponent("§d[Idle]"));
    ...
    /* renamed from: net.mcreator.latexes.entity.ProtectorSlimelingsitEntity$1  reason: invalid class name */
    /* loaded from: 1-1034197-5414946_mapped_official_1.18.2.jar:net/mcreator/latexes/entity/ProtectorSlimelingsitEntity$1.class */
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(2, new LookAtPlayerGoal(this, DarklatexEntity.class, 3.0f));
    ...
    public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
        ...
        ProtectorSlimelingsitRightClickedOnEntityProcedure.execute(this.level, getX(), getY(), getZ(), this, sourceentity);
        return retval;
    }
    ...
    public static AttributeSupplier.Builder createAttributes() {
        return Mob.createMobAttributes().add(Attributes.MOVEMENT_SPEED, 0.0d).add(Attributes.MAX_HEALTH, 50.0d).add(Attributes.ARMOR, 5.5d).add(Attributes.ATTACK_DAMAGE, 0.0d).add(Attributes.FOLLOW_RANGE, 16.0d).add(Attributes.KNOCKBACK_RESISTANCE, 0.6d);
    }
}
