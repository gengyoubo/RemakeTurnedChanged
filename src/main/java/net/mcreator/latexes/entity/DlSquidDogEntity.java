...
/* loaded from: 1-1034197-5414946_mapped_official_1.18.2.jar:net/mcreator/latexes/entity/DlSquidDogEntity.class */
public class DlSquidDogEntity extends Monster {
    ...
    /* renamed from: net.mcreator.latexes.entity.DlSquidDogEntity$1  reason: invalid class name */
    /* loaded from: 1-1034197-5414946_mapped_official_1.18.2.jar:net/mcreator/latexes/entity/DlSquidDogEntity$1.class */
    class AnonymousClass1 extends MeleeAttackGoal {
        ...
        public boolean canUse() {
            DlSquidDogEntity.this.getX();
            DlSquidDogEntity.this.getY();
            DlSquidDogEntity.this.getZ();
            Entity entity = DlSquidDogEntity.this;
            Level level = DlSquidDogEntity.this.level;
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(22, new AnonymousClass5(this));
    }

    /* renamed from: net.mcreator.latexes.entity.DlSquidDogEntity$2  reason: invalid class name */
    /* loaded from: 1-1034197-5414946_mapped_official_1.18.2.jar:net/mcreator/latexes/entity/DlSquidDogEntity$2.class */
    ...
    /* renamed from: net.mcreator.latexes.entity.DlSquidDogEntity$3  reason: invalid class name */
    /* loaded from: 1-1034197-5414946_mapped_official_1.18.2.jar:net/mcreator/latexes/entity/DlSquidDogEntity$3.class */
    ...
    /* renamed from: net.mcreator.latexes.entity.DlSquidDogEntity$4  reason: invalid class name */
    /* loaded from: 1-1034197-5414946_mapped_official_1.18.2.jar:net/mcreator/latexes/entity/DlSquidDogEntity$4.class */
    ...
    /* renamed from: net.mcreator.latexes.entity.DlSquidDogEntity$5  reason: invalid class name */
    /* loaded from: 1-1034197-5414946_mapped_official_1.18.2.jar:net/mcreator/latexes/entity/DlSquidDogEntity$5.class */
    class AnonymousClass5 extends FloatGoal {
        ...
        public boolean canUse() {
            ...
            DlSquidDogEntity dlSquidDogEntity = DlSquidDogEntity.this;
            return canUse() && CheckbordersharkProcedure.execute(DlSquidDogEntity.this.level, x, y, z);
        }
    }
    ...
    public void awardKillScore(Entity entity, int score, DamageSource damageSource) {
        ...
        DlSquidDogThisEntityKillsAnotherOneProcedure.execute(this.level, getX(), getY(), getZ(), entity);
    }
