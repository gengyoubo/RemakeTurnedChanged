...
/*  33 */     super((EntityType)LatexModEntities.EXPLOSIVEGOO.get(), world);
/*     */   }
/*     */   
...
/*  61 */     return new ItemStack((ItemLike)LatexModItems.EXPLOSIVEGOO.get());
/*     */   }
/*     */ 
/*     */   
...
/*  92 */     ExplosivegooEntity entityarrow = new ExplosivegooEntity((EntityType<? extends ExplosivegooEntity>)LatexModEntities.EXPLOSIVEGOO.get(), entity, world);
...
/* 100 */         .getValue(new ResourceLocation("entity.slime.squish")), SoundSource.PLAYERS, 1.0F, 1.0F / (random
...
/* 106 */     ExplosivegooEntity entityarrow = new ExplosivegooEntity((EntityType<? extends ExplosivegooEntity>)LatexModEntities.EXPLOSIVEGOO.get(), entity, entity.level);
...
/* 110 */     entityarrow.shoot(dx, dy - entityarrow.getY() + Math.hypot(dx, dz) * 0.20000000298023224D, dz, 1.0F, 12.0F);
/* 111 */     entityarrow.setSilent(true);
/* 112 */     entityarrow.setBaseDamage(0.5D);
/* 113 */     entityarrow.setKnockback(2);
...
/* 117 */         .getValue(new ResourceLocation("entity.slime.squish")), SoundSource.PLAYERS, 1.0F, 1.0F / ((new Random())
...
/* Location:              C:\Users\Administrator\.gradle\caches\forge_gradle\deobf_dependencies\curse\maven\1-1034197\5414946_mapped_official_1.18.2\1-1034197-5414946_mapped_official_1.18.2.jar!\net\mcreator\latexes\entity\ExplosivegooEntity.class
