...
public class HertxvarSolEntity extends TamableAnimal {
    ...
    protected void registerGoals() {
        ...
        this.targetSelector.addGoal(2, new NearestAttackableTargetGoal(this, SlimelingEntity.class, false, false) {
            public boolean canUse() {
                double x = HertxvarSolEntity.this.getX();
                double y = HertxvarSolEntity.this.getY();
                double z = HertxvarSolEntity.this.getZ();
                Entity entity = HertxvarSolEntity.this;
                Level world = HertxvarSolEntity.this.level;
    ...
    public @NotNull InteractionResult mobInteract(Player sourceentity, @NotNull InteractionHand hand) {
        ...
        HertxvarSolRightClickedOnEntityProcedure.execute(world, x, y, z, entity, sourceentity);
        return retval;
    }
    ...
    public AgeableMob getBreedOffspring(@NotNull ServerLevel serverWorld, @NotNull AgeableMob ageable) {
        HertxvarSolEntity retval = (HertxvarSolEntity)((EntityType)LatexModEntities.HERTXVAR_SOL.get()).create(serverWorld);
