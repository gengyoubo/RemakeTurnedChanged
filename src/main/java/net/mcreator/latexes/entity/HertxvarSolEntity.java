...
/*  91 */             double x = HertxvarSolEntity.this.getX();
/*  92 */             double y = HertxvarSolEntity.this.getY();
/*  93 */             double z = HertxvarSolEntity.this.getZ();
/*  94 */             HertxvarSolEntity hertxvarSolEntity = HertxvarSolEntity.this;
/*  95 */             Level world = HertxvarSolEntity.this.level;
/*  96 */             return (super.canUse() && CheckiftamedProcedure.execute((LevelAccessor)world, x, y, z, (Entity)hertxvarSolEntity));
/*     */           }
/*     */         });
...
/* 101 */     this.goalSelector.addGoal(5, (Goal)new FollowOwnerGoal(this, 1.0D, 2.0F, 64.0F, false));
...
/* 106 */     this.targetSelector.addGoal(10, (Goal)(new HurtByTargetGoal((PathfinderMob)this, new Class[0])).setAlertOthers(new Class[0]));
...
/* 232 */     HertxvarSolEntity retval = (HertxvarSolEntity)((EntityType)LatexModEntities.HERTXVAR_SOL.get()).create((Level)serverWorld);
...
/* 239 */     return List.<Item>of((Item)LatexModItems.DARKLATEXGOO.get(), Items.IRON_NUGGET, Items.IRON_INGOT).contains(stack.getItem());
/*     */   }
/*     */ 
/*     */   
...
/* 249 */     builder = builder.add(Attributes.ARMOR, 7.5D);
...
/* 253 */     builder = builder.add(Attributes.ATTACK_KNOCKBACK, 0.2D);
/* 254 */     return builder;
/*     */   }
/*     */ }


/* Location:              C:\Users\Administrator\.gradle\caches\forge_gradle\deobf_dependencies\curse\maven\1-1034197\5414946_mapped_official_1.18.2\1-1034197-5414946_mapped_official_1.18.2.jar!\net\mcreator\latexes\entity\HertxvarSolEntity.class
