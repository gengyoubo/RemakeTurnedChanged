...
/* loaded from: 1-1034197-5414946_mapped_official_1.18.2.jar:net/mcreator/latexes/entity/BeeHertxSitEntity.class */
public class BeeHertxSitEntity extends TamableAnimal {
    public BeeHertxSitEntity(PlayMessages.SpawnEntity packet, Level world) {
        this((EntityType) LatexModEntities.BEE_HERTX_SIT.get(), world);
    }
    ...
    public BeeHertxSitEntity(EntityType<BeeHertxSitEntity> type, Level world) {
        ...
        this.xpReward = 4;
        setNoAi(false);
        setCustomName(new TextComponent("§e[Idle]"));
    ...
    /* renamed from: net.mcreator.latexes.entity.BeeHertxSitEntity$1  reason: invalid class name */
    /* loaded from: 1-1034197-5414946_mapped_official_1.18.2.jar:net/mcreator/latexes/entity/BeeHertxSitEntity$1.class */
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(3, new LookAtPlayerGoal(this, PathfinderMob.class, 6.0f));
    ...
    public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
        ...
        BeeHertxSitRightClickedOnEntityProcedure.execute(this.level, getX(), getY(), getZ(), this, sourceentity);
        return retval;
    }
    ...
    public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
        BeeHertxSitEntity retval = ((EntityType) LatexModEntities.BEE_HERTX_SIT.get()).create(serverWorld);
        retval.finalizeSpawn(serverWorld, serverWorld.getCurrentDifficultyAt(retval.blockPosition()), MobSpawnType.BREEDING, null, null);
        return retval;
    }

    public boolean isFood(ItemStack stack) {
        return List.of((Object[]) new Item[]{Items.HONEYCOMB, Items.HONEY_BOTTLE, (Item) LatexModItems.DARKLATEXGOO.get(), Blocks.DANDELION.asItem(), Blocks.POPPY.asItem(), Blocks.BLUE_ORCHID.asItem(), Blocks.ALLIUM.asItem(), Blocks.AZURE_BLUET.asItem(), Blocks.RED_TULIP.asItem(), Blocks.ORANGE_TULIP.asItem(), Blocks.WHITE_TULIP.asItem(), Blocks.PINK_TULIP.asItem(), Blocks.OXEYE_DAISY.asItem(), Blocks.CORNFLOWER.asItem(), Blocks.SUNFLOWER.asItem()}).contains(stack.getItem());
    }
