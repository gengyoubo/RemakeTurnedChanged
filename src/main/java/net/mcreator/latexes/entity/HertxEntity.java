...
/* loaded from: 1-1034197-5414946_mapped_official_1.18.2.jar:net/mcreator/latexes/entity/HertxEntity.class */
public class HertxEntity extends TamableAnimal {
    public HertxEntity(PlayMessages.SpawnEntity packet, Level world) {
        this((EntityType) LatexModEntities.HERTX.get(), world);
    }
    ...
    /* renamed from: net.mcreator.latexes.entity.HertxEntity$1  reason: invalid class name */
    /* loaded from: 1-1034197-5414946_mapped_official_1.18.2.jar:net/mcreator/latexes/entity/HertxEntity$1.class */
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(5, new FollowOwnerGoal(this, 1.0d, 3.0f, 48.0f, false));
    ...
    /* renamed from: net.mcreator.latexes.entity.HertxEntity$2  reason: invalid class name */
    /* loaded from: 1-1034197-5414946_mapped_official_1.18.2.jar:net/mcreator/latexes/entity/HertxEntity$2.class */
    class AnonymousClass2 extends NearestAttackableTargetGoal {
        ...
        public boolean canUse() {
            return canUse() && CheckiftamedProcedure.execute(HertxEntity.this.level, HertxEntity.this.getX(), HertxEntity.this.getY(), HertxEntity.this.getZ(), HertxEntity.this);
        }
    }
    ...
    public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
        ...
        HertxRightClickedOnEntityProcedure.execute(this.level, getX(), getY(), getZ(), this, sourceentity);
        return retval;
    }
    ...
    public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
        HertxEntity retval = ((EntityType) LatexModEntities.HERTX.get()).create(serverWorld);
        retval.finalizeSpawn(serverWorld, serverWorld.getCurrentDifficultyAt(retval.blockPosition()), MobSpawnType.BREEDING, null, null);
        return retval;
    }

    public boolean isFood(ItemStack stack) {
        return List.of((Item) LatexModItems.DARKLATEXGOO.get(), (Item) LatexModItems.LATEX_SOUP.get()).contains(stack.getItem());
    }
    ...
    public static AttributeSupplier.Builder createAttributes() {
        return Mob.createMobAttributes().add(Attributes.MOVEMENT_SPEED, 0.32d).add(Attributes.MAX_HEALTH, 36.0d).add(Attributes.ARMOR, 4.0d).add(Attributes.ATTACK_DAMAGE, 5.0d).add(Attributes.FOLLOW_RANGE, 16.0d).add(Attributes.KNOCKBACK_RESISTANCE, 0.2d);
    }
}
