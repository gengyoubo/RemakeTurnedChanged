...
public class HertxEntity extends TamableAnimal {
    ...
    protected void registerGoals() {
        ...
        this.targetSelector.addGoal(2, new NearestAttackableTargetGoal(this, SlimelingEntity.class, false, false) {
            public boolean canUse() {
                double x = HertxEntity.this.getX();
                double y = HertxEntity.this.getY();
                double z = HertxEntity.this.getZ();
                Entity entity = HertxEntity.this;
                Level world = HertxEntity.this.level;
                return super.canUse() && CheckiftamedProcedure.execute(world, x, y, z, entity);
            }
        });
        this.goalSelector.addGoal(3, new OwnerHurtByTargetGoal(this));
        this.targetSelector.addGoal(4, new OwnerHurtTargetGoal(this));
        this.goalSelector.addGoal(5, new FollowOwnerGoal(this, 1.0, 3.0F, 48.0F, false));
    ...
    public @NotNull InteractionResult mobInteract(Player sourceentity, @NotNull InteractionHand hand) {
        ...
        HertxRightClickedOnEntityProcedure.execute(world, x, y, z, entity, sourceentity);
        return retval;
    }
    ...
    public AgeableMob getBreedOffspring(@NotNull ServerLevel serverWorld, @NotNull AgeableMob ageable) {
        HertxEntity retval = (HertxEntity)((EntityType)LatexModEntities.HERTX.get()).create(serverWorld);
    ...
    public static AttributeSupplier.Builder createAttributes() {
        ...
        builder = builder.add(Attributes.MAX_HEALTH, 36.0);
