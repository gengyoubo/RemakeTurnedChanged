    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.2, false) {
            ...
            public boolean canUse() {
                double x = DarkLatexFoxEntity.this.getX();
                double y = DarkLatexFoxEntity.this.getY();
                double z = DarkLatexFoxEntity.this.getZ();
                Entity entity = DarkLatexFoxEntity.this;
                Level world = DarkLatexFoxEntity.this.level;
        ...
        this.goalSelector.addGoal(20, new MoveBackToVillageGoal(this, 0.6, false));
        this.goalSelector.addGoal(21, new LookAtPlayerGoal(this, LivingEntity.class, 6.0F) {
            public boolean canUse() {
                double x = DarkLatexFoxEntity.this.getX();
                double y = DarkLatexFoxEntity.this.getY();
                double z = DarkLatexFoxEntity.this.getZ();
        ...
        this.goalSelector.addGoal(23, new RandomStrollGoal(this, 0.75));
