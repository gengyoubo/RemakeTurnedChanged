...
/*  73 */     AR70AssaultRifleEntity entityarrow = new AR70AssaultRifleEntity((EntityType<? extends AR70AssaultRifleEntity>)LatexModEntities.AR_70_ASSAULT_RIFLE.get(), entity, world);
...
/*  81 */         .getValue(new ResourceLocation("latex:rifle_shot")), SoundSource.PLAYERS, 1.0F, 1.0F / (random
...
/*  87 */     AR70AssaultRifleEntity entityarrow = new AR70AssaultRifleEntity((EntityType<? extends AR70AssaultRifleEntity>)LatexModEntities.AR_70_ASSAULT_RIFLE.get(), entity, entity.level);
...
/*  91 */     entityarrow.shoot(dx, dy - entityarrow.getY() + Math.hypot(dx, dz) * 0.20000000298023224D, dz, 4.8F, 12.0F);
/*  92 */     entityarrow.setSilent(true);
/*  93 */     entityarrow.setBaseDamage(1.0D);
/*  94 */     entityarrow.setKnockback(0);
...
/*  98 */         .getValue(new ResourceLocation("latex:rifle_shot")), SoundSource.PLAYERS, 1.0F, 1.0F / ((new Random())
...
/* Location:              C:\Users\Administrator\.gradle\caches\forge_gradle\deobf_dependencies\curse\maven\1-1034197\5414946_mapped_official_1.18.2\1-1034197-5414946_mapped_official_1.18.2.jar!\net\mcreator\latexes\entity\AR70AssaultRifleEntity.class
