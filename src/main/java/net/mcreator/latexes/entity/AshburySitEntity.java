...
/* loaded from: 1-1034197-5414946_mapped_official_1.18.2.jar:net/mcreator/latexes/entity/AshburySitEntity.class */
public class AshburySitEntity extends TamableAnimal {
    ...
    /* renamed from: net.mcreator.latexes.entity.AshburySitEntity$1  reason: invalid class name */
    /* loaded from: 1-1034197-5414946_mapped_official_1.18.2.jar:net/mcreator/latexes/entity/AshburySitEntity$1.class */
    ...
    public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
        ...
        AshburySitRightClickedOnEntityProcedure.execute(this.level, getX(), getY(), getZ(), this, sourceentity);
        return retval;
    }
    ...
    public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
        AshburySitEntity retval = ((EntityType) LatexModEntities.ASHBURY_SIT.get()).create(serverWorld);
        retval.finalizeSpawn(serverWorld, serverWorld.getCurrentDifficultyAt(retval.blockPosition()), MobSpawnType.BREEDING, null, null);
        return retval;
    }

    public boolean isFood(ItemStack stack) {
        return List.of((Item) LatexModItems.DARKLATEXGOO.get(), (Item) LatexModItems.LATEX_SOUP.get(), Items.ORANGE_DYE).contains(stack.getItem());
    }
