    ...
    protected void registerGoals() {
        ...
        this.targetSelector.addGoal(5, new NearestAttackableTargetGoal(this, Mob.class, true, false) {
            public boolean canUse() {
                double x = TSCOutsiderEntity.this.getX();
                double y = TSCOutsiderEntity.this.getY();
                double z = TSCOutsiderEntity.this.getZ();
                Entity entity = TSCOutsiderEntity.this;
                Level world = TSCOutsiderEntity.this.level;
        ...
        this.goalSelector.addGoal(11, new LookAtPlayerGoal(this, LivingEntity.class, 4.0F) {
            public boolean canUse() {
                double x = TSCOutsiderEntity.this.getX();
                double y = TSCOutsiderEntity.this.getY();
                double z = TSCOutsiderEntity.this.getZ();
