    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.1, false) {
            ...
            public boolean canUse() {
                double x = DarkLatexFoxScientistEntity.this.getX();
                double y = DarkLatexFoxScientistEntity.this.getY();
                double z = DarkLatexFoxScientistEntity.this.getZ();
                Entity entity = DarkLatexFoxScientistEntity.this;
                Level world = DarkLatexFoxScientistEntity.this.level;
