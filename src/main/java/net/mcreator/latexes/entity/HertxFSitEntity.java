...
/* loaded from: 1-1034197-5414946_mapped_official_1.18.2.jar:net/mcreator/latexes/entity/HertxFSitEntity.class */
public class HertxFSitEntity extends TamableAnimal {
    ...
    public HertxFSitEntity(EntityType<HertxFSitEntity> type, Level world) {
        ...
        this.xpReward = 4;
        setNoAi(false);
        setCustomName(new TextComponent("§b[Idle]"));
    ...
    /* renamed from: net.mcreator.latexes.entity.HertxFSitEntity$1  reason: invalid class name */
    /* loaded from: 1-1034197-5414946_mapped_official_1.18.2.jar:net/mcreator/latexes/entity/HertxFSitEntity$1.class */
    ...
    public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
        ...
        HertxFSitRightClickedOnEntityProcedure.execute(this.level, getX(), getY(), getZ(), this, sourceentity);
        return retval;
    }
    ...
    public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
        HertxFSitEntity retval = ((EntityType) LatexModEntities.HERTX_F_SIT.get()).create(serverWorld);
