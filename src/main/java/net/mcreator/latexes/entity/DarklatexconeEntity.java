...
public class DarklatexconeEntity extends Monster {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.1, false) {
            ...
            public boolean canUse() {
                double x = DarklatexconeEntity.this.getX();
                double y = DarklatexconeEntity.this.getY();
                double z = DarklatexconeEntity.this.getZ();
                Entity entity = DarklatexconeEntity.this;
                Level world = DarklatexconeEntity.this.level;
    ...
    public void awardKillScore(Entity entity, int score, DamageSource damageSource) {
        ...
        DarklatexconeThisEntityKillsAnotherOneProcedure.execute(this.level, this.getX(), this.getY(), this.getZ(), entity, this);
    }
