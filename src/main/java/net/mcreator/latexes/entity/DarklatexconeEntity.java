...
/* loaded from: 1-1034197-5414946_mapped_official_1.18.2.jar:net/mcreator/latexes/entity/DarklatexconeEntity.class */
public class DarklatexconeEntity extends Monster {
    ...
    /* renamed from: net.mcreator.latexes.entity.DarklatexconeEntity$1  reason: invalid class name */
    /* loaded from: 1-1034197-5414946_mapped_official_1.18.2.jar:net/mcreator/latexes/entity/DarklatexconeEntity$1.class */
    class AnonymousClass1 extends MeleeAttackGoal {
        ...
        public boolean canUse() {
            DarklatexconeEntity.this.getX();
            DarklatexconeEntity.this.getY();
            DarklatexconeEntity.this.getZ();
            Entity entity = DarklatexconeEntity.this;
            Level level = DarklatexconeEntity.this.level;
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(22, new AnonymousClass5(this, LivingEntity.class, 6.0f));
    ...
    /* renamed from: net.mcreator.latexes.entity.DarklatexconeEntity$2  reason: invalid class name */
    /* loaded from: 1-1034197-5414946_mapped_official_1.18.2.jar:net/mcreator/latexes/entity/DarklatexconeEntity$2.class */
    ...
    /* renamed from: net.mcreator.latexes.entity.DarklatexconeEntity$3  reason: invalid class name */
    /* loaded from: 1-1034197-5414946_mapped_official_1.18.2.jar:net/mcreator/latexes/entity/DarklatexconeEntity$3.class */
    ...
    /* renamed from: net.mcreator.latexes.entity.DarklatexconeEntity$4  reason: invalid class name */
    /* loaded from: 1-1034197-5414946_mapped_official_1.18.2.jar:net/mcreator/latexes/entity/DarklatexconeEntity$4.class */
    ...
    /* renamed from: net.mcreator.latexes.entity.DarklatexconeEntity$5  reason: invalid class name */
    /* loaded from: 1-1034197-5414946_mapped_official_1.18.2.jar:net/mcreator/latexes/entity/DarklatexconeEntity$5.class */
    ...
    public void awardKillScore(Entity entity, int score, DamageSource damageSource) {
        ...
        DarklatexconeThisEntityKillsAnotherOneProcedure.execute(this.level, getX(), getY(), getZ(), entity, this);
    }
    ...
    public static AttributeSupplier.Builder createAttributes() {
        return Mob.createMobAttributes().add(Attributes.MOVEMENT_SPEED, 0.32d).add(Attributes.MAX_HEALTH, 18.0d).add(Attributes.ARMOR, 0.0d).add(Attributes.ATTACK_DAMAGE, 2.0d).add(Attributes.FOLLOW_RANGE, 18.0d).add(Attributes.KNOCKBACK_RESISTANCE, 0.1d);
    }
}
