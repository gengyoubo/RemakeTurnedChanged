...
/*     */ import net.mcreator.latexes.procedures.DarklatexconeThisEntityKillsAnotherOneProcedure;
...
/*     */ 
/*     */ public class DarklatexconeEntity extends Monster {
/*     */   public DarklatexconeEntity(PlayMessages.SpawnEntity packet, Level world) {
/*  61 */     this((EntityType<DarklatexconeEntity>)LatexModEntities.DARKLATEXCONE.get(), world);
/*     */   }
/*     */   
...
/*  86 */             double x = DarklatexconeEntity.this.getX();
/*  87 */             double y = DarklatexconeEntity.this.getY();
/*  88 */             double z = DarklatexconeEntity.this.getZ();
/*  89 */             DarklatexconeEntity darklatexconeEntity = DarklatexconeEntity.this;
/*  90 */             Level world = DarklatexconeEntity.this.level;
/*  91 */             return (super.canUse() && TargetwearingmaskProcedure.execute((Entity)darklatexconeEntity));
/*     */           }
/*     */         });
/*     */     
...
/*     */         {
/*     */           public boolean canUse() {
/*  99 */             double x = DarklatexconeEntity.this.getX();
/* 100 */             double y = DarklatexconeEntity.this.getY();
/* 101 */             double z = DarklatexconeEntity.this.getZ();
/* 102 */             DarklatexconeEntity darklatexconeEntity = DarklatexconeEntity.this;
/* 103 */             Level world = DarklatexconeEntity.this.level;
/* 104 */             return (super.canUse() && CheckSlimelingProcedure.execute((Entity)darklatexconeEntity));
/*     */           }
/*     */         });
/* 107 */     this.targetSelector.addGoal(4, (Goal)new NearestAttackableTargetGoal((Mob)this, LivingEntity.class, true, false)
/*     */         {
/*     */           public boolean canUse() {
/* 110 */             double x = DarklatexconeEntity.this.getX();
/* 111 */             double y = DarklatexconeEntity.this.getY();
/* 112 */             double z = DarklatexconeEntity.this.getZ();
/* 113 */             DarklatexconeEntity darklatexconeEntity = DarklatexconeEntity.this;
/* 114 */             Level world = DarklatexconeEntity.this.level;
/* 115 */             return (super.canUse() && CheckGoodProcedure.execute((Entity)darklatexconeEntity));
/*     */           }
/*     */         });
/* 118 */     this.targetSelector.addGoal(5, (Goal)new NearestAttackableTargetGoal((Mob)this, LivingEntity.class, true, false)
/*     */         {
/*     */           public boolean canUse() {
/* 121 */             double x = DarklatexconeEntity.this.getX();
/* 122 */             double y = DarklatexconeEntity.this.getY();
/* 123 */             double z = DarklatexconeEntity.this.getZ();
/* 124 */             DarklatexconeEntity darklatexconeEntity = DarklatexconeEntity.this;
/* 125 */             Level world = DarklatexconeEntity.this.level;
/* 126 */             return (super.canUse() && CheckEvilProcedure.execute((Entity)darklatexconeEntity));
/*     */           }
/*     */         });
...
/*     */         {
/*     */           public boolean canUse() {
/* 148 */             double x = DarklatexconeEntity.this.getX();
/* 149 */             double y = DarklatexconeEntity.this.getY();
/* 150 */             double z = DarklatexconeEntity.this.getZ();
/* 151 */             DarklatexconeEntity darklatexconeEntity = DarklatexconeEntity.this;
/* 152 */             Level world = DarklatexconeEntity.this.level;
/* 153 */             return (super.canUse() && CheckentityislatexProcedure.execute((Entity)darklatexconeEntity));
/*     */           }
/*     */         });
...
/* 213 */     DarklatexconeThisEntityKillsAnotherOneProcedure.execute((LevelAccessor)this.level, getX(), getY(), getZ(), entity, (Entity)this);
/*     */   }
/*     */   
/*     */   public static void init() {
/* 217 */     DungeonHooks.addDungeonMob((EntityType)LatexModEntities.DARKLATEXCONE.get(), 180);
/*     */   }
/*     */   
/*     */   public static AttributeSupplier.Builder createAttributes() {
/* 221 */     AttributeSupplier.Builder builder = Mob.createMobAttributes();
/* 222 */     builder = builder.add(Attributes.MOVEMENT_SPEED, 0.32D);
/* 223 */     builder = builder.add(Attributes.MAX_HEALTH, 18.0D);
/* 224 */     builder = builder.add(Attributes.ARMOR, 0.0D);
/* 225 */     builder = builder.add(Attributes.ATTACK_DAMAGE, 2.0D);
/* 226 */     builder = builder.add(Attributes.FOLLOW_RANGE, 18.0D);
/* 227 */     builder = builder.add(Attributes.KNOCKBACK_RESISTANCE, 0.1D);
/* 228 */     return builder;
/*     */   }
/*     */ }


/* Location:              C:\Users\Administrator\.gradle\caches\forge_gradle\deobf_dependencies\curse\maven\1-1034197\5414946_mapped_official_1.18.2\1-1034197-5414946_mapped_official_1.18.2.jar!\net\mcreator\latexes\entity\DarklatexconeEntity.class
