...
/*  59 */     this((EntityType<AHVHertxSitEntity>)LatexModEntities.AHV_HERTX_SIT.get(), world);
/*     */   }
/*     */   
...
/*  64 */     this.xpReward = 4;
/*  65 */     setNoAi(false);
/*  66 */     setCustomName((Component)new TextComponent("§a[Idle]"));
...
/*  88 */             double x = AHVHertxSitEntity.this.getX();
/*  89 */             double y = AHVHertxSitEntity.this.getY();
/*  90 */             double z = AHVHertxSitEntity.this.getZ();
/*  91 */             AHVHertxSitEntity aHVHertxSitEntity = AHVHertxSitEntity.this;
/*  92 */             Level world = AHVHertxSitEntity.this.level;
/*  93 */             return (super.canUse() && CheckiftamedProcedure.execute((LevelAccessor)world, x, y, z, (Entity)aHVHertxSitEntity));
/*     */           }
/*     */         });
...
/* 205 */     double y = getY();
/* 206 */     double z = getZ();
/* 207 */     AHVHertxSitEntity aHVHertxSitEntity = this;
/* 208 */     Level world = this.level;
/*     */     
/* 210 */     AHVHertxSitRightClickedOnEntityProcedure.execute((LevelAccessor)world, x, y, z, (Entity)aHVHertxSitEntity, (Entity)sourceentity);
/* 211 */     return retval;
/*     */   }
/*     */ 
/*     */   
...
/* 222 */     AHVHertxSitEntity retval = (AHVHertxSitEntity)((EntityType)LatexModEntities.AHV_HERTX_SIT.get()).create((Level)serverWorld);
...
/* 229 */     return List.<Item>of((Item)LatexModItems.DARKLATEXGOO.get(), (Item)LatexModItems.SLIMEESSENCE.get(), (Item)LatexModItems.SLIMEESSENCE.get())
/* 230 */       .contains(stack.getItem());
/*     */   }
/*     */ 
/*     */   
...
/* 238 */     builder = builder.add(Attributes.MOVEMENT_SPEED, 0.0D);
/* 239 */     builder = builder.add(Attributes.MAX_HEALTH, 30.0D);
/* 240 */     builder = builder.add(Attributes.ARMOR, 5.0D);
/* 241 */     builder = builder.add(Attributes.ATTACK_DAMAGE, 0.0D);
/* 242 */     builder = builder.add(Attributes.FOLLOW_RANGE, 16.0D);
/* 243 */     builder = builder.add(Attributes.KNOCKBACK_RESISTANCE, 0.5D);
/* 244 */     return builder;
/*     */   }
/*     */ }


/* Location:              C:\Users\Administrator\.gradle\caches\forge_gradle\deobf_dependencies\curse\maven\1-1034197\5414946_mapped_official_1.18.2\1-1034197-5414946_mapped_official_1.18.2.jar!\net\mcreator\latexes\entity\AHVHertxSitEntity.class
