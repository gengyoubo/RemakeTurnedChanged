...
public class HertxSitEntity extends TamableAnimal {
    ...
    public HertxSitEntity(EntityType<HertxSitEntity> type, Level world) {
        ...
        this.xpReward = 4;
        this.setNoAi(false);
        this.setCustomName(new TextComponent("§a[Idle]"));
    ...
    protected void registerGoals() {
        ...
        this.targetSelector.addGoal(2, new NearestAttackableTargetGoal(this, SlimelingEntity.class, false, false) {
            public boolean canUse() {
                double x = HertxSitEntity.this.getX();
                double y = HertxSitEntity.this.getY();
                double z = HertxSitEntity.this.getZ();
                Entity entity = HertxSitEntity.this;
                Level world = HertxSitEntity.this.level;
    ...
    public @NotNull InteractionResult mobInteract(Player sourceentity, @NotNull InteractionHand hand) {
        ...
        HertxSitRightClickedOnEntityProcedure.execute(world, x, y, z, entity, sourceentity);
        return retval;
    }
    ...
    public AgeableMob getBreedOffspring(@NotNull ServerLevel serverWorld, @NotNull AgeableMob ageable) {
        HertxSitEntity retval = (HertxSitEntity)((EntityType)LatexModEntities.HERTX_SIT.get()).create(serverWorld);
