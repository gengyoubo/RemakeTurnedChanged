...
/*  59 */     this((EntityType<HertxSitEntity>)LatexModEntities.HERTX_SIT.get(), world);
/*     */   }
/*     */   
...
/*  88 */             double x = HertxSitEntity.this.getX();
/*  89 */             double y = HertxSitEntity.this.getY();
/*  90 */             double z = HertxSitEntity.this.getZ();
/*  91 */             HertxSitEntity hertxSitEntity = HertxSitEntity.this;
/*  92 */             Level world = HertxSitEntity.this.level;
/*  93 */             return (super.canUse() && CheckiftamedProcedure.execute((LevelAccessor)world, x, y, z, (Entity)hertxSitEntity));
/*     */           }
/*     */         });
...
/* 205 */     double y = getY();
/* 206 */     double z = getZ();
/* 207 */     HertxSitEntity hertxSitEntity = this;
/* 208 */     Level world = this.level;
/*     */     
/* 210 */     HertxSitRightClickedOnEntityProcedure.execute((LevelAccessor)world, x, y, z, (Entity)hertxSitEntity, (Entity)sourceentity);
/* 211 */     return retval;
/*     */   }
/*     */ 
/*     */   
...
/* 222 */     HertxSitEntity retval = (HertxSitEntity)((EntityType)LatexModEntities.HERTX_SIT.get()).create((Level)serverWorld);
...
/* Location:              C:\Users\Administrator\.gradle\caches\forge_gradle\deobf_dependencies\curse\maven\1-1034197\5414946_mapped_official_1.18.2\1-1034197-5414946_mapped_official_1.18.2.jar!\net\mcreator\latexes\entity\HertxSitEntity.class
