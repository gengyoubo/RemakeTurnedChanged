...
import net.mcreator.latexes.procedures.HertxSitRightClickedOnEntityProcedure;
...
/* loaded from: 1-1034197-5414946_mapped_official_1.18.2.jar:net/mcreator/latexes/entity/HertxSitEntity.class */
public class HertxSitEntity extends TamableAnimal {
    public HertxSitEntity(PlayMessages.SpawnEntity packet, Level world) {
        this((EntityType) LatexModEntities.HERTX_SIT.get(), world);
    }

    public HertxSitEntity(EntityType<HertxSitEntity> type, Level world) {
        super(type, world);
        this.xpReward = 4;
        setNoAi(false);
    ...
    /* renamed from: net.mcreator.latexes.entity.HertxSitEntity$1  reason: invalid class name */
    /* loaded from: 1-1034197-5414946_mapped_official_1.18.2.jar:net/mcreator/latexes/entity/HertxSitEntity$1.class */
    ...
    /* renamed from: net.mcreator.latexes.entity.HertxSitEntity$2  reason: invalid class name */
    /* loaded from: 1-1034197-5414946_mapped_official_1.18.2.jar:net/mcreator/latexes/entity/HertxSitEntity$2.class */
    class AnonymousClass2 extends NearestAttackableTargetGoal {
        ...
        public boolean canUse() {
            return canUse() && CheckiftamedProcedure.execute(HertxSitEntity.this.level, HertxSitEntity.this.getX(), HertxSitEntity.this.getY(), HertxSitEntity.this.getZ(), HertxSitEntity.this);
        }
    }
    ...
    public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
        ...
        HertxSitRightClickedOnEntityProcedure.execute(this.level, getX(), getY(), getZ(), this, sourceentity);
        return retval;
    }
    ...
    public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
        HertxSitEntity retval = ((EntityType) LatexModEntities.HERTX_SIT.get()).create(serverWorld);
