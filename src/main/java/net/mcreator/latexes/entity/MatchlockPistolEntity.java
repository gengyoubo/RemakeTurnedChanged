...
/*  73 */     MatchlockPistolEntity entityarrow = new MatchlockPistolEntity((EntityType<? extends MatchlockPistolEntity>)LatexModEntities.MATCHLOCK_PISTOL.get(), entity, world);
...
/*  76 */     entityarrow.setCritArrow(true);
...
/*  81 */         .getValue(new ResourceLocation("latex:musket_fire")), SoundSource.PLAYERS, 1.0F, 1.0F / (random
...
/*  87 */     MatchlockPistolEntity entityarrow = new MatchlockPistolEntity((EntityType<? extends MatchlockPistolEntity>)LatexModEntities.MATCHLOCK_PISTOL.get(), entity, entity.level);
...
/*  91 */     entityarrow.shoot(dx, dy - entityarrow.getY() + Math.hypot(dx, dz) * 0.20000000298023224D, dz, 4.0F, 12.0F);
/*  92 */     entityarrow.setSilent(true);
/*  93 */     entityarrow.setBaseDamage(2.0D);
/*  94 */     entityarrow.setKnockback(1);
/*  95 */     entityarrow.setCritArrow(true);
...
/*  98 */         .getValue(new ResourceLocation("latex:musket_fire")), SoundSource.PLAYERS, 1.0F, 1.0F / ((new Random())
...
/* Location:              C:\Users\Administrator\.gradle\caches\forge_gradle\deobf_dependencies\curse\maven\1-1034197\5414946_mapped_official_1.18.2\1-1034197-5414946_mapped_official_1.18.2.jar!\net\mcreator\latexes\entity\MatchlockPistolEntity.class
