...
/* loaded from: 1-1034197-5414946_mapped_official_1.18.2.jar:net/mcreator/latexes/entity/DarkLatexSnepEntity.class */
public class DarkLatexSnepEntity extends Monster {
    ...
    /* renamed from: net.mcreator.latexes.entity.DarkLatexSnepEntity$1  reason: invalid class name */
    /* loaded from: 1-1034197-5414946_mapped_official_1.18.2.jar:net/mcreator/latexes/entity/DarkLatexSnepEntity$1.class */
    class AnonymousClass1 extends MeleeAttackGoal {
        ...
        public boolean canUse() {
            DarkLatexSnepEntity.this.getX();
            DarkLatexSnepEntity.this.getY();
            DarkLatexSnepEntity.this.getZ();
            Entity entity = DarkLatexSnepEntity.this;
            Level level = DarkLatexSnepEntity.this.level;
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(20, new AnonymousClass5(this, LivingEntity.class, 6.0f));
        this.goalSelector.addGoal(21, new RandomStrollGoal(this, 0.8d));
        this.goalSelector.addGoal(22, new RandomLookAroundGoal(this));
        this.goalSelector.addGoal(23, new FloatGoal(this));
    }

    /* renamed from: net.mcreator.latexes.entity.DarkLatexSnepEntity$2  reason: invalid class name */
    /* loaded from: 1-1034197-5414946_mapped_official_1.18.2.jar:net/mcreator/latexes/entity/DarkLatexSnepEntity$2.class */
    ...
    /* renamed from: net.mcreator.latexes.entity.DarkLatexSnepEntity$3  reason: invalid class name */
    /* loaded from: 1-1034197-5414946_mapped_official_1.18.2.jar:net/mcreator/latexes/entity/DarkLatexSnepEntity$3.class */
    ...
    /* renamed from: net.mcreator.latexes.entity.DarkLatexSnepEntity$4  reason: invalid class name */
    /* loaded from: 1-1034197-5414946_mapped_official_1.18.2.jar:net/mcreator/latexes/entity/DarkLatexSnepEntity$4.class */
    ...
    /* renamed from: net.mcreator.latexes.entity.DarkLatexSnepEntity$5  reason: invalid class name */
    /* loaded from: 1-1034197-5414946_mapped_official_1.18.2.jar:net/mcreator/latexes/entity/DarkLatexSnepEntity$5.class */
    ...
    public void awardKillScore(Entity entity, int score, DamageSource damageSource) {
        ...
        DarkLatexSnepThisEntityKillsAnotherOneProcedure.execute(this.level, getX(), getY(), getZ(), entity, this);
    }
    ...
    public static AttributeSupplier.Builder createAttributes() {
        return Mob.createMobAttributes().add(Attributes.MOVEMENT_SPEED, 0.4d).add(Attributes.MAX_HEALTH, 20.0d).add(Attributes.ARMOR, 0.0d).add(Attributes.ATTACK_DAMAGE, 3.0d).add(Attributes.FOLLOW_RANGE, 16.0d).add(Attributes.KNOCKBACK_RESISTANCE, 0.3d).add(Attributes.ATTACK_KNOCKBACK, 0.5d);
    }
}
