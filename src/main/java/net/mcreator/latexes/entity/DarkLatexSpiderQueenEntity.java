    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.1, false) {
            ...
            public boolean canUse() {
                double x = DarkLatexSpiderQueenEntity.this.getX();
                double y = DarkLatexSpiderQueenEntity.this.getY();
                double z = DarkLatexSpiderQueenEntity.this.getZ();
                Entity entity = DarkLatexSpiderQueenEntity.this;
                Level world = DarkLatexSpiderQueenEntity.this.level;
