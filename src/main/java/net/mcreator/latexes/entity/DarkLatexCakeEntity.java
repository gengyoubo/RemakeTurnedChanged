...
public class DarkLatexCakeEntity extends Monster {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.3, false) {
            ...
            public boolean canUse() {
                double x = DarkLatexCakeEntity.this.getX();
                double y = DarkLatexCakeEntity.this.getY();
                double z = DarkLatexCakeEntity.this.getZ();
                Entity entity = DarkLatexCakeEntity.this;
                Level world = DarkLatexCakeEntity.this.level;
    ...
    public void awardKillScore(Entity entity, int score, DamageSource damageSource) {
        ...
        DarkLatexCakeThisEntityKillsAnotherOneProcedure.execute(this.level, this.getX(), this.getY(), this.getZ(), entity, this);
    }
