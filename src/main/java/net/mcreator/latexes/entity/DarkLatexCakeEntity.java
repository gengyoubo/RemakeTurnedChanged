...
/* loaded from: 1-1034197-5414946_mapped_official_1.18.2.jar:net/mcreator/latexes/entity/DarkLatexCakeEntity.class */
public class DarkLatexCakeEntity extends Monster {
    ...
    /* renamed from: net.mcreator.latexes.entity.DarkLatexCakeEntity$1  reason: invalid class name */
    /* loaded from: 1-1034197-5414946_mapped_official_1.18.2.jar:net/mcreator/latexes/entity/DarkLatexCakeEntity$1.class */
    class AnonymousClass1 extends MeleeAttackGoal {
        ...
        public boolean canUse() {
            DarkLatexCakeEntity.this.getX();
            DarkLatexCakeEntity.this.getY();
            DarkLatexCakeEntity.this.getZ();
            Entity entity = DarkLatexCakeEntity.this;
            Level level = DarkLatexCakeEntity.this.level;
    ...
    protected void registerGoals() {
        registerGoals();
        this.goalSelector.addGoal(1, new AnonymousClass1(this, 1.3d, false));
    ...
    /* renamed from: net.mcreator.latexes.entity.DarkLatexCakeEntity$2  reason: invalid class name */
    /* loaded from: 1-1034197-5414946_mapped_official_1.18.2.jar:net/mcreator/latexes/entity/DarkLatexCakeEntity$2.class */
    ...
    /* renamed from: net.mcreator.latexes.entity.DarkLatexCakeEntity$3  reason: invalid class name */
    /* loaded from: 1-1034197-5414946_mapped_official_1.18.2.jar:net/mcreator/latexes/entity/DarkLatexCakeEntity$3.class */
    ...
    /* renamed from: net.mcreator.latexes.entity.DarkLatexCakeEntity$4  reason: invalid class name */
    /* loaded from: 1-1034197-5414946_mapped_official_1.18.2.jar:net/mcreator/latexes/entity/DarkLatexCakeEntity$4.class */
    ...
    public boolean hurt(DamageSource source, float amount) {
        DarkLatexCakeEntityIsHurtProcedure.execute(this);
    ...
    public void awardKillScore(Entity entity, int score, DamageSource damageSource) {
        ...
        DarkLatexCakeThisEntityKillsAnotherOneProcedure.execute(this.level, getX(), getY(), getZ(), entity, this);
    }
    ...
    public static AttributeSupplier.Builder createAttributes() {
        return Mob.createMobAttributes().add(Attributes.MOVEMENT_SPEED, 0.2d).add(Attributes.MAX_HEALTH, 25.0d).add(Attributes.ARMOR, 0.0d).add(Attributes.ATTACK_DAMAGE, 2.0d).add(Attributes.FOLLOW_RANGE, 16.0d).add(Attributes.KNOCKBACK_RESISTANCE, 0.2d);
    }
}
