...
public class DroneHertxKillsEntityProcedure {
    public DroneHertxKillsEntityProcedure() {
    }
                    ...
                    ((<undefinedtype>)(new Object() {
                        ...
                        private void run() {
                            ...
                            if (var2 instanceof Level _level) {
                                if (!_level.isClientSide()) {
                                    _level.playSound((Player)null, new BlockPos(x, y, z), (SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("turned:robot_burp")), SoundSource.NEUTRAL, 1.0F, 1.0F);
                                } else {
                                    _level.playLocalSound(x, y, z, (SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("turned:robot_burp")), SoundSource.NEUTRAL, 1.0F, 1.0F, false);
                                }
                            }
                            ...
                            if (Math.random() < 0.1) {
                                ...
                                if (var2 instanceof Level) {
                                    _level = (Level)var2;
                                    if (!_level.isClientSide()) {
                                        entityToSpawn = new ItemEntity(_level, x, y, z, new ItemStack(Items.IRON_NUGGET));
                                        entityToSpawn.setPickUpDelay(60);
                                        _level.addFreshEntity(entityToSpawn);
                                    }
                                }
                ...
                if (Math.random() < 0.1) {
                    ...
                    ((<undefinedtype>)(new Object() {
                        ...
                        private void run() {
                            ...
                            if (var2 instanceof Level _level) {
                                if (!_level.isClientSide()) {
                                    entityToSpawn = new ItemEntity(_level, x, y, z, new ItemStack(Items.IRON_INGOT));
                                    entityToSpawn.setPickUpDelay(60);
                                    _level.addFreshEntity(entityToSpawn);
                                }
                            }
                            ...
                            if (Math.random() < 0.3) {
                                ...
                                if (var2 instanceof Level) {
                                    _level = (Level)var2;
                                    if (!_level.isClientSide()) {
                                        entityToSpawn = new ItemEntity(_level, x, y, z, new ItemStack(Items.REDSTONE));
                                        entityToSpawn.setPickUpDelay(60);
                                        _level.addFreshEntity(entityToSpawn);
                                    }
                                }
