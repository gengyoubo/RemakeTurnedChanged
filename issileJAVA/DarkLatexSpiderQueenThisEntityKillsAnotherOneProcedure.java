...
public class DarkLatexSpiderThisEntityKillsAnotherOneProcedure {
    public DarkLatexSpiderThisEntityKillsAnotherOneProcedure() {
    }
    ...
    public static boolean execute(LevelAccessor world, final double x, final double y, final double z, Entity entity) {
        if (entity == null) {
            ...
            if (world.getLevelData().getGameRules().getBoolean(LatexModGameRules.DARKLATEXTRANSFUR)) {
                ...
                if (!var21) {
                    if ((entity.getType().is(TagKey.create(Registry.ENTITY_TYPE_REGISTRY, new ResourceLocation("latex:darklatexes"))) || entity.getType().is(TagKey.create(Registry.ENTITY_TYPE_REGISTRY, new ResourceLocation("latex:robots")))) && !(entity instanceof DLbeeEntity) && !(entity instanceof DarkLatexQueenBeeEntity)) {
                        return true;
                    }
                    ...
                    if (entity instanceof FlyingMob) {
                        ...
                        if (Math.random() < 0.4) {
                            ...
                            if (world instanceof ServerLevel) {
                                _level = (ServerLevel)world;
                                Entity entityToSpawn = new DarkLatexSnepEntity((EntityType)LatexModEntities.DARK_LATEX_SNEP.get(), _level);
                                entityToSpawn.moveTo(x, y, z, world.getRandom().nextFloat() * 360.0F, 0.0F);
                                if (entityToSpawn instanceof Mob) {
                                    _mobToSpawn = (Mob)entityToSpawn;
                                    _mobToSpawn.finalizeSpawn(_level, world.getCurrentDifficultyAt(entityToSpawn.blockPosition()), MobSpawnType.MOB_SUMMONED, (SpawnGroupData)null, (CompoundTag)null);
                                ...
                                private void run() {
                                    ...
                                    if (Math.random() < 0.5) {
                                        ...
                                        if (var2 instanceof Level) {
                                            _level = (Level)var2;
                                            if (!_level.isClientSide()) {
                                                entityToSpawn = new ItemEntity(_level, x, y, z, new ItemStack(Blocks.COBWEB));
                                        ...
                                        if (var2 instanceof Level) {
                                            _level = (Level)var2;
                                            if (!_level.isClientSide()) {
                                                entityToSpawn = new ItemEntity(_level, x, y, z, new ItemStack(Items.STRING));
                                                entityToSpawn.setPickUpDelay(10);
                                                _level.addFreshEntity(entityToSpawn);
                                            }
                                        }
                    ...
                    } else if (entity instanceof Bee || entity instanceof DLbeeEntity || entity instanceof BeeHertxEntity) {
                        if (!entity.level.isClientSide()) {
                            entity.discard();
                        }
                        ...
                        if (Math.random() < 0.2 && !(entity instanceof Player)) {
                            if (!entity.level.isClientSide()) {
                                entity.discard();
                            }
