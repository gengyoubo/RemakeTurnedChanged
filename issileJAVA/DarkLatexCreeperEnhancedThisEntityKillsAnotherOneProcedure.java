...
public class DarkLatexCreeperEnhancedThisEntityKillsAnotherOneProcedure {
    public DarkLatexCreeperEnhancedThisEntityKillsAnotherOneProcedure() {
    }
    ...
    public static boolean execute(LevelAccessor world, final double x, final double y, final double z, Entity entity, Entity sourceentity) {
        if (entity != null && sourceentity != null) {
            ...
            if (world.getLevelData().getGameRules().getBoolean(LatexModGameRules.DARKLATEXTRANSFUR) && Math.random() < 0.75) {
                ItemStack var10000;
                ...
                if (world instanceof ServerLevel) {
                    ...
                    _level.sendParticles(ParticleTypes.HEART, x, y, z, 4, 2.0, 2.0, 2.0, 1.0);
                }
                ...
                if (sourceentity instanceof LivingEntity) {
                    ...
                    _entity.setHealth(var10001 + var10002 / 6.0F);
                }
                ...
                if (Math.random() < 0.75) {
                    ((<undefinedtype>)(new Object() {
                        ...
                        private void run() {
                            ...
                            if (var2 instanceof Level _level) {
                                if (!_level.isClientSide()) {
                                    entityToSpawn = new ItemEntity(_level, x, y, z, new ItemStack(Items.GUNPOWDER));
