    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.25, false) {
            ...
            public boolean canUse() {
                double x = DarkLatexSnakeEntity.this.getX();
                double y = DarkLatexSnakeEntity.this.getY();
                double z = DarkLatexSnakeEntity.this.getZ();
                Entity entity = DarkLatexSnakeEntity.this;
                Level world = DarkLatexSnakeEntity.this.level;
